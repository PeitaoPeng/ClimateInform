...
// ---------------------------------------------------------
// NINO3.4 Loader (PNG-based)
// ---------------------------------------------------------

function updateNino34(year, month) {
...
if (window.location.pathname.includes("monthly")) {
    ...
    // ⭐ Update NINO3.4 PNGs in parallel
    updateNino34(year, month);
}
