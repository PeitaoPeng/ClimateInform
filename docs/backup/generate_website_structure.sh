...
# 1. first set up the ClimateInform website repo
# 2. want to reorganize or clean the folder structure
# 3. add new sections to the site (e.g., new variables, new forecast types)
# 4. want to regenerate missing folders after cleanup
