...
lcdir=/home/peitao/src/forecast/ca_ss
...
'reinit'
'open $outsst0.ctl'
'open /home/peitao/src/utility/mask/mask1X1.dat.ctl'
'set gxout fwrite'
...
#
outfile=${sst_analysis}.3mon.1948-curr.total.1x1
cat >sst3monavg<<EOF
run avg.gs
EOF
cat >avg.gs<<EOF
