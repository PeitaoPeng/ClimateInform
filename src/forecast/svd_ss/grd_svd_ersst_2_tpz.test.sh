...
#
outfile3=fcst_grd.$var1.2.$var2.mlag$lagmax.mlead$mlead.msvd$msvd.cv$ncv.tpz_area_${tpz_area}.3mon
outfile4=skill_grd_1d.$var1.2.$var2.mlag$lagmax.mlead$mlead.msvd$msvd.cv$ncv.tpz_area_${tpz_area}.3mon
outfile5=hcst_grd.$var1.2.$var2.mlag$lagmax.mlead$mlead.msvd$msvd.tpz_area_${tpz_area}.cv$ncv.3mon
