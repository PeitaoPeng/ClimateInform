...
#=======================================
#
cp $lcdir/pc_svd_ersst_2_tpz.test.f $tmp/svd.f
...
outfile6=pc_svd_$var1.msvd$msvd.tpz_area_${tpz_area}.cv$ncv.3mon
outfile7=pc_svd_$var2.msvd$msvd.tpz_area_${tpz_area}.cv$ncv.3mon
...
#
./svd.x > $dataot2/pc_svd_test.$var1.2.$var2.mlag$lagmax.mlead$mlead.out
#
