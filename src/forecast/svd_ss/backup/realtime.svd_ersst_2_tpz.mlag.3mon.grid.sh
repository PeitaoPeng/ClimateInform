...
#=======================================
#
cp $lcdir/realtime.svd_ersst_2_tpz.mlag.3mon.grid.f $tmp/svd.f
...
outfile6=svd_$var1.msvd$msvd.tpz_area_${tpz_area}.cv$ncv.3mon
outfile7=svd_$var2.msvd$msvd.tpz_area_${tpz_area}.cv$ncv.3mon
...
#
./svd.x > $dataot2/$var1.2.$var2.mlag$lagmax.mlead$mlead.out
#
