#!/bin/sh
#===============================================
# PLSR for seasonal forecast from sst to tpz
...
#=======================================
#
cp $lcdir/realtime.pls_ersst_2_tpz.mlag.3mon.f $tmp/pls.f
...
#
outfile3=fcst.pls.$var1.2.$var2.mlag$lagmax.mlead$mlead.mpls$mpls.cv$ncv.tpz_area_${tpz_area}.3mon
outfile4=skill_1d.pls.$var1.2.$var2.mlag$lagmax.mlead$mlead.mpls$mpls.cv$ncv.tpz_area_${tpz_area}.3mon
outfile5=hcst.pls.$var1.2.$var2.mlag$lagmax.mlead$mlead.mpls$mpls.tpz_area_${tpz_area}.cv$ncv.3mon

outfile6=pls_$var1.mpls$mpls.tpz_area_${tpz_area}.cv$ncv.3mon
...
#
#./pls.x 
./pls.x > $dataot2/$var1.2.$var2.mlag$lagmax.mlead$mlead.out
#
