#!/bin/sh
#==============================================================
# PCR to forecst TPZ of recent seasons for checking real skill
#==============================================================
...
#=======================================
#
cp $lcdir/recent.pcr_ersst_2_tpz_mld.3mon.f $tmp/pcr.f
...
outfile3=fcst.$var1.2.$var2.mlag$lagmax.mlead$mlead.cv$ncv.3mon
outfile4=skill_1d.$var1.2.$var2.mlag$lagmax.mlead$mlead.cv$ncv.3mon
