...
its_clm=`expr $nclm_start - 1948 - $lagmax / 12`
...
outfile5=hcst.$var1.2.$var2.mics$mics.mlead$mlead.id_ceof${id_ceof}.ncut$ncut.nmod1_$icut1.id_detrd$id_detrd.cv$ncv.3mon
