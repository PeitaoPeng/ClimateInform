...
mics=3     # season or month numbers used as ICs
id_mics=0 # =1: ics over lapped; =0 not overlapped
mlead=1     # max lead of ensemble fcst
ncv=1
nmod=20
id_eof=0 # =1: ics combined; =0 not combined
#
...
#=======================================
#
cp $lcdir/pcr_ersst_2_tpz.3mon.dtrd.mics.f $tmp/pcr.f
...
c
      ...
      parameter(id_eof=$id_eof)
      parameter(id_mics=$id_mics)
c
      parameter(ncv=$ncv)
c
      parameter(nyr=$nyear)
...
#
outfile3=fcst.$var1.2.$var2.mics$mics.mlead$mlead.nmod$nmod.id_eof${id_eof}.id_mics$id_mics.cv$ncv.3mon
outfile4=skill_1d.$var1.2.$var2.mics$mics.mlead$mlead.nmod$nmod.id_eof${id_eof}.id_mics$id_mics.cv$ncv.3mon
outfile5=hcst.$var1.2.$var2.mics$mics.mlead$mlead.id_eof${id_eof}.nmod$nmod.id_mics$id_mics.cv$ncv.3mon
#
