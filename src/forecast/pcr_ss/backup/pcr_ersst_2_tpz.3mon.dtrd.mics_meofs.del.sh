...
#=======================================
#
cp $lcdir/pcr_ersst_2_tpz.3mon.dtrd.mics_meofs.del.f $tmp/pcr.f
...
#
outfile3=fcst.$var1.2.$var2.mics$mics.mlead$mlead.ncut$ncut.id_ceof${id_ceof}.id_detrd$id_detrd.cv$ncv.del.3mon
outfile4=skill_1d.$var1.2.$var2.mics$mics.mlead$mlead.ncut$ncut.id_ceof${id_ceof}.id_detrd$id_detrd.cv$ncv.del.3mon
outfile5=hcst.$var1.2.$var2.mics$mics.mlead$mlead.id_ceof${id_ceof}.ncut$ncut.id_detrd$id_detrd.cv$ncv.del.3mon
