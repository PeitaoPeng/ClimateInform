...
lcdir=/home/ppeng/src/forecast/cca_ss
...
dataot1=/home/ppeng/data/cca_prd
#
var1=ersst
...
outd=/home/ppeng/data/ss_fcst/cca/$icyr
outdata=${outd}/$icmon
if [ ! -d $outd ] ; then
  mkdir -p $outd
fi
...
#=======================================
#
cp $lcdir/pc_cca_ersst_2_tpz.test.f $tmp/cca.f
...
gfortran -mcmodel=medium -o cca.x cca.f svd.s.f reof.s.f
echo "done compiling"
...
outfile6=pc_cca_$var1.msvd$msvd.tpz_area_${tpz_area}.cv$ncv.3mon
outfile7=pc_cca_$var2.msvd$msvd.tpz_area_${tpz_area}.cv$ncv.3mon
...
#
./cca.x > $dataot2/pc_cca_test.$var1.2.$var2.mlag$lagmax.mlead$mlead.out
#
