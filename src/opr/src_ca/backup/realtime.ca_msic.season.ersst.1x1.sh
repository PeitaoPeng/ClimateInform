...
#
cp $lcdir/realtime.ca_msic.season.sst.1x1.f $tmp/sst_prd.f
...
#
ln -s $outdata/eof.${sst_analysis}.${eof_range}.${msic}ics.3mon.1x1.gr fort.70
#
ln -s $outdata/real_ca_prd.sst.${sst_analysis}.${eof_range}.$modemax.${msic}ics.3mon.1x1.gr fort.85
ln -s $outdata/real_ca_weights.${sst_analysis}.${eof_range}.$modemax.${msic}ics.3mon.1x1.gr fort.86
#
./ca.x > $outdata/realtime.${sst_analysis}.${eof_range}.$modemax.${msic}ics.1x1.out
#ca.x 
#
cat>$outdata/eof.${sst_analysis}.${eof_range}.${msic}ics.3mon.1x1.ctl<<EOF
dset ^eof.${sst_analysis}.${eof_range}.${msic}ics.3mon.1x1.gr
undef -9.99E+8
title EXP1
XDEF  360 LINEAR    0.5  1.0
...
EOF
#
cat>$outdata/real_ca_prd.sst.${sst_analysis}.${eof_range}.$modemax.${msic}ics.3mon.1x1.ctl<<EOF
dset ^real_ca_prd.sst.${sst_analysis}.${eof_range}.$modemax.${msic}ics.3mon.1x1.gr
undef -9.99E+8
title EXP1
XDEF 360 LINEAR    0.5  1.0
YDEF 180 LINEAR  -89.5  1.0
...
#
#
cat>$outdata/real_ca_weights.${sst_analysis}.${eof_range}.$modemax.${msic}ics.3mon.1x1.ctl<<EOF
dset ^real_ca_weights.${sst_analysis}.${eof_range}.$modemax.${msic}ics.3mon.1x1.gr
undef -9.99E+8
title EXP1
