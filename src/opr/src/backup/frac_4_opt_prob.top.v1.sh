...
#
cp $lcdir/frac_4_opt_prob.top.v1.f $tmp/opt.f
...
#
outfile=$version.frac_rpss.ensmsynth.$var.mlead$mlead.nprd$nprd.iwts$iwts.3mon.$vnmb
...
#
#./syn.x > $outdata/$version.syn_fcst.$var.mlead$mlead.$vnmb.out
./opt.x 
#
