...
#cleve and ccols
#clevsPrecGL="0 10 20 30 40 50 60 70 80"
#ccolsPrecGL="0 21 22 23 24 25 26 27 28 29"
#clevsT2mGL="0 10 20 30 40 50 60 70 80"
#ccolsT2mGL="0 21 22 23 24 25 26 27 28 29"

clevs="0 10 20 30 40 50 60 70 80"
ccols="0 21 22 23 24 25 26 27 28 29"
#ccols="59 56 49 46 44 42 0 22 24 26 29 74 78"
#
#======================================
...
'draw string 5.5 8.25 Heidke Skill of 'varb' FCST for 'tgtss'(1981-$vyrend), Lead 'lead''
...
*
*'print'
*'printim ${var}_HSS.'lead'.png gif x800 y600'
'gxprint ${var}_HSS.'lead'.png x1600 y1200'
*
c
'set vpage off'
*
