...
#cleve and ccols
clevsPrecGL="-80 -70 -60 -50 -40 40 50 60 70 80"
ccolsPrecGL="79 77 75 73 71 0 31 33 35 37 39"
clevsT2mGL="-90 -80 -70 -60 -50 -40 40 50 60 70 80 90"
ccolsT2mGL="49 47 46 45 43 41 0 21 23 25 26 27 29"
#
#======================================
...
'draw string 5.5 8.25 'varb' Prob Fcst (%) for 'tgtssyy', data through 'icmonc''icyr', Lead 'lead''
...
*if ( $var = 'prec' );'run $bindir/dline.gs 180 -90 180 90'; endif 
 'set string 1 tc 5 0'
  iframe=iframe+1
'run $bindir/cbarn2.gs 1. 0 5.5 1.'
endwhile
*
'set string 4 tl 6'
'set strsiz 0.13 0.13'
...
'set strsiz 0.16 0.16'
'set string 4 tc 8'
'draw string 3.5 0.75 Below Normal (%)' 
'set string 2 tc 8'
'draw string 7.5 0.75 Above Normal (%)' 
*
*'print'
*'printim ${var}_prob.'lead'.png gif x800 y600'
