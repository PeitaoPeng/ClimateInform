...
#for var2 in t2m; do # prec, t2m, hg
...
#=======================================
#
cp $lcdir/pcr_ersst_2_tpz.3mon.mics_meofs.$vnmb.f $tmp/pcr.f
...
outfile3=fcst.$var1.2.$var2.mics$mics.mlead$mlead.ncut$ncut.nmod1_$icut1.id_ceof${id_ceof}.cv$ncv.3mon.$vnmb
outfile4=skill_1d.$var1.2.$var2.mics$mics.mlead$mlead.ncut$ncut.nmod1_$icut1.id_ceof${id_ceof}.cv$ncv.3mon.$vnmb
outfile5=hcst.$var1.2.$var2.mics$mics.mlead$mlead.ncut$ncut.nmod1_$icut1.id_ceof${id_ceof}.cv$ncv.3mon.$vnmb
