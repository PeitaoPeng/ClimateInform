...
nskill_start=1981 # to have yrs clm for more stable than 30 yrs
its_skill=`expr $nskill_start - 1947 - $lagmax / 4`
...
ny_out2=`expr $nyear - $its_skill - $lagmax / 4 + 1` # from its_skill to 
...
#=======================================
#
cp $lcdir/eeof_tpz_2_tpz.3mon.$vnmb.f $tmp/pcr.f
...
outfile4=eskill_1d.$var1.2.$var2.cv$ncv.3mon.$vnmb
