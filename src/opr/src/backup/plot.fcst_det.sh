...
if ( $var = 'hgt' );'run /home/ppeng/src/bin/dline.gs 180 -90 180 90'; endif 
if ( $var = 'prec' );'run /home/ppeng/src/bin/dline.gs 180 -60 180 90'; endif 
 'set string 1 tc 5 0'
  iframe=iframe+1
...
'run /home/ppeng/src/bin/rgbset.gs'
*
*
analy_1=ersst
analy_2=hadoisst
