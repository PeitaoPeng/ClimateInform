...
outfile3=new.fcst.$var1.2.$var2.mics$mics.mlead$mlead.ncut$ncut.nmod1_$icut1.id_ceof${id_ceof}.id_detrd$id_detrd.cv$ncv.3mon
outfile4=new.skill_1d.$var1.2.$var2.mics$mics.mlead$mlead.ncut$ncut.nmod1_$icut1.id_ceof${id_ceof}.id_detrd$id_detrd.cv$ncv.3mon
outfile5=new.hcst.$var1.2.$var2.mics$mics.mlead$mlead.ncut$ncut.nmod1_$icut1.id_ceof${id_ceof}.id_detrd$id_detrd.cv$ncv.3mon
