...
ccols="0 91 92 31 33 35 37 81 82 85"
#======================================
...
'draw string 5.5 8.25 AC Skill(%) of 'varb' FCST for 'tgtss'(1981-$vyrend), Lead 'lead''
...
'run $bindir/dline.gs 180 -90 180 90' 
 'set string 1 tc 5 0'
  iframe=iframe+1
...
*
*'print'
*'printim ${var}_ACC.'lead'.png gif x800 y600'
'gxprint ${var}_ACC.'lead'.png x1600 y1200'
*
c
'set vpage off'
*
