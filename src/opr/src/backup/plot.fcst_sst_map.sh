...
ccolsSST="49 47 45 43 41 0 21 23 25 27 29"
#
#======================================
...
'set string 1 tl 5 0'
'set strsiz 0.13 0.13'
'run $bindir/dline.gs 180 -85 180 85'
...
*
*'print'
*'printim ${var}_anom.'lead'.png gif x800 y600'
'gxprint ${var}_anom.'lead'.png x1600 y1200'
*
c
'set vpage off'
*
