...
#for curyr in 2021 2022 2023; do
...
if [ $eof_area = tp_nml ]; then lons=1;lone=360;lats=61;late=151; fi # 30S-60N
if [ $var1 = hadoisst ] && [ $eof_area = tp_nml ]; then ngrd=21243; fi
#echo $ngrd
#
sstfile=${var1}.3mon.1948-curr.total.1x1
#
#=======================================
#
cp $lcdir/pcr_hadoisst_2_tpz.3mon.dtrd.mics_meofs.f $tmp/pcr.f
