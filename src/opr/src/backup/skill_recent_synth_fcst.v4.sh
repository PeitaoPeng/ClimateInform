...
for var2 in t2m; do
#
if [ $var2 = t2m ];  then ivar2=1; nprd=5; fi
if [ $var2 = prec ]; then ivar2=2; nprd=4; fi
#
...
if [ $version = cvcor ]; then
infile2=$version.fcst.ensmsynth.$var2.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb
outfile1=$version.skill_rct_ensmsynth_1d.$var2.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb
outfile2=$version.skill_rct_ensmsynth_2d.$var2.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb
else 
infile2=$version.fcst.ensmsynth.$var2.mlead$mlead.nprd$nprd.3mon.$vnmb
outfile1=$version.skill_rct_ensmsynth_1d.$var2.mlead$mlead.nprd$nprd.3mon.$vnmb
outfile2=$version.skill_rct_ensmsynth_2d.$var2.mlead$mlead.nprd$nprd.3mon.$vnmb
fi
#
# have TPZ anom
#
...
EOF
#
cp $lcdir/skill_recent_synth_fcst.v4.f $tmp/skill.f
...
dirin45=/home/ppeng/data/ss_fcst/pcr/2024/8
dirin46=/home/ppeng/data/ss_fcst/pcr/2024/9
dirin47=/home/ppeng/data/ss_fcst/pcr/2024/10
dirin48=/home/ppeng/data/ss_fcst/pcr/2024/11
dirin49=/home/ppeng/data/ss_fcst/pcr/2024/12
dirin50=/home/ppeng/data/ss_fcst/pcr/2025/1
#
...
vars  6
cor1   1 99 50S-70N sp_cor
rms1   1 99 50S-70N sp_rms
cor2   1 99 CONUS sp_cor
rms2   1 99 CONUS sp_rms
hss1   1 99 50S-70N sp_hss
