...
C weights depend on cor and prd amplitude(t)
...
c
      ...
      SUBROUTINE weights_2(cor,prd,n,wts)
      dimension cor(n),prd(n),wts(n) 
...
C== have weights
      ...
      SUBROUTINE weights(cor,prd,n,wts)
      dimension cor(n),prd(n),wts(n) 
