...
#================================================================
cp $lcdir/synth_fcst_ensm.cor.test.f $tmp/syn.f
...
infile13=$version.frac_rpss.ensmsynth.$var.mlead$mlead.3mon.nprd$nprd.wts$iwts.test
#
outfile1=$version.fcst.ensmsynth.$var.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb2
outfile2=$version.hcst.ensmsynth.$var.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb2
outfile3=$version.skill_1d.ensmsynth.$var.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb2
