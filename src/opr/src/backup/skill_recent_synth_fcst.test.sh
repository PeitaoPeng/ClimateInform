...
infile2=$version.fcst_flt.ensmsynth.$var2.mlead$mlead.3mon.test2

outfile1=$version.skill_rct_ensmsynth_1d.$var2.mlead$mlead.nprd$nprd.wts$iwts.3mon.test2
outfile2=$version.skill_rct_ensmsynth_2d.$var2.mlead$mlead.nprd$nprd.wts$iwts.3mon.test2
#
# have TPZ anom
#
cat >tpzanom<<EOF
...
EOF
#
cp $lcdir/skill_recent_synth_fcst.test.f $tmp/skill.f
