...
c     real eval(nfld),evec(mlag*ngrd,nfld),coef(nfld,nfld)
...
cc... write out eval and reval
      totv1=0
      do i=1,20
c     write(6,*)'eval= ',i,eval(i)
c     totv1=totv1+eval(i)
      end do
      write(6,*)'total= ',totv1
...
c read in predictant (tpz) for each lead
      ...
      write(6,*) 'wtpz(260,130)=',wtpz(260,130,ns_tpz),w2d3(260,130)
C      
...
c
     ...
     &stdf(i,j,ld)
      ...
      enddo
      enddo
      write(6,*) 'stdzed vfld(260,130,ns_tpz2,ld)=',
     &vfld(260,130,ns_tpz2,ld)
      write(6,*) 'stdzed hcst(260,130,ns_tpz2,ld)=',
