...
#
cp $lcdir/frac_4_opt_prob.rms.$vnmb2.f $tmp/opt.f
...
gfortran -mcmodel=medium -g -o opt.x opt.f reof.s.f
echo "done compiling"
...
#
#outfile=$version.frac_rpss.ensmsynth.$var.mlead$mlead.3mon.nprd$nprd.$vnmb
outfile=$version.frac_rpss.ensmsynth.$var.mlead$mlead.3mon.nprd$nprd.$vnmb2
#
