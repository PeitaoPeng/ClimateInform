...
xnino_crt=3.
version=cvcor # or cor
vnmb=v3_1

iwts=2 # =1 <0 ignored, =2 <0 flipped
...
if [ $var = t2m ];  then icut1=3; nprd=5; fi
if [ $var = prec ]; then icut1=5; nprd=4; fi
...
#
cp $lcdir/synth_fcst_ensm.cor.$vnmb.f $tmp/syn.f
...
gfortran -mcmodel=large -g -fcheck=all -o syn.x syn.f
...
#
if [ $var = prec ]; then
infile4=efcst.ersst.2.prec.cv1.3mon.v3
infile3=efcst.prec.2.prec.cv1.3mon.v3
...
infile9=ehcst.ersst.2.prec.cv1.3mon.v3
infile8=ehcst.prec.2.prec.cv1.3mon.v3
...
if [ $var = t2m ]; then
infile5=efcst.t2m.2.t2m.cv1.3mon.v3
infile3=efcst.glb.prec.2.t2m.cv1.3mon.v3
infile4=efcst.ersst.2.t2m.cv1.3mon.v3
infile1=fcst.ersst.2.t2m.mics4.mlead$mlead.ncut1.nmod1_3.id_ceof1.cv1.3mon.$vnmb
infile2=fcst.slp.2.$var.mics1.mlead$mlead.ncut1.nmod1_5.id_ceof1.cv1.3mon.$vnmb

infile10=ehcst.t2m.2.t2m.cv1.3mon.v3
infile8=ehcst.glb.prec.2.t2m.cv1.3mon.v3
infile9=ehcst.ersst.2.t2m.cv1.3mon.v3
...
infile13=$version.frac_rpss.ensmsynth.$var.mlead$mlead.3mon.nprd$nprd.wts$iwts.$vnmb
#
outfile1=$version.fcst.ensmsynth.$var.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb
outfile2=$version.hcst.ensmsynth.$var.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb
outfile3=$version.skill_1d.ensmsynth.$var.mlead$mlead.nprd$nprd.wts$iwts.3mon.$vnmb
