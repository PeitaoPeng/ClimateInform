...
c have regr patterns
      DO m=1,nmod
        ...
        ENDDO ! m loop
      write(6,*) 'regr3(180,45,11)=',regr3(180,45,11)
c
c fcst
...
c std of obs
     ...
     &      (vfld(i,j,it,ld)-avgo(i,j))**2
        ...
        enddo
        enddo
      write(6,*) 'stdo(180,45,ld)=',stdo(180,45,ld)
...
c std of hcst
     ...
     &      (hcst(i,j,it,ld)-avgf(i,j))**2
        ...
        enddo
        enddo
      write(6,*) 'stdf(180,45,ld)=',stdf(180,45,ld)
c
...
c standardized fcsts
      ...
      write(6,*) 'standardized fcst(180,45,ld)=',fcst(180,45,ld)
