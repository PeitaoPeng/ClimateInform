...
#nprd=5  # of input fcst
for nprd in 1 3 5;do

xnino_crt=3.
version=top # or cor
vnmb=v1

for iwts in 1 2; do # =1 +- ignored, =2 <0 flipped
...
#
cp $lcdir/synth_fcst_ensm.top.v1.f $tmp/syn.f
...
infile13=$version.frac_rpss.ensmsynth.$var.mlead$mlead.nprd$nprd.iwts$iwts.3mon.$vnmb
#
outfile1=$version.fcst.ensmsynth.$var.mlead$mlead.nprd$nprd.iwts$iwts.3mon.$vnmb
outfile2=$version.hcst.ensmsynth.$var.mlead$mlead.nprd$nprd.iwts$iwts.3mon.$vnmb
outfile3=$version.skill_1d.ensmsynth.$var.mlead$mlead.nprd$nprd.iwts$iwts.3mon.$vnmb
