...
#
nyr=42  # 1981-2022
hcst=cv # tm:time martching; cv:cross validation
eof_area=tp_nml #gl,tp_nml
ic_mean=mon
out_mean=3mon
nlead=1 # extend of lead months
nclms=1 # 1991
nclme=40 # 2020
undef=-999.0
#
...
eof
#
outfile=${var1}_2_$var2.$hcst.ic_${ic_mean}.nmod$nmod.leadmax$leadmax.$tgtss.${eof_area}.$out_mean
outfile1=pcr_ens.$var2.$hcst.ic_${ic_mean}.$tgtss.nmod$nmod.leadmax$leadmax.${var1}_eof_${eof_area}.$out_mean
outfile2=skill_t.ens.$var2.$hcst.ic_${ic_mean}.$tgtss.nmod$nmod.leadmax$leadmax.${var1}_${eof_area}.$out_mean
outfile3=skill_s.ens.$var2.$hcst.ic_${ic_mean}.$tgtss.nmod$nmod.leadmax$leadmax.${var1}_${eof_area}.$out_mean
#
\rm $tmp/fort.*
#
#gfortran -o pcr.x pcr.f
gfortran -mcmodel=large -o pcr.x pcr.f
echo "done compiling"
#
ilead=1
...
ch1=`expr 10 + $ilead`
ch2=`expr 50 + $ilead`
ln -s $datain/skill.pcr.$hcst.$var2.ic_${ic_mean}.$tgtss.ld$ilead.nmod$nmod.${var1}_${eof_area}.$out_mean.gr fort.$ch1
