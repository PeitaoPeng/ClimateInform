...
outfile=${var1}_2_$var2.ic_$ic_mean.ld$ilead.nmod$nmod.$tgtss.${eof_area}.$out_mean
outfile1=pcr_$var2.ic_$ic_mean.$tgtss.ld$ilead.nmod$nmod.${var1}_${eof_area}.$out_mean
outfile2=skill.pcr.$var2.ic_$ic_mean.$tgtss.ld$ilead.nmod$nmod.${var1}_${eof_area}.$out_mean
outfile3=${var2}_regr.ic_$ic_mean.$tgtss.ld$ilead.48-21.${var1}_${eof_area}.$out_mean
#
\rm $tmp/fort.*
#
