...
ic_mean=mon # sst ic
out_mean=3mon
idtrd=0 # =1: to detrend data; =0: keep trend
nfyr_start=1 # begining year of the sst data 
#
...
outfile4=skill_s.pcr.cv.$var2.ic_$ic_mean.$tgtss.ld$ilead.nmod$nmod.${var1}_${eof_area}.$out_mean
#
\rm $tmp/fort.*
#
...
ydef  180 linear -89.5 1.
zdef  1 levels 1
tdef  $longout linear jan1981 1yr
vars  1
cor   0 99 ac skill
endvars
EOF
