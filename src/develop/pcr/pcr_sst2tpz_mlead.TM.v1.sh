#
#======================================
# time martching (TM)PCR from sst to tpz
# with fixed nmod 
#=======================================
...
datadir=/home/ppeng/data/pcr_hcst/tpz
#
nskip=0
undef=-999.0
#
...
for var1 in ersst; do
        ...
        if [ $var1 = hadoisst ] && [ $eof_area = tp_nml ]; then ngrd=18636; fi
...
#
cp $lcdir/pcr_sst2tpz_mlead.TM.v1.f $tmp/pcr.f
...
infile2=$var2.1948_cur.$out_mean.total.1x1
outfile=${var1}_2_$var2.tm.ic_$ic_mean.ld$ilead.nmod$nmod.$tgtss.${eof_area}.$out_mean
outfile1=pcr_$var2.tm.ic_$ic_mean.$tgtss.ld$ilead.nmod$nmod.${var1}_${eof_area}.$out_mean
outfile2=skill.pcr.tm.$var2.ic_$ic_mean.$tgtss.ld$ilead.nmod$nmod.${var1}_${eof_area}.$out_mean
outfile3=${var2}_regr.tm.ic_$ic_mean.$tgtss.ld$ilead.nmod$nmod.${var1}_${eof_area}.$out_mean
outfile4=skill_s.pcr.tm.$var2.ic_$ic_mean.$tgtss.ld$ilead.nmod$nmod.${var1}_${eof_area}.$out_mean
#
\rm $tmp/fort.*
#
...
ln -s $datadir/$outfile4.gr           fort.33
#
...
EOF
#
cat>$datadir/$outfile4.ctl<<EOF
dset $datadir/$outfile4.gr
undef $undef
title Realtime Surface Obs
xdef  1 linear   0.5 1.
ydef  1 linear -89.5 1.
