...
#
cp $lcdir/all_pc_svd_sst2tpz_mlead.f $tmp/svd.f
...
outfile1=svd_prd.$var2.$tgtss.ld$ilead.95-22.msvd$msvd.${var1}_${sst_area}.tpz_${tpz_area}
outfile2=skill.svd_vs_obs.$var2.$tgtss.ld$ilead.95-22.msvd$msvd.${var1}_${sst_area}.tpz_${tpz_area}
#
\rm $tmp/fort.*
#
