      subroutine pls_tmarch(ntot,nt,im,jm,is,ie,js,je,mode,
     &f1d,f3d,f2d,pc2,pco,pt1,pt2,var,cosl,undef,ID)
C======================================================
...
C=====================================================
      ...
      dimension ts(nt),pc(nt,mode),pc2(ntot,mode)
      dimension pco(mode),pt1(im,jm,mode),pt2(im,jm,mode),var(mode)
