...
#outdata=/mnt/d/data/ca_hcst/$var
#
cd $tmp
#
...
outdata=/mnt/d/data/ca_hcst/$var
#
#1 for sst_analysis in ersst hadoisst; do
...
nskip=32 # =32 for outport from 1981; =0 for from 1950
#skip=0 # output from 1950
...
for modemax in 10 15 20 25 30 35 40 45 50 55 60 65; do
...
ln -s $datadir/$var.1948_cur.3mon.1x1.gr         fort.12
#
