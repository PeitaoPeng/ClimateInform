...
outfile1=ca_hcst_wt_esm.$icss.${sst_analysis}_2_$var2.eof_${eof_area}
outfile2=skill_ca_hcst_wt_esm.$icss.${sst_analysis}_2_$var2.eof_${eof_area}
...
ln -s $datadir/$var2/ca_hcst.skill.${sst_analysis}.$modemax.$icss.${msic}ics.${eof_area}.gr fort.$ifile2
#
done  # maxmode
done  # msics
#
