...
if [ $var = 'prec' ]; then
#
clm_bgn=1200  #t=1: jan1891; t=1201: jan1991
clm_end=`expr $clm_bgn + 360`
ntsp=`expr $nts + 684`
ntep=`expr $nte + 684`
#
cat >data_rewrite.gs<<EOF3
    'reinit'
'sdfopen $datadir0/precip.mon.total.1x1.v2020.nc'
'set x 1 $imxp'
'set y 1 $jmxp'
'set t 1 12'
*anom wrt wmo clim 1991-2020
...
#
cp $lcdir/realtime.ca_msic.season.sst_tpz.new.f $tmp/prd.f
...
eof
#
#gfortran -mcmodel=medium -g -o ca.x sst_prd.f
gfortran -o ca.x prd.f
echo "done compiling"
...
#fi
#
ln -s $outdata/real_ca_weights.${sst_analysis}.${eof_range}.$modemax.${msic}ics.3mon.gr fort.10
ln -s $datadir/$outfile.1x1.gr fort.11
#
