...
if ( $var = 'hgt' );'run /home/peitao/bin/dline.gs 180 -90 180 90'; endif 
if ( $var = 'prec' );'run /home/peitao/bin/dline.gs 180 -60 180 90'; endif 
 'set string 1 tc 5 0'
  iframe=iframe+1
...
'gxprint real.nino34.ca_fcst.png x1600 y1200'
*'print'
*
'c'
'set vpage off'
