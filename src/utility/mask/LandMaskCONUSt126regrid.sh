...
cat >regrid.gs<<gsEOF
* regrid to 0.5X0.5 grid for T126
'open LandMaskCONUSdeg0.5pnt.big.glb.ctl'
'set lat -90 90'
'set lon  0 360'
'set gxout fwrite'
'set fwrite LandMaskCONUSt126.gr'
'd regrid2(land,384,190,gg)'
gsEOF
...
rm in.dat udf.regrid.dat udf.regrid.out


cat >LandMaskCONUSt126.ctl <<ctlEOF
dset ^LandMaskCONUSt126.gr
options big_endian
undef -9999.00
