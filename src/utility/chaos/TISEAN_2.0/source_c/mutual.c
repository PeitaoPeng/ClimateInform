...
double make_shannon(void)
{
  double shannon=0.0,p,norm;
  long i,*h;

  check_alloc(h=(long *)malloc(sizeof(long)*partitions));
...
{
  long i,j,hi,count=0;
  double hpi,pij,cond_ent=0.0,he,norm;
