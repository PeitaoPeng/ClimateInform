...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
#include "parm.h"
      PARAMETER (imax=144,jmax=72,imax2=144,jmax2=73)
      real yy(jmax),yy2(jmax2),yreg73(jmax2),xx(imax),xx2(imax2)
...
C
      ...
      CALL SETXY(XX2,imax2,yreg73,jmax2,0.0,DXX2,-90.,DYY) !jmax=73
C
  ...
  666 continue
      ...
      do 1000 kk=1,ltime
      read(11)  grd1
      call intp2d(grd1,imax,jmax,xx,yy,grd2,imax2,jmax2,xx2,yreg73,0)
