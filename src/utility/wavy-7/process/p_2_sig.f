...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      PARAMETER (KMAX=10,KMXI=17 ,MAND=17,
     *LONG=144,LATG=73,
...
C                                                                       
      OPEN(unit=10,
     ' FORM='UNFORMATTED',ACCESS='DIRECT',recl=4*LONG*LATG)
      OPEN(unit=20,
     ' FORM='UNFORMATTED',ACCESS='DIRECT',recl=4*LONG*LATG)
      OPEN(unit=60,
     ' FORM='UNFORMATTED',ACCESS='DIRECT',recl=4*LONG*LATG)
C                                                                       
      DATA PMAND  /1000.,925.,850.,700.,600.,500.,400.,300.,250.,          
...
C.....READ Tsfc
      ...
      TSFC(I,J)=FIELD(I,J)                                              
 375  CONTINUE                                                          
      write(6,*) 'have read top,z,div,vor and Tsfc, irec=',irec
C======================================================                 
      DO 1000 LAT=1, LATG                                               
C                                                                       
c     write(6,*) 'before call lowtmp'
      DO 50 LO=1,LONG                                                   
         DO 30 K=1,KMXI                                                 
