...
c
      include "ptrunk.h"
c
      PARAMETER ( NW =15, NLV=10, NLIN=10)
      PARAMETER ( NWP1=NW+1)                        
...
C....READ SPECTRAL FIELDS
      ...
      IREAD=IREAD+1
      CALL READ85 (INFILE,BUFR,IREAD,NLIN,AVGD1,NWP1)
c          CALL INTPBST(WORK,AVGD1)
      IREAD=IREAD+NLIN
      CALL READ85 (INFILE,BUFR,IREAD,NLIN,AVGV1,NWP1)
c          CALL INTPBST(WORK,AVGV1)
      IREAD=IREAD+NLIN
      CALL READ85 (INFILE,BUFR,IREAD,NLIN,AVGT1,NWP1)
c          CALL INTPBST(WORK,AVGT1)
      IREAD=IREAD+NLIN
...
C
      ...
      IREAD=IREAD+1
      CALL READ85 (INFILE,BUFR,IREAD,NLIN,AVGD2,NWP1)
c          CALL INTPBST(WORK,AVGD2)
      IREAD=IREAD+NLIN
      CALL READ85 (INFILE,BUFR,IREAD,NLIN,AVGV2,NWP1)
c          CALL INTPBST(WORK,AVGV2)
      IREAD=IREAD+NLIN
      CALL READ85 (INFILE,BUFR,IREAD,NLIN,AVGT2,NWP1)
c          CALL INTPBST(WORK,AVGT2)
      IREAD=IREAD+NLIN
