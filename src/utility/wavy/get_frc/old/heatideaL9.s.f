...
c     if(j.lt.15.or.j.gt.25) out(i,j)=0>    !24.4S-24.4N
      if(j.lt.16.or.j.gt.25) out(i,j)=0.    !20S-20N
...
c=== for having RADG
      ...
      OLRFRC2(i,j)=0.
  50  CONTINUE
      call IDEADH(OLRFRC1,100., 0.,   4.)
      call IDEADH(OLRFRC2,180., 0.,   -4.)
      do i=1,nlong
      do j=1,nlatg
...
C
      DATA SL    /0.95,0.9,0.85,0.785,0.71,0.625,
     *            0.50,0.30,0.15,0.025/
c     DATA SL    /0.95,0.85,0.75,0.65,0.55,0.45,
c    *            0.35,0.25,0.15,0.05/
