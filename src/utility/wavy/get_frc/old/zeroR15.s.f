...
CC
      ...
      real    COLRAD(KHALF),WGT(KHALF),WGTCS(KHALF),RCS2(KHALF)
      LOGICAL zset
      PI=ACOS(-1.0)
...
C.....transform and set zero            
 ...
 50     continue
      ...
      do 100 i=1,nlong
      do 100 j=1,nlatg
      IF(j.lt.10) FIELDG(i,j)=0.
c     IF(j.gt.16) FIELDG(i,j)=0.
c     IF(i.lt.22.or.i.gt.44) FIELDG(i,j)=0.
c     IF(j.le.14.or.j.gt.20) FIELDG(i,j)=0.
c     IF(i.lt.7.or.i.gt.26) FIELDG(i,j)=0.
c     IF(j.lt.15.or.j.gt.25) FIELDG(i,j)=0.
c     IF(j.lt.18.or.j.gt.20) FIELDG(i,j)=0.
c     IF(i.lt.36.or.i.gt.44) FIELDG(i,j)=0.
c     IF(j.gt.13) FIELDG(i,j)=0.
c     IF(j.gt.20) FIELDG(i,j)=0.
c     IF(j.lt.18.or.j.gt.23) FIELDG(i,j)=0.
c     IF(i.lt.26.or.i.gt.30) FIELDG(i,j)=0.
c     IF(fieldg(i,j).lt.0.)  FIELDG(i,j)=0.
c     IF(i.lt.27.and.fieldg(i,j) .gt.0.) FIELDG(i,j)=-1.*FIELDG(i,j)
c     IF(i.lt.27.) FIELDG(i,j)=1.5*FIELDG(i,j)
