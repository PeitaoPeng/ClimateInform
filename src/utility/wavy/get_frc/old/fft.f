...
c     IF (N-2) 101,102,103                                              NCA00070
      NM2=N-2
      IF(NM2.lt.0) go to 101
      IF(NM2.eq.0) go to 102
      IF(NM2.gt.0) go to 103
...
c     IF (NR) 101,105,101                                               NCA00810
  ...
  101 CONTINUE                                                          NCA01430
      ...
      NP1 = N+1                                                         NCA01500
      NS2 = N/2                                                         NCA01510
c     IF (N-2) 106,101,102                                              NCA01520
      NM2=N-2
      IF (NM2.lt.0) go to 106                                           NCA01520
      IF (NM2.eq.0) go to 101                                           NCA01520
      IF (NM2.gt.0) go to 102                                           NCA01520
...
c     IF (N-2) 102,101,103                                              NCA02540
      NM2=N-2                                                           NCA02540
      IF(NM2.lt.0) go to 102
      IF(NM2.eq.0) go to 101
      IF(NM2.gt.0) go to 103
...
c     IF (IDO-2) 107,105,102                                            NCA13210
      IDOM2=IDO-2
      IF(IDOM2.lt.0) go to 107
      IF(IDOM2.eq.0) go to 105
      IF(IDOM2.gt.0) go to 102
...
c     IF (IDO-2) 107,105,102                                            NCA13920
      IDOM2=IDO-2
      IF(IDOM2.lt.0) go to 107
      IF(IDOM2.eq.0) go to 105
      IF(IDOM2.gt.0) go to 102
...
c     IF (IDO-2) 107,105,102                                            NCA17300
      IDOM2=IDO-2
      IF(IDOM2.lt.0) go to 107
      IF(IDOM2.eq.0) go to 105
      IF(IDOM2.gt.0) go to 102
...
c     IF (IDO-2) 107,105,102                                            NCA17970
      IDOM2=IDO-2
      IF(IDOM2.lt.0) go to 107
      IF(IDOM2.eq.0) go to 105
      IF(IDOM2.gt.0) go to 102
