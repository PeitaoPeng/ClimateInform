...
CC    PARAMETER(NSKPIN=44,NFIELD=51)
      ...
      PARAMETER(NEDDY=3*NMAND,NTIME=60)              
     ...
     2           AVDPTT(NLONG,NLATG,NMAND),GLBAVT(NMAND)
      ...
      DIMENSION FIELDG(NLONG,NLATG),FIELDG2(NLONG,NLATG)
...
C.....compute the average of two year seasonal means
      DO 50 IP=1,NAVFLD
      READ(50) FIELDG
      READ(51) FIELDG2
      DO 50 J=1,NLATG
      DO 50 I=1,NLONG
      AVGGRD(I,J,IP)=0.5*(FIELDG(I,J)+FIELDG2(I,J))
   50 CONTINUE
...
C.....transform absolute temp to potential temp         
  ...
  440 CONTINUE
c.....compute eddy u & v  and potential temp
      DO 450 K=1,14   
      DO 450 J=1,NLATG
      DO 450 I=1,NLONG
      EDDYGD(I,J,K)=EDDYGD(I,J,K)-AVGGRD(I,J,1+K)
  450 CONTINUE
      DO 455 K=15,NEDDY
      DO 455 J=1,NLATG
      DO 455 I=1,NLONG
...
C     CALL RELVOT(UWN(1,1,L),VWN(1,1,L),AVSPRV(1,1,1,L))
      CALL RLVORT(UWN(1,1,L),VWN(1,1,L),EDYGRV(1,1,L))
  100 CONTINUE
C     DO 720 L=1,MAND
C        CALL EVLSCA(AVSPRV(1,1,1,L),EDYGRV(1,1,L))
C 720 CONTINUE
      DO 725 K=1,MAND
      DO 725 J=1,NLATG
      DO 725 I=1,NLONG
