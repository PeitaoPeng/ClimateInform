...
CC    PARAMETER(NSKPIN=44,NFIELD=51)
     ...
     5        AVGTMP(2,NLEG,NMP,NMAND),AVGSPH(2,NLEG,NMP,NMAND)
      ...
      DIMENSION IDATE(4)
      DIMENSION CORIOLIS(NLATG),COSLAT(NLATG)  
      ...
      DIMENSION EDYGDT(NLONG,NLATG,MAND)
      DIMENSION EDYSRV(2,NLEG,NMP,MAND),EDYGRV(NLONG,NLATG,MAND)
      DIMENSION EDYPTV(NLONG,NLATG,MAND)
...
C.....transform absolute temp to potential temp         
  ...
  440 CONTINUE
c.....compute eddy geoht and potential temp
      DO 450 K=1,NEDDY 
      DO 450 J=1,NLATG
      DO 450 I=1,NLONG
      EDDYGD(I,J,K)=EDDYGD(I,J,K)-AVGGRD(I,J,23+K) 
  450 CONTINUE
C.....transform eddy geoht into eddy stream function
      DO 430 IG=1,NMAND
      DO 430 J=1,NLATG
      DO 430 I=1,NLONG
      EDDYGD(I,J,IG)=EDDYGD(I,J,IG)/CORIOLIS(J)
  430 CONTINUE
C.....TRANSFORM FIELDS TO SPECTRAL SPACE
      DO 460 J=1,NEDDY
...
C 
      DO 535 L=1,MAND
         ...
         CALL EVLSCA(EDYHST(1,1,1,L+NMAND+1,NT),EDYGDT(1,1,L))
...
C
      ...
      DO 550 I=1,NLONG
         ...
         EDDYGD(I,J,4)=EDYGDU(I,J,L)*EDYGDT(I,J,L)/XTIME
         EDDYGD(I,J,5)=EDYGDV(I,J,L)*EDYGDT(I,J,L)/XTIME
         EDDYGD(I,J,6)=EDYGDT(I,J,L)*EDYGDT(I,J,L)/XTIME
  550 CONTINUE
...
C
      ...
      DO 555 J=1,NLEG 
      DO 555 I=1,2 
      EDYSRV(I,J,K,L)=-(XXN(J,K)+1)*XXN(J,K)*EDYHST(I,J,K,L+1,NT)
     1/RR
  555 CONTINUE
      DO 560 L=1,MAND
  ...
  560 CONTINUE
      DO 570 K=1,NMAND
         CALL EVLSCA(EDYHST(1,1,1,K,NT),EDDYGD(1,1,K))
  570 CONTINUE
      DO 575 K=1,MAND
      DO 575 J=1,NLATG
      DO 575 I=1,NLONG
      FT1=CORIOLIS(J)**2*2*PLEVEL(1)**XKAPA/(
     1    GASCON*(PLEVEL(K+2)-PLEVEL(K))) 
      FT2=(EDDYGD(I,J,K+1)-EDDYGD(I,J,K))/(
     1    (0.5*(PLEVEL(K)+PLEVEL(K+1)))**(XKAPA-1.)*
     2    (AVGGRD(I,J,30+K+1)-AVGGRD(I,J,30+K)))
      FT3=(EDDYGD(I,J,K+2)-EDDYGD(I,J,K+1))/(
     1    (0.5*(PLEVEL(K+1)+PLEVEL(K+2)))**(XKAPA-1.)*
     2    (AVGGRD(I,J,30+K+2)-AVGGRD(I,J,30+K+1)))
      TERM3=FT1*(FT2-FT3)
