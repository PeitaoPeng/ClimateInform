...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      SUBROUTINE RVDVVPST(UWND,VWND,UWNDR,VWNDR,STREAM,VORTGD)
      PARAMETER(NW=40)
...
C     CALL EVLU(VLPS,QZER,UWNDD)
C     CALL EVLV(VLPS,QZER,VWNDD)
      RETURN
      END
