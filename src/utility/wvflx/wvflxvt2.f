...
C    multy year pressure history data(U,V & T only)                             C
C                                                                      C
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
     ...
     3           GLBAVT(NMAND)
      ...
      DIMENSION AVGGDH(NLONG,NLATG,NMAND)
      ...
      DIMENSION XMM(NLONG,NLATG,MAND)
      OPEN(10,FILE='~/ppt/gcm1/gt87vt.hp',FORM='UNFORMATTED',
     +RECORDTYPE='STREAM',CONVERT='BIG_ENDIAN')
      OPEN(60,FILE='~/ppt/gcm1/pbhp87nd',FORM='UNFORMATTED')
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      DO 755 K=1,MAND
         CALL GRADIENT(AVGPTV(1,1,K),GGRPVX(1,1,K),GGRPVY(1,1,K))
  755 CONTINUE
...
C
      CALL DIVERG(XMR,YMR,ZMR,DIVMR)
      CALL DIVERG(XMT,YMT,ZMT,DIVMT)
      DO 795 K=1,MAND
         CALL GRADIENT(AVEDES(1,1,K),GRDESX(1,1,K),GRDESY(1,1,K))
  795 CONTINUE
C     WRITE(61,999) GRDESX       
      DO 800 K=1,3
      DO 800 J=1,NLATG
      DO 800 I=1,NLONG
