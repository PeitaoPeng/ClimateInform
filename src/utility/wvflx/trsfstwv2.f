...
C
      ...
      DIMENSION R2(nlon,nlat,nlev2),RZ(nlat,nlev1)
      OPEN(10,FILE='/data/pool/peng/stwv/gcmstwv',FORM='UNFORMATTED')
C    +RECORDTYPE='STREAM',CONVERT='BIG_ENDIAN')
      OPEN(80,FILE='/data/pool/peng/stwv/gcmstwv15',           
...
130   continue
100   continue
C.....read and write 7 level zonal mean data
      do 140 iread=1,4 
      read(10) RZ
      WRITE (6,*) ' NUMBER OF READ = ',iread
      do 150 k=1,nlev1
