...
C     OPEN(10,FILE='~/ppt/gcm1/pbhpwv87w',FORM='UNFORMATTED')
      OPEN(10,FILE='/data/pool/ppt/pbhpwv87w',FORM='UNFORMATTED')
C    +RECORDTYPE='STREAM',CONVERT='BIG_ENDIAN')
C     OPEN(80,FILE='~/ppt/gcm1/pbhp1587w',FORM='UNFORMATTED',
      OPEN(80,FILE='/data/pool/ppt/pbhp1587w',FORM='UNFORMATTED',
