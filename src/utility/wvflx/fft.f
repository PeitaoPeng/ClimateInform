...
C                                                                       NCA00050
      DIMENSION       R(1)       ,A(1)       ,B(1)       ,WSAVE(1)      NCA00060
...
C                                                                       NCA00190
  ...
  105 CONTINUE                                                          NCA00320
      ...
      DIMENSION       R(1)       ,A(1)       ,B(1)       ,WSAVE(1)      NCA00370
...
C                                                                       NCA00500
  ...
  101 CONTINUE                                                          NCA01430
      ...
      DIMENSION       X(1)       ,WSAVE(1)                              NCA01480
      NM1 = N-1                                                         NCA01490
      NP1 = N+1                                                         NCA01500
      NS2 = N/2                                                         NCA01510
  ...
  101 CONTINUE                                                          NCA02000
      ...
      DIMENSION       X(1)       ,WSAVE(1)                              NCA02050
  ...
  101 CONTINUE                                                          NCA02470
      ...
      DIMENSION       X(1)       ,WSAVE(1)                              NCA02520
  ...
  103 CALL COSQF1 (N,X,WSAVE,WSAVE(N+1))                                NCA02590
      ...
      DIMENSION       X(1)       ,W(1)       ,XH(1)                     NCA02630
      NS2 = (N+1)/2                                                     NCA02640
      NP2 = N+2                                                         NCA02650
  ...
  103 CONTINUE                                                          NCA02840
      ...
      DIMENSION       X(1)       ,WSAVE(1)                              NCA02880
  ...
  103 CALL COSQB1 (N,X,WSAVE,WSAVE(N+1))                                NCA02970
      ...
      DIMENSION       X(1)       ,W(1)       ,XH(1)                     NCA03010
      NS2 = (N+1)/2                                                     NCA03020
      NP2 = N+2                                                         NCA03030
  ...
  102 CONTINUE                                                          NCA03450
      ...
      DIMENSION       X(1)       ,WSAVE(1)                              NCA03490
  ...
  103 CONTINUE                                                          NCA03630
      ...
      DIMENSION       WA(1)      ,IFAC(1)    ,NTRYH(4)                  NCA03750
  ...
  110 CONTINUE                                                          NCA04310
      ...
      DIMENSION       C(1)       ,WSAVE(1)                              NCA04350
      ...
      DIMENSION       CH(1)      ,C(1)       ,WA(1)      ,IFAC(1)       NCA04430
      NF = IFAC(2)                                                      NCA04440
      NA = 0                                                            NCA04450
      L1 = 1                                                            NCA04460
      IW = 1                                                            NCA04470
  ...
  104 CONTINUE                                                          NCA06160
     ...
     1                WA1(1)     ,WA2(1)     ,WA3(1)     ,WA4(1)        NCA06210
  ...
  104 CONTINUE                                                          NCA06910
     ...
     1                C1(IDO,L1,IP)          ,WA(1)      ,C2(IDL1,IP),  NCA06960
...
C                                                                       NCA07030
  ...
  130 CONTINUE                                                          NCA08070
      ...
      DIMENSION       C(1)       ,WSAVE(1)                              NCA08110
      ...
      DIMENSION       CH(1)      ,C(1)       ,WA(1)      ,IFAC(1)       NCA08190
      NF = IFAC(2)                                                      NCA08200
      NA = 0                                                            NCA08210
      L1 = 1                                                            NCA08220
      IW = 1                                                            NCA08230
  ...
  104 CONTINUE                                                          NCA09920
     ...
     1                WA1(1)     ,WA2(1)     ,WA3(1)     ,WA4(1)        NCA09970
  ...
  104 CONTINUE                                                          NCA10670
     ...
     1                C1(IDO,L1,IP)          ,WA(1)      ,C2(IDL1,IP),  NCA10720
...
C                                                                       NCA10790
  ...
  107 RETURN                                                            NCA14330
     ...
     1                WA1(1)     ,WA2(1)     ,WA3(1)     ,WA4(1)        NCA14370
  ...
  107 RETURN                                                            NCA18360
     ...
     1                WA1(1)     ,WA2(1)     ,WA3(1)     ,WA4(1)        NCA18400
