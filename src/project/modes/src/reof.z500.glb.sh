...
cp $lcdir/reof.z500.glb.f $tmp/pure_eof.f
...
#infile=R1.z500.jan1949-dec2021.std_cos
 ...
 outfile1=reof.${eof_area}.R1_$var.$mon.mtx$mtx.yre${end_yr}.mskip$mskip
 outfile2=reof.${eof_area}.R1_$var.$mon.mtx$mtx.yre${end_yr}.mskip$mskip.glb
 outfile3=rpc.${eof_area}.R1_$var.$mon.mtx$mtx.yre${end_yr}.mskip$mskip
#
cat > parm.h << eof
...
*'printim /cpc/home/wd52pp/project/modes/plot/$outfile2.png gif x1200 y1600'
'c'
EOF
