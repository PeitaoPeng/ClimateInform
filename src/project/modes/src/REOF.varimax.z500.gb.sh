...
#=====================================================
# Have EOF with eigrs REOF with varimax
#=========================================================
set -eaux
...
undefdata=-9.99e+8
#
cp $lcdir/REOF.varimax.z500.gb.f $tmp/eof.f
cp $lcdir/eigrs_varimax.s.f $tmp/reof.s.f
cd $tmp
#
#
...
#
 infile=monthly_tele_indices_1949-2021.in
 outfile1=eof.$mon
 outfile2=reof.$mon
#
cat > parm.h << eof
...
vars   1
e   0 99 normalized loading pattern
endvars
EOF
#
#=======================================
...
endwhile
'printim $datadir/$outfile2.vmx.2020.png gif x600 y800'
'c'
EOF
...
#
outfile3=eof.z500.1950-2020
outfile4=reof.z500.1950-2020.vmx
