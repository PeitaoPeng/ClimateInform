...
#
 ...
 ln -s $datadir/rsd_reof.NH.R1_z500.Jun.mtx1.nmod12.yre2000.gr fort.16
 ln -s $datadir/rsd_reof.NH.R1_z500.Jul.mtx1.nmod12.yre2000.gr fort.17
 ln -s $datadir/rsd_reof.NH.R1_z500.Aug.mtx1.nmod12.yre2000.gr fort.18
 ln -s $datadir/rsd_reof.NH.R1_z500.Sep.mtx1.nmod12.yre2000.gr fort.19
...
*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.95 REOF Pattern of Sep Z500 (1950-${end_yr})'
 'set strsiz 0.12 0.12'
*---------------------------set dimsnesion, page size and style
nframe=10
nframe2=5
...
endwhile
'printim /cpc/home/wd52pp/project/modes/plot/$outfile.sep.png gif x600 y800'
'c'
EOF
/usr/local/bin/grads -pb <have_plot
