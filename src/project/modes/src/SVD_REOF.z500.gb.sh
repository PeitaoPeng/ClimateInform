...
set -eaux
#==============================================================
# have EOF with SVD, REOF with varimax
#===========================================================
...
undefdata=-9.99e+8
#
cp $lcdir/SVD_REOF.z500.gb.f $tmp/svd_eof.f
...
eof
gfortran -o svd_eof.x reof.s.f svd_eof.f
echo "done compiling"
...
endwhile
'printim $datadir/$outfile2.png gif x600 y800'
'c'
EOF
