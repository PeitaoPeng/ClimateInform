...
C===========================================================
      ...
      real RPC2(neof,71),ts3(ny),ts4(ny)
     ...
     &,EVCT(ngrd,ifld)
C
      open(10,form='unformatted',access='direct',recl=4*imx2*jmx2) !obs
C
      open(50,form='unformatted',access='direct',recl=4*imx*jmx)
      open(51,form='unformatted',access='direct',recl=4*imx2*jmx2)
