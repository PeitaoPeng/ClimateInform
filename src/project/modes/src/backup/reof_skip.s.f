...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC       
     ...
     &                 ,NMOD,REVAL,REVCT,RPC,T,RWORK,RWORK2,mskip)                         
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC       
...
C                                                                       
c     parameter(eps=0.00001, delta=0.00001, norm=0)
      parameter(eps=0.00001, delta=0.00001, norm=1)
      DIMENSION A(M,N),EVAL(MN),EVCT(M,MN),PC(MN,N),WK(MN,M )           
...
c       RWORK2(I,J)= EVCT(I,J)*SQRT(EVAL(J))                              
        k=k+1
        RWORK2(I,k)= EVCT(I,J)*SQRT(EVAL(J))                              
      ENDDO
      ENDDO
C                                                                       
...
c         norm=0 (=1, Row normalization option; =0 no normalization performed)
