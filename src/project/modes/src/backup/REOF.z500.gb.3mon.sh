...
undefdata=-9.99e+8
#
cp $lcdir/REOF.z500.gb.3mon.f $tmp/eof.f
...
endwhile
'printim $datadir/$outfile2.3mon.png gif x600 y800'
'c'
EOF
...
#
outfile3=eof.z500.3mon.1950-2020
outfile4=reof.z500.3mon.1950-2020
