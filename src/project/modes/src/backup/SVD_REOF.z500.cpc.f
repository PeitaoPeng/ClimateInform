...
c     open(51,form='unformatted',access='direct',recl=4*imx*jmx)
...
c     write(11,rec=1) ((a(i,j),i=1,timedim),j=1,timedim)
c     write(14,rec=1) ((rawPC(j,l),j=1,timedim),l=1,timedim)
c     write(12,rec=1) ((v(i,j),i=1,spacedim),j=1,spacedim)
