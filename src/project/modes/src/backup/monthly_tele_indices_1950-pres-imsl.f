...
c read in time values produced by Grads script
      ...
      open (2,file='/cpc/home/wd52gb/eof_new/daymon.dat',
     &status='unknown')
c
...
c
      ...
      dimension zz(ngpt),zproj(ieof),a(ieof,ieof),
     &aeofs(ieof,ngpt),ampltud(ieof)
      real soln(numeofs),aa(numeofs,numeofs),pi,rad
      integer iipos2(ieof)
c
...
c
      call lslrg(numeofs,aa,numeofs,zproj,1,soln)
c
