...
C===========================================================
      ...
      real eout(ngrd),eout2(ngrd)

      real vv(ngrd,ngrd),vv2(ngrd,ngrd)
      real aa(ifld,ngrd)
...
c Transpose data so it is in the form time-space
      ...
      call varimax(vv,aa,ngrd,ifld,neof,neof)
c
