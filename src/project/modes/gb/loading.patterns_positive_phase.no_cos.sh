#!/bin/sh
#==========================================================
# have positive loading patterns
#=========================================
...
\rm fort.*
#
cp $lcdir/loading.patterns_positive_phase.no_cos.f pat.f
f77 -o pat.x pat.f
echo "done compiling"
#
 ln -s $datadir/reof.z500.1950-2000.no_cos.gr         fort.10
 ln -s $datadir/reof.positive_phase.z500.1950-$endyr.no_cos.gr  fort.11
#
pat.x
#
cat>reof.positive_phase.z500.1950-$endyr.no_cos.ctl<<EOF
dset ^reof.positive_phase.z500.1950-$endyr.no_cos.gr
undef -9.99E+8
...
EOF
#
mv reof.positive_phase.z500.1950-$endyr.no_cos.ctl $datadir
