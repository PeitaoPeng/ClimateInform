...
datadir1=/cpc/consistency/telecon
datadir2=/cpc/consistency/telecon/gb
#
endyr=2000
undefdata=-9.99e+8
#
...
\rm fort.*
#
cp $lcdir/loading.patterns_positive_phase.select.f pat.f
f77 -o pat.x pat.f
echo "done compiling"
#
 ln -s $datadir1/reof.NH.z500.1950-${endyr}.select.gr         fort.10
 ln -s $datadir2/reof.positive_phase.z500.1950-$endyr.select.gr  fort.11
#
pat.x
#
cat>reof.positive_phase.z500.1950-$endyr.select.ctl<<EOF
dset ^reof.positive_phase.z500.1950-$endyr.select.gr
undef -9.99E+8
...
EOF
#
mv reof.positive_phase.z500.1950-$endyr.select.ctl $datadir2
