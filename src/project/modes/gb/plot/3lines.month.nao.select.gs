...
'open /cpc/consistency/telecon/gb/monthly_raw_tele_indices.2000.local_proj.NAO.ctl'
*
...
'set string 1 tl 5'
'set strsiz 0.12'
'draw string 1.0 10.57 new(all area proj, AC=0.83)'
*
'set line 3'
'set cmark 0'
...
'set string 1 tl 5'
'set strsiz 0.12'
'draw string 5.0 10.57 new(local proj, AC=0.88)'
*
'printim mon.nao.3lines.select.gif white'
'set t 1'
