...
'reinit'
'open /cpc/consistency/telecon/gb/monthly_pna_indices.gb2000.ctl'
'open /cpc/consistency/telecon/gb/monthly_raw_tele_indices.2000.select.ctl'
*
...
*
'set t 1 12'
'define clm1=ave('pna',t+0,t=852,12)'
'define clm2=ave('pna.2',t+0,t=852,12)'
'modify clm1 seasonal'
'modify clm2 seasonal'
*'define var = ave(pow('pna'-clim,2),t+372,t=732,12)'
'define var1 = ave(pow('pna'-clm1,2),t+0,t=852,12)'
'define var2 = ave(pow('pna.2'-clm2,2),t+0,t=852,12)'
'modify var1 seasonal'
'modify var2 seasonal'
'set time jan1950 'cmon''year
'define nidx1=('pna'-clm1)/sqrt(var1)'
'define nidx2=('pna.2'-clm2)/sqrt(var2)'
*
...
'set strsiz 0.15'
'set string 4 tc 6'
'draw string 4.25 10.85 3-Month Running Mean PNA Index'
'set cthick 5'
'set line 1'
'set cmark 0'
...
'set string 1 tl 5'
'set strsiz 0.12'
'draw string 1.0 10.57 new(1950-2000 REOF AC=0.66)'
*
'set line 3'
'set cmark 0'
*'draw line 4.5 10.5 5.0 10.5'
'set string 1 tl 5'
'set strsiz 0.12'
*'draw string 5.0 10.57 new-2(1950-2020 REOF AC=0.84)'
*
'printim mon.pna.2lines.select.gif white'
'set t 1'
