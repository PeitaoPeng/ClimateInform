...
'define clm3=ave('pna.3',t+0,t=852,12)'
...
'define var3 = ave(pow('pna.3'-clm3,2),t+0,t=852,12)'
...
'define nidx3=('pna.3'-clm3)/sqrt(var3)'
*
...
'set strsiz 0.15'
'set string 4 tc 6'
'draw string 5.5 8.2 Monthly PNA Index'
'set cthick 5'
'set line 2'
'set cmark 0'
...
*
'printim mon.pna.3lines.recent.gif white'
'set t 1'
