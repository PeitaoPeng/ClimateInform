'reinit'
'open /cpc/consistency/telecon/gb/reof.positive_phase.z500.1950-2000.select.ctl'
*Plot the loading patterns used in the codes to calcualte the teleconnection indices
*file is rotated_original_loadingpatterns_jun-nov.gs
*
...
*'enable print 'tele'.loading_jun-nov.gmf'
plotfil=tele"_pattern_jun-nov.ye2000.select"
*
...
if(iloop = 1)
'set line 4 1 7'
'draw line 285 20 285 87.5'
'draw line 360 20 360 87.5'
endif
endif
'draw string 5.5 8.3 'name' (Positive Phase Shown)'
'draw string 5.5 8.05 1950-2000 Covariance Based Varimax REOF for Calculating Indices'
*
'set t 7'
month="July"
xl=xr0+xinc
...
yb=yb0
yt=yt0
*if(iloop != 7 & iloop != 8 & iloop != 9 & iloop != 10)
if(iloop != 8 & iloop != 9 & iloop != 10)
