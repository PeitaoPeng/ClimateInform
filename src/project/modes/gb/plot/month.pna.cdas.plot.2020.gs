** Create standardized 3-month running mean PNA index plot
eyr=2020
'reinit'
...
*
'define sd1=sqrt(ave(pna*pna,t=1,t=870))'
'define sd2=sqrt(ave(pna.2*pna.2,t=1,t=870))'
'define ac=ave(pna*pna.2,t=1,t=870)/(sd1*sd2)'
*
...
*
'set t 1 12'
*'define clim=ave('pna',t+372,t=732,12)'
'define clim=ave('pna',t+0,t=612,12)'
'modify clim seasonal'
*'define var = ave(pow('pna'-clim,2),t+372,t=732,12)'
'define var = ave(pow('pna'-clim,2),t+0,t=612,12)'
'modify var seasonal'
'set time jan1950 'cmon''year
'define normtel=('pna'-clim)/sqrt(var)'
*
...
'set strsiz 0.17'
'set string 4 tc 6'
'draw string 5 10.8 3-Month Running Mean PNA Index'
'draw string 5 10.5 Through 'month' 'year '(1950-2020 pattern)'
*
'printim mon.pna.'eyr'.gif white'
*'define sd1=sqrt(ave(pna*pna,t=1,t=870))'
*'define sd2=sqrt(ave(pna.2*pna.2,t=1,t=870))'
*'define ac=ave(pna*pna.2,t=1,t=870)/(sd1*sd2)'
*'disable'
