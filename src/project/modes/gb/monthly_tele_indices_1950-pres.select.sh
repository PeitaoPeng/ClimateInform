...
eof_end_yr=2000
cd $tmp
cp $lcdir/monthly_tele_indices_1950-pres.select.f index.f
...
#
 ...
 ln -s $datadir/monthly_raw_tele_indices.${eof_end_yr}.select.bi     fort.24
 ln -s $datadir/monthly_raw_tele_indices.${eof_end_yr}.select.ctl    fort.26
 ln -s $datadir/monthly_tele_indices.${eof_end_yr}.select.bi         fort.25
 ln -s $datadir/monthly_tele_indices.${eof_end_yr}.select.ctl        fort.27
#
index.x 
#
