...
*
'set time jan1949 dec2011'
'define z500=hgt'
'set t 1 12'
'define z500c=ave(z500,t+12,t=744,12)'
'modify z500c seasonal'
'define varzc=ave(pow(z500-z500c,2),t+12,t=744,12)'
...
*
'set gxout fwrite'
*'set fwrite /cpc/consistency/telecon/gb/monthly_tele_pattern_1949-2001.in'
*'set fwrite /cpc/consistency/telecon/gb/monthly_tele_pattern_1949-2001.no_cos.in'
'set fwrite /cpc/consistency/telecon/gb/monthly_tele_pattern_1949-2011.no_cos.in'
'set t 'beg' 'end
*'d (z500-z500c)/sqrt(varzc)*sqrt(cos(lat*rad))'
'd (z500-z500c)/sqrt(varzc)'
'disable fwrite'
'quit'
*
function mydate
