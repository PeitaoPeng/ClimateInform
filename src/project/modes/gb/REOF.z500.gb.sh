#!/bin/sh
#==========================================================
# have EOF with eigrs, REOF with ofrota code
#=========================================
...
undefdata=-9.99e+8
#
cp $lcdir/REOF.z500.gb.f $tmp/eof.f
...
#
#infile=monthly_tele_pattern_1949-2011.no_cos.in
#infile=monthly_tele_pattern_1949-2001.no_cos.in
 infile=monthly_tele_pattern_1949-2001.in
#infile=monthly_tele_pattern_1949-2021.in
 outfile1=eof.$mon
 outfile2=reof.$mon
 outfile5=rpc.$mon.z500.1950-${end_yr}
#outfile5=rpc.$mon.z500.1950-${end_yr}.no_cos
#
cat > parm.h << eof
...
#
 ...
 ln -s $datadir/$outfile5.gr    fort.53
#
...
endwhile
*'printim $datadir/$outfile2.1950-${end_yr}.no_cos.png gif x600 y800'
'printim $datadir/$outfile2.1950-${end_yr}.png x600 y800'
'c'
EOF
...
#
outfile3=eof.z500.1950-${end_yr}
outfile4=reof.z500.1950-${end_yr}
#outfile3=eof.z500.1950-${end_yr}.no_cos
#outfile4=reof.z500.1950-${end_yr}.no_cos
...
cat reof.Jan.gr reof.Feb.gr reof.Mar.gr reof.Apr.gr reof.May.gr reof.Jun.gr reof.Jul.gr reof.Aug.gr reof.Sep.gr reof.Oct.gr reof.Nov.gr reof.Dec.gr > $outfile4.gr
#
mv $outfile3.gr $datadir
mv $outfile4.gr $datadir
#
