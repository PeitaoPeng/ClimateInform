...
c read in month and year to calculate eof amplitudes for
 ...
 1212 ntim=(dyrf-1950)*12+bmf
  ...
  10  continue
      ...
      parameter(nsn=12,ieof=10,neof=10,imx=144,jmx=28,neof1=neof+1)
      parameter(is=115,ie=144,iln=35,ilt=28,ngpt=iln*ilt)
...
c
      dimension z1(imx,jmx),z2(imx,jmx)
      real expvar2(nmon)
...
c Input standardized anomalies--arranged south-to-north
      open (1,form='unformatted',access='direct',recl=4*imx*jmx)
c
...
c
       ...
       write(26,300)
 300  format('DSET ^monthly_raw_tele_indices.2000.local_proj.NAO.bi')
       write(27,301)
c23456789012345678901234567890123456789012345678901234567890123456789012
 301  format('DSET ^monthly_tele_indices.2000.local_proj.NAO.bi')
       write(26,302) 
       write(27,302)
 302   format('*') 
       write(26,785)
...
c
c     parameter(nsn=12,ieof=10,iln=144,ilt=28,ngpt=iln*ilt)
      parameter(nsn=12,ieof=10,iln=35,ilt=28,ngpt=iln*ilt)
...
c
c     parameter(ieof=10,iln=144,ilt=28,ngpt=iln*ilt)
      parameter(ieof=10,iln=35,ilt=28,ngpt=iln*ilt)
