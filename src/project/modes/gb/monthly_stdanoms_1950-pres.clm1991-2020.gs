...
'define z500=hgt'
'set t 1 12'
'define z500c=ave(z500,t+492,t=852,12)'
'modify z500c seasonal'
'define varzc=ave(pow(z500-z500c,2),t+492,t=852,12)'
...
*
'set gxout fwrite'
'set fwrite /cpc/consistency/telecon/gb/monthly_tele_indices_1950-pres.clm1991-2020.in'
'set t 'beg' 'end
