...
*'draw string 5.5 7.75 Z200 CORR to NINO34 SST (51-99 JFM)'
*'draw string 5.5 7.75 Z200 CORR to IPCC Global Mean SST (51-99 JFM)'
*'draw string 5.5 7.75 Z200 CORR to AMO (51-99 JFM)'
*'draw string 5.5 7.75 Z200 CORR to PDO (51-99 JFM)'
 'draw string 5.5 7.75 Z200 CORR to RPC11 (51-99 JFM)'
...
*
 'run /export/hobbes/wd52pp/bin/cbarn2.gs 1. 0 5.5 0.8'
  iframe=iframe+1
endwhile
*'print'
 'printim obs_gcm.z200_rpc11.4idx_us.png gif x800 y600'
*'printim obs_gcm.z200_glmsst.png gif x800 y600'
*'printim obs_gcm.z200_nino34.png gif x800 y600'
*'printim obs_gcm.z200_amo_us.png gif x800 y600'
*'printim obs_gcm.z200_pdo_us.png gif x800 y600'
*'c'
 'set vpage off'
*----------
