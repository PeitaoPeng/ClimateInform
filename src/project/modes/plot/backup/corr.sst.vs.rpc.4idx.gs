...
*
'open /export-12/cacsrv1/wd52pp/modes/corr.idx_rcoef.vs.sst.51-99jfm.4idx_us.ctl'
...
'draw string 5.5 8.25 Corr (SST vs idx & Z200 rsd_rpc) (51-99 JFM)'
...
'run /export/hobbes/wd52pp/bin/dline.gs 180 -30 180 80'
'set gxout contour'
'set csmooth on'
*'set cint 0.5'
*'set ccolor 1'
...
endwhile
*'print'
'printim corr.rpc_vs_sst.4idx_us.png gif x800 y600'
*'c'
 'set vpage off'
*----------
