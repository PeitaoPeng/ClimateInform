...
'draw string 5.5 7.5 JFM Z200 ACC vs Skill of Regr Pattern to Nino34'
...
'set vrange2 0 50'
if (iframe = 1);'d spr;cor*100';endif
if (iframe = 2);'d spc;cor*100';endif
'draw ylab ACC(%)'
if (iframe = 1);'draw xlab RMS Error';endif
if (iframe = 2);'draw xlab CORR Coef';endif
*----------
  iframe=iframe+1
*'run /export/hobbes/wd52pp/bin/cbarn2.gs 1.0 0 5.5 0.5'
endwhile
*'print'
'printim cor_vs_regr.png gif x800 y600'
*'c'
 'set vpage off'
*----------
