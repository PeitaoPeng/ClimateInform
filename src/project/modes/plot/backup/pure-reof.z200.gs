...
*
'open /export-12/cacsrv1/wd52pp/bias_skill/reof.z200.jfm.51-99.ctl'
...
'draw string 5.5 7.75 REOFs of Z200 (51-99 JFM)'
*---------------------------set dimsnesion, page size and style
nframe=12
nframe2=4
nframe3=8
xmin0=0.75;  xlen=3.;  xgap=0.25
ymax0=7.25; ylen=-1.4;  ygap=-0.0
*
iframe=1
while ( iframe <= nframe )
...
*----------
 ...
 if(iframe = 2); 'draw string 'titlx' 'titly' reof2'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' reof3'; endif
 if(iframe = 4); 'draw string 'titlx' 'titly' reof4'; endif
 if(iframe = 5); 'draw string 'titlx' 'titly' reof5'; endif
 if(iframe = 6); 'draw string 'titlx' 'titly' reof6'; endif
 if(iframe = 7); 'draw string 'titlx' 'titly' reof7'; endif
 if(iframe = 8); 'draw string 'titlx' 'titly' reof8'; endif
 if(iframe = 9); 'draw string 'titlx' 'titly' reof9'; endif
 if(iframe = 10); 'draw string 'titlx' 'titly' reof10'; endif
 if(iframe = 11); 'draw string 'titlx' 'titly' reof11'; endif
 if(iframe = 12); 'draw string 'titlx' 'titly' reof12'; endif
'set strsiz 0.12 0.12'
...
*
 'run /export/hobbes/wd52pp/bin/cbarn2.gs 1. 0 5.5 1.25'
  iframe=iframe+1
endwhile
*'print'
'printim reof.z200.png gif x800 y600'
*'c'
 'set vpage off'
*----------
