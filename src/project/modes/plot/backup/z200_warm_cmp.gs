...
'define stdv8=wc(t=8)'
'define stdv9=wc(t=9)'
'define stdv10=wc(t=10)'
'define stdv11=wc(t=11)'
'define stdv12=wc(t=12)'

'set string 1 tc 4'
'set strsiz 0.18 0.18'
'draw string 5.5 8.25 Z200 Composite of El Nino Events'
...
'set strsiz 0.12 0.12'
 if(iframe = 1); 'draw string 'numbx' 'numby' 0.88'; endif
 if(iframe = 2); 'draw string 'numbx' 'numby' 0.92'; endif
 if(iframe = 3); 'draw string 'numbx' 'numby' 0.85'; endif
 if(iframe = 4); 'draw string 'numbx' 'numby' 0.89'; endif
 if(iframe = 5); 'draw string 'numbx' 'numby' 0.71'; endif
 if(iframe = 6); 'draw string 'numbx' 'numby' 0.79'; endif
 if(iframe = 7); 'draw string 'numbx' 'numby' 0.88'; endif
 if(iframe = 8); 'draw string 'numbx' 'numby' 0.86'; endif
 if(iframe = 9); 'draw string 'numbx' 'numby' 0.69'; endif
 if(iframe = 10); 'draw string 'numbx' 'numby' 0.92'; endif
 if(iframe = 11); 'draw string 'numbx' 'numby' 0.90'; endif
*
 'run /export/hobbes/wd52pp/bin/cbarn2.gs 1. 0 5.5 0.35'
  iframe=iframe+1
endwhile
*'print'
'printim z200_warm_comp.png gif x800 y600'
*'c'
 'set vpage off'
*----------
