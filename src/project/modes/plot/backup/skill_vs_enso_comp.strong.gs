...
'draw string 5.5 8.25 JFM Z200 ACC vs Skill of Strong ENSO Composits'
...
'set vrange2 0 50'
if (iframe = 1);'d swc;cor*100';endif
if (iframe = 2);'d swr;cor*100';endif
if (iframe = 3);'d scc;cor*100';endif
if (iframe = 4);'d scr;cor*100';endif
'draw ylab ACC(%)'
...
endwhile
*'print'
'printim cor_vs_enso_comp.s.png gif x800 y600'
*'c'
 'set vpage off'
*----------
