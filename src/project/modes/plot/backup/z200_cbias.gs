...
*---------------------------string/caption
*
'define stdv1=bia(t=1)'
'define stdv2=bia(t=2)'
'define stdv3=bia(t=3)'
'define stdv4=bia(t=4)'
'define stdv5=bia(t=5)'
'define stdv6=bia(t=6)'
'define stdv7=bia(t=7)'
'define stdv8=bia(t=8)'
'define stdv9=bia(t=9)'
'define stdv10=bia(t=10)'
'define stdv11=bia(t=11)'

'set string 1 tc 4'
'set strsiz 0.18 0.18'
'draw string 5.5 8.25 Clim Bias of AMIP JFM Z200'
...
'set strsiz 0.12 0.12'
 if(iframe = 1); 'draw string 'numbx' 'numby' 70'; endif
 if(iframe = 2); 'draw string 'numbx' 'numby' 49'; endif
 if(iframe = 3); 'draw string 'numbx' 'numby' 120'; endif
 if(iframe = 4); 'draw string 'numbx' 'numby' 73'; endif
 if(iframe = 5); 'draw string 'numbx' 'numby' 47'; endif
 if(iframe = 6); 'draw string 'numbx' 'numby' 68'; endif
 if(iframe = 7); 'draw string 'numbx' 'numby' 53'; endif
 if(iframe = 8); 'draw string 'numbx' 'numby' 63'; endif
 if(iframe = 9); 'draw string 'numbx' 'numby' 71'; endif
 if(iframe = 10); 'draw string 'numbx' 'numby' 151'; endif
 if(iframe = 11); 'draw string 'numbx' 'numby' 158'; endif
*
 'run /export/hobbes/wd52pp/bin/cbarn2.gs 1. 0 5.5 0.35'
  iframe=iframe+1
endwhile
*'print'
'printim skill_cbias.png gif x800 y600'
*'c'
 'set vpage off'
*----------
