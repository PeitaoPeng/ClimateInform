...
*
'open /export-12/cacsrv1/wd52pp/bias_skill/rsd_eof.z200.jfm.51-99.ctl'
...
*----------
 ...
 if(iframe = 3); 'draw string 'titlx' 'titly' rsd_reof1'; endif
 if(iframe = 4); 'draw string 'titlx' 'titly' rsd_reof2'; endif
 if(iframe = 5); 'draw string 'titlx' 'titly' rsd_reof3'; endif
 if(iframe = 6); 'draw string 'titlx' 'titly' rsd_reof4'; endif
 if(iframe = 7); 'draw string 'titlx' 'titly' rsd_reof5'; endif
 if(iframe = 8); 'draw string 'titlx' 'titly' rsd_reof6'; endif
 if(iframe = 9); 'draw string 'titlx' 'titly' rsd_reof7'; endif
 if(iframe = 10); 'draw string 'titlx' 'titly' rsd_reof8'; endif
 if(iframe = 11); 'draw string 'titlx' 'titly' rsd_reof9'; endif
 if(iframe = 12); 'draw string 'titlx' 'titly' rsd_reof10'; endif
 if(iframe = 13); 'draw string 'titlx' 'titly' rsd_reof11'; endif
'set strsiz 0.12 0.12'
...
endwhile
*'print'
'printim rsd_reof.z200.png gif x800 y600'
*'c'
 'set vpage off'
*----------
