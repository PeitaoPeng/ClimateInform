...
*
'open /export-12/cacsrv1/wd52pp/bias_skill/regr_nino34.z200.jfm.51-99.ctl'
'run /export/hobbes/wd52pp/bin/rgbset2.gs'
*'enable print Fig_14'
*
*---------------------------string/caption
*
'define stdv1=reg(t=2)'
'define stdv2=reg(t=3)'
'define stdv3=reg(t=4)'
'define stdv4=reg(t=5)'
'define stdv5=reg(t=6)'
'define stdv6=reg(t=7)'
'define stdv7=reg(t=8)'
'define stdv8=reg(t=9)'
'define stdv9=reg(t=10)'
'define stdv10=reg(t=11)'
'define stdv11=reg(t=12)'
'define stdv12=reg(t=1)'

'set string 1 tc 4'
'set strsiz 0.18 0.18'
'draw string 5.5 8.25 Z200 Regr to Nino34'
...
'set ccols   49 47 45 43 23 25 27 29'
'set xlab off'
'set ylab off'
*'set yaxis 80 80 10'
 'd stdv'%iframe
...
'set strsiz 0.12 0.12'
 if(iframe = 1); 'draw string 'numbx' 'numby' 0.83'; endif
 if(iframe = 2); 'draw string 'numbx' 'numby' 0.97'; endif
 if(iframe = 3); 'draw string 'numbx' 'numby' 0.90'; endif
 if(iframe = 4); 'draw string 'numbx' 'numby' 0.87'; endif
 if(iframe = 5); 'draw string 'numbx' 'numby' 0.77'; endif
 if(iframe = 6); 'draw string 'numbx' 'numby' 0.84'; endif
 if(iframe = 7); 'draw string 'numbx' 'numby' 0.92'; endif
 if(iframe = 8); 'draw string 'numbx' 'numby' 0.93'; endif
 if(iframe = 9); 'draw string 'numbx' 'numby' 0.68'; endif
 if(iframe = 10); 'draw string 'numbx' 'numby' 0.95'; endif
 if(iframe = 11); 'draw string 'numbx' 'numby' 0.93'; endif
*
 'run /export/hobbes/wd52pp/bin/cbarn2.gs 1. 0 5.5 0.35'
  iframe=iframe+1
endwhile
*'print'
'printim z200_regr_nino34.png gif x800 y600'
*'c'
 'set vpage off'
*----------
