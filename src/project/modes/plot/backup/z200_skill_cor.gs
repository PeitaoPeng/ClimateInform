...
'define stdv7=cor(t=7)'
'define stdv8=cor(t=8)'
'define stdv9=cor(t=9)'
'define stdv10=cor(t=10)'
'define stdv11=cor(t=11)'

'set string 1 tc 4'
'set strsiz 0.18 0.18'
'draw string 5.5 8. Skill(corrx100) of AMIP JFM Z200'
...
'set strsiz 0.12 0.12'
 if(iframe = 1); 'draw string 'numbx' 'numby' 36'; endif
 if(iframe = 2); 'draw string 'numbx' 'numby' 43'; endif
 if(iframe = 3); 'draw string 'numbx' 'numby' 43'; endif
 if(iframe = 4); 'draw string 'numbx' 'numby' 41'; endif
 if(iframe = 5); 'draw string 'numbx' 'numby' 38'; endif
 if(iframe = 6); 'draw string 'numbx' 'numby' 38'; endif
 if(iframe = 7); 'draw string 'numbx' 'numby' 46'; endif
 if(iframe = 8); 'draw string 'numbx' 'numby' 46'; endif
 if(iframe = 9); 'draw string 'numbx' 'numby' 31'; endif
 if(iframe = 10); 'draw string 'numbx' 'numby' 33'; endif
 if(iframe = 11); 'draw string 'numbx' 'numby' 34'; endif
*
 'run /export/hobbes/wd52pp/bin/cbarn2.gs 1. 0 5.5 0.75'
  iframe=iframe+1
endwhile
*'print'
'printim skill_corr.png gif x800 y600'
*'c'
 'set vpage off'
*----------
