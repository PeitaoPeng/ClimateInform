...
*
'open /export-12/cacsrv1/wd52pp/modes/rsd_eof.z200.jfm.51-99.4idx_us.ctl'
...
'draw string 5.5 8.5 Decomposition of Z200 (51-99 JFM)'
*---------------------------set dimsnesion, page size and style
nframe=15
nframe2=5
nframe3=10
xmin0=0.75;  xlen=3.;  xgap=0.25
ymax0=8.; ylen=-1.4;  ygap=-0.1
*
iframe=1
while ( iframe <= nframe )
...
'run /export/hobbes/wd52pp/bin/dline.gs 180 -30 180 90'
'set gxout contour'
'set csmooth on'
*'set cint 0.5'
*'set ccolor 1'
...
*----------
 ...
 if(iframe = 4); 'draw string 'titlx' 'titly' regr to PDO'; endif
 if(iframe = 5); 'draw string 'titlx' 'titly' rsd_reof1'; endif
 if(iframe = 6); 'draw string 'titlx' 'titly' rsd_reof2'; endif
 if(iframe = 7); 'draw string 'titlx' 'titly' rsd_reof3'; endif
 if(iframe = 8); 'draw string 'titlx' 'titly' rsd_reof4'; endif
 if(iframe = 9); 'draw string 'titlx' 'titly' rsd_reof5'; endif
 if(iframe = 10); 'draw string 'titlx' 'titly' rsd_reof6'; endif
 if(iframe = 11); 'draw string 'titlx' 'titly' rsd_reof7'; endif
 if(iframe = 12); 'draw string 'titlx' 'titly' rsd_reof8'; endif
 if(iframe = 13); 'draw string 'titlx' 'titly' rsd_reof9'; endif
 if(iframe = 14); 'draw string 'titlx' 'titly' rsd_reof10'; endif
 if(iframe = 15); 'draw string 'titlx' 'titly' rsd_reof11'; endif
 if(iframe = 16); 'draw string 'titlx' 'titly' rsd_reof12'; endif
'set strsiz 0.12 0.12'
...
*
 'run /export/hobbes/wd52pp/bin/cbarn2.gs 1. 0 5.5 0.25'
  iframe=iframe+1
endwhile
*'print'
'printim rsd_reof.z200.4idx_us.png gif x800 y600'
*'c'
 'set vpage off'
*----------
