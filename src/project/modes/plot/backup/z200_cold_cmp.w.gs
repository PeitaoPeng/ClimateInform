...
*---------------------------string/caption
*
'define stdv1=cc2(t=1)'
'define stdv2=cc2(t=2)'
'define stdv3=cc2(t=3)'
'define stdv4=cc2(t=4)'
'define stdv5=cc2(t=5)'
'define stdv6=cc2(t=6)'
'define stdv7=cc2(t=7)'
'define stdv8=cc2(t=8)'
'define stdv9=cc2(t=9)'
'define stdv10=cc2(t=10)'
'define stdv11=cc2(t=11)'
'define stdv12=cc2(t=12)'

'set string 1 tc 4'
'set strsiz 0.18 0.18'
'draw string 5.5 8.25 Z200 Composite of Weak La Nina Events'
...
'set strsiz 0.12 0.12'
 if(iframe = 1); 'draw string 'numbx' 'numby' 0.19'; endif
 if(iframe = 2); 'draw string 'numbx' 'numby' 0.65'; endif
 if(iframe = 3); 'draw string 'numbx' 'numby' 0.37'; endif
 if(iframe = 4); 'draw string 'numbx' 'numby' 0.66'; endif
 if(iframe = 5); 'draw string 'numbx' 'numby' -0.11'; endif
 if(iframe = 6); 'draw string 'numbx' 'numby' 0.25'; endif
 if(iframe = 7); 'draw string 'numbx' 'numby' 0.29'; endif
 if(iframe = 8); 'draw string 'numbx' 'numby' 0.48'; endif
 if(iframe = 9); 'draw string 'numbx' 'numby' -0.14'; endif
 if(iframe = 10); 'draw string 'numbx' 'numby' 0.13'; endif
 if(iframe = 11); 'draw string 'numbx' 'numby' 0.22'; endif
*
 'run /export/hobbes/wd52pp/bin/cbarn2.gs 1. 0 5.5 0.35'
  iframe=iframe+1
endwhile
*'print'
'printim z200_cold_comp.w.png gif x800 y600'
*'c'
 'set vpage off'
*----------
