...
*'draw string 5.5 8. Z200 Regression to Nino34 (51-99 JFM)'
'draw string 5.5 8. Z200 Regression to IPCC Global mean SST (51-99 JFM)'
...
endwhile
*'print'
*'printim obs_gcm.z200_glsst.png gif x800 y600'
*'c'
 'set vpage off'
*----------
