...
*
'open /export-12/cacsrv1/wd52pp/bias_skill/corr.idx_rcoef.vs.sst.51-99jfm.3idx_sm.ctl'
...
'draw string 5.5 8.25 Corr (SST vs idx & Z200 RPC) (51-99 JFM)'
...
*----------
 ...
 if(iframe = 3); 'draw string 'titlx' 'titly' vs Z200 RPC1'; endif
 if(iframe = 4); 'draw string 'titlx' 'titly' vs Z200 RPC2'; endif
 if(iframe = 5); 'draw string 'titlx' 'titly' vs Z200 RPC3'; endif
 if(iframe = 6); 'draw string 'titlx' 'titly' vs Z200 RPC4'; endif
 if(iframe = 7); 'draw string 'titlx' 'titly' vs Z200 RPC5'; endif
 if(iframe = 8); 'draw string 'titlx' 'titly' vs Z200 RPC6'; endif
 if(iframe = 9); 'draw string 'titlx' 'titly' vs Z200 RPC7'; endif
 if(iframe = 10); 'draw string 'titlx' 'titly' vs Z200 RPC8'; endif
 if(iframe = 11); 'draw string 'titlx' 'titly' vs Z200 RPC9'; endif
 if(iframe = 12); 'draw string 'titlx' 'titly' vs Z200 RPC10'; endif
 if(iframe = 13); 'draw string 'titlx' 'titly' vs Z200 RPC11'; endif
'set strsiz 0.12 0.12'
...
endwhile
*'print'
'printim corr.rpc_vs_sst.3idx_sm.png gif x800 y600'
*'c'
 'set vpage off'
*----------
