...
*---------------------------string/caption
*
'define stdv1=wc2(t=1)'
'define stdv2=wc2(t=2)'
'define stdv3=wc2(t=3)'
'define stdv4=wc2(t=4)'
'define stdv5=wc2(t=5)'
'define stdv6=wc2(t=6)'
'define stdv7=wc2(t=7)'
'define stdv8=wc2(t=8)'
'define stdv9=wc2(t=9)'
'define stdv10=wc2(t=10)'
'define stdv11=wc2(t=11)'
'define stdv12=wc2(t=12)'

'set string 1 tc 4'
'set strsiz 0.18 0.18'
'draw string 5.5 8.25 Z200 Composite of Weak El Nino Events'
...
endwhile
*'print'
'printim z200_warm_comp.w.png gif x800 y600'
*'c'
 'set vpage off'
*----------
