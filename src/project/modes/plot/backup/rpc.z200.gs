...
*
'open /export-12/cacsrv1/wd52pp/bias_skill/rcoef.z200.jfm.51-99.ctl'
...
'draw string 5.5 8. RPCs of Z200 (51-99 JFM)'
*---------------------------set dimsnesion, page size and style
nframe=12
nframe2=4
nframe3=8
xmin0=0.75;  xlen=3.;  xgap=0.5
ymax0=7.25; ylen=-1.25;  ygap=-0.3
*
iframe=1
while ( iframe <= nframe )
...
*----------
 ...
 if(iframe = 7); 'draw string 'titlx' 'titly' rpc7'; endif
 if(iframe = 8); 'draw string 'titlx' 'titly' rpc8'; endif
 if(iframe = 9); 'draw string 'titlx' 'titly' rpc9'; endif
 if(iframe = 10); 'draw string 'titlx' 'titly' rpc10'; endif
 if(iframe = 11); 'draw string 'titlx' 'titly' rpc11'; endif
 if(iframe = 12); 'draw string 'titlx' 'titly' rpc12'; endif
'set strsiz 0.12 0.12'
...
endwhile
*'print'
'printim rpc.z200.png gif x800 y600'
*'c'
 'set vpage off'
*----------
