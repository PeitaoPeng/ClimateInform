...
*
'open /export-12/cacsrv1/wd52pp/bias_skill/idx_rcoef.z200.jfm.51-99.3idx_sm.ctl'
...
*----------
 ...
 if(iframe = 4); 'draw string 'titlx' 'titly' rsd_rpc1'; endif
 if(iframe = 5); 'draw string 'titlx' 'titly' rsd_rpc2'; endif
 if(iframe = 6); 'draw string 'titlx' 'titly' rsd_rpc3'; endif
 if(iframe = 7); 'draw string 'titlx' 'titly' rsd_rpc4'; endif
 if(iframe = 8); 'draw string 'titlx' 'titly' rsd_rpc5'; endif
 if(iframe = 9); 'draw string 'titlx' 'titly' rsd_rpc6'; endif
 if(iframe = 10); 'draw string 'titlx' 'titly' rsd_rpc7'; endif
 if(iframe = 11); 'draw string 'titlx' 'titly' rsd_rpc8'; endif
 if(iframe = 12); 'draw string 'titlx' 'titly' rsd_rpc9'; endif
 if(iframe = 13); 'draw string 'titlx' 'titly' rsd_rpc10'; endif
 if(iframe = 14); 'draw string 'titlx' 'titly' rsd_rpc11'; endif
 if(iframe = 15); 'draw string 'titlx' 'titly' rsd_rpc12'; endif
'set strsiz 0.12 0.12'
...
endwhile
*'print'
'printim idx_rpc.z200.3idx_sm.png gif x800 y600'
*'c'
 'set vpage off'
*----------
