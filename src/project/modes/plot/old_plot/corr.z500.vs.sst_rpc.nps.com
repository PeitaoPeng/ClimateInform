...
set string 1 tc 8
set strsiz 0.2 0.2
draw string 4.0 10.8 Z500 regr to tp_sst_rpc and rsd_glb_sst_rpc
set t 1
...
set string 1 tc 8
set strsiz 0.2 0.2
draw string 4.0 10.8 Z500 regr to rsd_glb_sst_rpc (1950-2001 DJFM)
set t 3
set vpage 1 4 7.0 10.0
set grads off
set gxout shaded
