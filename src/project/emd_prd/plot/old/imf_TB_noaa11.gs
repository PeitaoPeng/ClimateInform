...
*
'open /gpfsuser/g03/wx52pp/emd/imf_TB_noaa11.ctl'
'enable print  imf_TB_noaa11.gr'
...
'draw string 4.25 10.5 TB_noaa11 and its EMD (Oct1988-Apr1998)'
...
if(iframe = 8); 'set vrange 251 251.5'; endif
if(iframe = 8); 'set yaxis 251 251.5 0.1'; endif
'set cmark 0'
'd stdv'%iframe
'define zero=0.0'
'd zero'
...
endwhile
'print'
'printim imf_TB_noaa11.png gif x600 y800'
*'c'
 'set vpage off'
*----------
