...
*
  ...
  'define stdv8=rem(t=7)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
'draw string 4.25 10.5 AO index and its EMD (1950-1985)'
...
*'set xlab off'
*'set ylab off'
 if(iframe = 1); 'set yaxis -4.5 4 2'; endif
 if(iframe = 2); 'set yaxis -2.5 3.0 1'; endif
 if(iframe = 3); 'set yaxis -2.1 1.7 1'; endif
 if(iframe = 4); 'set yaxis -1.2 1.35 0.5'; endif
 if(iframe = 5); 'set yaxis -0.8 0.87 0.5'; endif
 if(iframe = 6); 'set yaxis -0.7 0.5 0.5'; endif
 if(iframe = 7); 'set yaxis -0.3 0.35 0.2'; endif
 if(iframe = 8); 'set yaxis -0.35 0.3 0.2'; endif
'set cmark 0'
'd stdv'%iframe
'define zero=0.0'
'd zero'
