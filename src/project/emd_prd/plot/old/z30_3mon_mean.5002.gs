...
*
'open /export-6/cacsrv1/wd52pp/emd/imf_z30_3mon_mean.50-02.ctl'
...
*
  ...
  'define stdv7=rem(t=5)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
'draw string 4.25 10.5 3mon mean NH avg Z30 and its EMD (1950-2002)'
...
*'set xlab off'
*'set ylab off'
 if(iframe = 1); 'set vrange -2.0 2.0'; endif
 if(iframe = 1); 'set ylint 1'; endif
 if(iframe = 2); 'set vrange -2.0 2.0'; endif
 if(iframe = 2); 'set ylint 1'; endif
 if(iframe = 3); 'set vrange -0.2 0.2'; endif
 if(iframe = 3); 'set ylint 0.1'; endif
 if(iframe = 4); 'set vrange -0.2 0.2'; endif
 if(iframe = 4); 'set ylint 0.1'; endif
 if(iframe = 5); 'set vrange -0.2 0.2'; endif
 if(iframe = 5); 'set ylint 0.1'; endif
 if(iframe = 6); 'set vrange -0.2 0.2'; endif
 if(iframe = 6); 'set ylint 0.1'; endif
 if(iframe = 7); 'set vrange -0.2 0.2'; endif
 if(iframe = 7); 'set ylint 0.1'; endif
'set xyrev on'
'set cmark 0'
'd stdv'%iframe
'define zero=0.0'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly'  Z30'; endif
