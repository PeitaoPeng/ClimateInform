...
*
'open /export-6/cacsrv1/wd52pp/emd/imf_sst_nino34.lp.5001-0306.ctl'
...
'draw string 4.25 10.5 Nino3.4(LP) and its EMD (1950-2002)'
*'draw string 4.25 10.5 Nino3.4 and its EMD (1950-2002)'
*---------------------------set dimsnesion, page size and style
nframe=8
nframe2=8
xmin0=0.75;  xlen=7.25;  xgap=0.0
ymax0=10.0; ylen=-0.9;  ygap=-0.3
*
iframe=1
while ( iframe <= nframe )
...
*'set xlab off'
*'set ylab off'
 if(iframe = 1); 'set vrange -3.0 3.0'; endif
 if(iframe = 1); 'set ylint 2'; endif
 if(iframe = 2); 'set vrange -3.0 3.0'; endif
 if(iframe = 2); 'set ylint 2'; endif
 if(iframe = 3); 'set vrange -3.0 3.0'; endif
 if(iframe = 3); 'set ylint 2'; endif
 if(iframe = 4); 'set vrange -3. 3.'; endif
 if(iframe = 4); 'set ylint 2'; endif
 ...
 if(iframe = 7); 'set vrange -1. 1.'; endif
 if(iframe = 7); 'set ylint 0.5'; endif
 if(iframe = 8); 'set vrange -1.0 1.0'; endif
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly'  SI'; endif
