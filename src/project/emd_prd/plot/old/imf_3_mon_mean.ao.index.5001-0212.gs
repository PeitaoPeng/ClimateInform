...
*
'open /export-6/cacsrv1/wd52pp/emd/imf_3_mon_mean.ao.index.5001-0212.ctl'
...
'draw string 4.25 10.5 3_mon_mean AO index and its EMD (1950-2002)'
...
*'set ylab off'
 ...
 if(iframe = 8); 'set vrange -0.5 0.5'; endif
 if(iframe = 8); 'set ylint 0.5'; endif
 if(iframe = 9); 'set vrange -0.5 0.5'; endif
 if(iframe = 9); 'set ylint 0.5'; endif
'set xyrev on'
'set cmark 0'
'd stdv'%iframe
'define zero=0.0'
