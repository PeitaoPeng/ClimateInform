...
*
'open /export-6/cacsrv1/wd52pp/emd/imf_monthly.nao.index.5001-0212.ctl'
...
*
  ...
  'define stdv9=ximf(t=8)'
  'define stdv10=rem(t=8)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
'draw string 4.25 10.5 NAO index and its EMD (1950-2002)'
...
*'set xlab off'
*'set ylab off'
 if(iframe = 1); 'set yaxis -5 3.4 2'; endif
 if(iframe = 2); 'set yaxis -3 3 2'; endif
 if(iframe = 3); 'set yaxis -1.8 1.8 1'; endif
 if(iframe = 4); 'set yaxis -1.4 1.4 1'; endif
 if(iframe = 5); 'set yaxis -0.7 0.7 0.5'; endif
 if(iframe = 6); 'set yaxis -0.7 0.5 0.5'; endif
 if(iframe = 7); 'set yaxis -0.399 0.35 0.2'; endif
 if(iframe = 8); 'set yaxis -0.21 0.21 0.2'; endif
 if(iframe = 9); 'set yaxis -0.3 0.3 0.2'; endif
 if(iframe = 10); 'set yaxis -0.16 0.08 0.1'; endif
'set cmark 0'
'd stdv'%iframe
'define zero=0.0'
'd zero'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly'  NAO'; endif
 ...
 if(iframe = 9); 'draw string 'titlx' 'titly'  C8'; endif
 if(iframe = 10); 'draw string 'titlx' 'titly'  R'; endif
*
  iframe=iframe+1
