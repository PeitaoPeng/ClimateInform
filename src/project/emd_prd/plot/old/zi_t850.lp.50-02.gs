...
*
'open /export-6/cacsrv1/wd52pp/emd/imf_zi_t850.lp.50-02.ctl'
...
'draw string 4.25 10.5 T850 ZI(LP) and its EMD (1950-2002)'
...
*'set ylab off'
 ...
 if(iframe = 3); 'set vrange -1.0 1.0'; endif
 if(iframe = 3); 'set ylint 0.5'; endif
 if(iframe = 4); 'set vrange -1. 1.'; endif
 if(iframe = 4); 'set ylint 0.5'; endif
 if(iframe = 5); 'set vrange -1.0 1.0'; endif
 if(iframe = 5); 'set ylint 0.5'; endif
 if(iframe = 6); 'set vrange -0.5.0 0.5'; endif
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly'  ZI'; endif
