...
*
'open /export-6/cacsrv1/wd52pp/test/imf_Fy35N100hPa.ctl'
...
'draw string 4.25 10.5 Fy35N100hPa and its EMD (1958-2002)'
...
*'set xlab off'
*'set ylab off'
 if(iframe = 1); 'set vrange -1.5 1.5'; endif
 if(iframe = 1); 'set ylint 0.5'; endif
 if(iframe = 2); 'set vrange -1.5 1.5'; endif
 if(iframe = 2); 'set ylint 0.5'; endif
 if(iframe = 3); 'set vrange -0.3 0.3'; endif
 if(iframe = 3); 'set ylint 0.3'; endif
 if(iframe = 4); 'set vrange -0.3 0.3'; endif
 if(iframe = 4); 'set ylint 0.3'; endif
 if(iframe = 5); 'set vrange -0.3 0.3'; endif
 if(iframe = 5); 'set ylint 0.3'; endif
 if(iframe = 6); 'set vrange -0.3 0.3'; endif
 if(iframe = 6); 'set ylint 0.3'; endif
 if(iframe = 7); 'set vrange -0.3. 0.3'; endif
 if(iframe = 7); 'set ylint 0.3'; endif
 if(iframe = 8); 'set vrange -0.3 0.3'; endif
 if(iframe = 8); 'set ylint 0.3'; endif
'set xyrev on'
'set cmark 0'
'd stdv'%iframe
'define zero=0.0'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly'  ORI'; endif
