...
C
      ...
      open(unit=26,form='unformatted',access='direct',recl=4*imx*jmx)
      open(unit=27,form='unformatted',access='direct',recl=4*imx*jmx)
      open(unit=28,form='unformatted',access='direct',recl=4*imx*jmx)
      open(unit=29,form='unformatted',access='direct',recl=4*imx*jmx)
      ...
      open(unit=33,form='unformatted',access='direct',recl=4*imx*jmx)
      open(unit=34,form='unformatted',access='direct',recl=4*imx*jmx)
c
c     open(unit=61,form='unformatted',access='direct',recl=4*imx*jmx)
      open(unit=62,form='unformatted',access='direct',recl=4*imx*jmx)
c
c     open(unit=71,form='unformatted',access='direct',recl=4)
      open(unit=72,form='unformatted',access='direct',recl=4)
c************************************************
c area of nino34
      is=190
      ie=240
      ...
      enddo
c
c     DO isst=1,2 !1=ersst,2=hadoisst
      DO isst=2,2 !1=ersst,2=hadoisst
c
...
c
      if(isst.eq.1) then
      write(6,*) 'CA NINO34 based on ERSST.v4'
      else
