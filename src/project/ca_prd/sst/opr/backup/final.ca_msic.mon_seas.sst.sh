...
EOF
#=======================================
# have latet month data as IC for later use
#=======================================
outfile4=sst.latestmon.anom
#
cat >readic<<EOF
run getic.gs
EOF
...
#
ln -s $outdata/final_ca_prd.sst.${eof_range}.$modemax.${msic}ics.3mon.gr fort.85
ln -s $outdata/final_ca_prd.sst.${eof_range}.$modemax.${msic}ics.mon.gr fort.87
ln -s $outdata/final_ca_weights.${eof_range}.$modemax.${msic}ics.3mon.gr fort.86
#
./ca.x > $outdata/final.${eof_range}.$modemax.${msic}ics.out
#ca.x 
#
...
EOF
#
cat>$outdata/final_ca_prd.sst.${eof_range}.$modemax.${msic}ics.3mon.ctl<<EOF
dset ^final_ca_prd.sst.${eof_range}.$modemax.${msic}ics.3mon.gr
undef -9.99E+33
title EXP1
XDEF 360 LINEAR    0.5  1.0
YDEF 180 LINEAR  -89.5  1.0
...
EOF
#
cat>$outdata/final_ca_prd.sst.${eof_range}.$modemax.${msic}ics.mon.ctl<<EOF
dset ^final_ca_prd.sst.${eof_range}.$modemax.${msic}ics.mon.gr
undef -9.99E+33
title EXP1
XDEF 360 LINEAR    0.5  1.0
YDEF 180 LINEAR  -89.5  1.0
...
EOF
#
cat>$outdata/final_ca_weights.${eof_range}.$modemax.${msic}ics.3mon.ctl<<EOF
dset ^final_ca_weights.${eof_range}.$modemax.${msic}ics.3mon.gr
undef -9.99E+33
title EXP1
