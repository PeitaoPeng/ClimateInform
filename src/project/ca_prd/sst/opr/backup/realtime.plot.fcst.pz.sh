...
if ( $var = 'hgt' );'run /cpc/home/wd52pp/bin/dline.gs 180 -90 180 90'; endif 
if ( $var = 'prec' );'run /cpc/home/wd52pp/bin/dline.gs 180 -60 180 90'; endif 
 'set string 1 tc 5 0'
  iframe=iframe+1
'run /cpc/home/wd52pp/bin/cbarn2.gs 1. 0 5.5 0.75'
endwhile
*
'set string 4 tl 6'
...
#/usr/local/bin/grads -bl <nino34plume
