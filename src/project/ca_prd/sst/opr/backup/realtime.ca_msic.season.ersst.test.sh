...
datadir0=/export/cpc-lw-mlheureux/wd52ml/enso/oni.v5/data/ersst.v5
...
nseasonp=`expr $nyear - 1` #for eof and ca forecast
...
#
cp $lcdir/realtime.ca_msic.season.sst.test.f $tmp/sst_prd.f
