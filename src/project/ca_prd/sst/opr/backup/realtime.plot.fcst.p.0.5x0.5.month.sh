...
'open $datadir/real_ca_prd.$var.'analy_1'.'eofrange_1'.'ieof'.'ics'ics.3mon.0.5x0.5.ctl'
icut=icut+1
endwhile
ics=ics+1
endwhile
...
if (icut = 2); ieof=25; endif
if (icut = 3); ieof=40; endif
'open $datadir/real_ca_prd.$var.'analy_2'.'eofrange_1'.'ieof'.'ics'ics.3mon.0.5x0.5.ctl'
icut=icut+1
endwhile
ics=ics+1
endwhile
