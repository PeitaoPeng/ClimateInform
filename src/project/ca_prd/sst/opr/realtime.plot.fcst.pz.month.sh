...
'draw string 5.5 7.8.0 CA 'varb' Prd for 'tgtmmyy', ICs through 'icmonc''icyr'($unit), Lead 'lead''
*
*---------------------------string/caption
 'set string 1 tc 5'
...
*
'print'
'printim ca'vr'_anom.'lead'.mon.png gif x800 y600'
*
c
'set vpage off'
*
...
#
cp ca${var}_anom.*.mon.png $datadir
#
done  # var loop
#
