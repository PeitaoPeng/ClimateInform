...
#
yrn=`expr $curyr - 1949` # total full years,=72 for 1949-2020
if [ $cmon = 1 ]; then yrn=`expr $yyym - 1949`; fi
mmn=`expr $yrn \* 12`
#
tmax=`expr $mmn + $icmoe` # 864=dec2020
#
nyear=`expr $curyr - 1949`  # total full year data used for CA, 72 for 1949-2020
...
#
outfile=sst.hadoi.jan1949-cur.mon.tot
#
...
#=======================================
outfile2=hadoisst.mon.1949-curr.1x1
ts=1
te=$tmax
clm_bgn=504  #dec1990
...
'set y 1 180'
'set t 1 12'
'define sstc=ave(sst,t+$clm_bgn,t=$clm_end,1yr)'
...
#=======================================
outfile3=hadoisst.3mon.1949-curr.1x1
ts=2
te=`expr $tmax - 1`
#
cat >3mavg<<EOF
...
c
      ...
      parameter(ngrd=$ngrd)
      parameter(msic=$msic)
      parameter(nskip=0) !skip sst from jan194x to jan1949
      parameter(nskip2=1) !skip jan1949 to feb1949 for mon sst
eof
#
...
ln -s $datadir/$outfile2.gr fort.12
#
