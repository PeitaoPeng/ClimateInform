...
cp $lcdir/hindcast.ca_hrcn.3mon.msic.cv-1.f $tmp/sst_hcst.f
...
#
ln -s $outdata/ca_hcst_skill.$var.${sst_analysis}.$modemax.$icseason.${mseason}ics.${eof_range}.cv-1.gr fort.85
ln -s $outdata/ca_hcst.$var.${sst_analysis}.$modemax.$icseason.${mseason}ics.${eof_range}.cv-1.gr fort.86
#
ca.x > $outdata/out.hrcn.ca_hcst.${sst_analysis}.$modemax.$icseason.${mseason}ics.$eof_range.cv-1
#ca.x 
#
undef_data=-9.99E+8
cat>$outdata/ca_hcst_skill.$var.${sst_analysis}.$modemax.$icseason.${mseason}ics.${eof_range}.cv-1.ctl<<EOF
dset ^ca_hcst_skill.$var.${sst_analysis}.$modemax.$icseason.${mseason}ics.${eof_range}.cv-1.gr
undef $undef_data
title EXP1
...
EOF
#
cat>$outdata/ca_hcst.$var.${sst_analysis}.$modemax.$icseason.${mseason}ics.${eof_range}.cv-1.ctl<<EOF
dset ^ca_hcst.$var.${sst_analysis}.$modemax.$icseason.${mseason}ics.${eof_range}.cv-1.gr
undef $undef_data
title EXP1
