...
'draw string 5.5 7.75 Skill Comparison(all seasons)'
...
'set string 2 tl 4'
if(iframe = 1);'draw string 'lx1' 'ly12' MLR(SST,D20)'; endif
'set string 4 tl 4'
if(iframe = 1);'draw string 'lx1' 'ly13' CA_SST'; endif

'set string 1 tl 4'
if(iframe = 2);'draw string 'lx1' 'ly21' CFSv2'; endif
'set string 2 tl 4'
if(iframe = 2);'draw string 'lx1' 'ly22' MLR(SST,D20)'; endif
'set string 4 tl 4'
if(iframe = 2);'draw string 'lx1' 'ly23' CA_SST'; endif
...
endwhile
'print'
'printim skill_vs_lead.allss.ann_vs_mlr.hybrid.png gif x800 y600'
*'c'
 'set vpage off'
*----------
