...
'open /cpc/home/wd52pp/data/casst/real_ca_prd.temp.'analy_1'.'eofrange_1'.'ieof'.'ics'ics.3mon.R1.ctl'
icut=icut+1
endwhile
ics=ics+1
endwhile
...
if (icut = 2); ieof=25; endif
if (icut = 3); ieof=40; endif
'open /cpc/home/wd52pp/data/casst/real_ca_prd.temp.'analy_2'.'eofrange_1'.'ieof'.'ics'ics.3mon.R1.ctl'
icut=icut+1
endwhile
ics=ics+1
endwhile
...
'draw string 4.25 10.250 CA T2m_AC Skill, SST ICs through 'ic_mon'(R1)'
*
*---------------------------string/caption
 'set string 1 tc 5'
...
endwhile
'print'
'printim real.2d-temp_ave_ac.'ic_mon'IC.R1.png gif x1200 y1600'
*
*'c'
'set vpage off'
