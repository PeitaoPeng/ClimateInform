...
#
ln -s $datadir/cahcst.$var.${icss}_ic.all_esm.gr       fort.91
ln -s $datadir/cahcst.$var.${icss}_ic.ersst_esm.gr     fort.92
ln -s $datadir/cahcst.$var.${icss}_ic.hadoisst_esm.gr  fort.93
ln -s $datadir/cahcst.$var.${icss}_ic.1sic_esm.gr fort.94
ln -s $datadir/cahcst.$var.${icss}_ic.2sic_esm.gr fort.95
ln -s $datadir/cahcst.$var.${icss}_ic.3sic_esm.gr fort.96
ln -s $datadir/cahcst.$var.${icss}_ic.4sic_esm.gr fort.97
#
esm.x 
#
cat>$datadir/cahcst.$var.${icss}_ic.all_esm.ctl<<EOF
dset ^cahcst.$var.${icss}_ic.all_esm.gr
undef -9.99E+8
title EXP1
...
EOF
#
cat>$datadir/cahcst.$var.${icss}_ic.ersst_esm.ctl<<EOF
dset ^cahcst.$var.${icss}_ic.ersst_esm.gr
undef -9.99E+8
title EXP1
XDEF  360 LINEAR    0.5  1.0
YDEF  180 LINEAR  -89.5  1.0
...
EOF
#
cat>$datadir/cahcst.$var.${icss}_ic.hadoisst_esm.ctl<<EOF
dset ^cahcst.$var.${icss}_ic.hadoisst_esm.gr
undef -9.99E+8
title EXP1
XDEF  360 LINEAR    0.5  1.0
YDEF  180 LINEAR  -89.5  1.0
