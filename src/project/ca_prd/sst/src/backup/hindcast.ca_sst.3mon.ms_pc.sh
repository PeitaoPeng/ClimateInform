...
mseason=3  # # of seasons together in CA
...
cp $lcdir/hindcast.ca_sst.3mon.ms_pc.f $tmp/sst_hcst.f
...
#
ln -s $outdata/eof.${sst_analysis}.$icseason.${mseason}ics_pc.${eof_range}.gr fort.70
#
ln -s $outdata/ca_hcst.skill.${sst_analysis}.$modemax.$icseason.${mseason}ics_pc.${eof_range}.gr fort.85
ln -s $outdata/ca_hcst.${sst_analysis}.$icseason.${mseason}ics_pc.${eof_range}.gr fort.86
#
ca.x > $outdata/ca_hcst.${sst_analysis}.$modemax.$icseason.${mseason}ics_pc.${eof_range}.out
#ca.x 
#
cat>$outdata/eof.${sst_analysis}.$icseason.${mseason}ics_pc.${eof_range}.ctl<<EOF
dset ^eof.${sst_analysis}.$icseason.${mseason}ics_pc.${eof_range}.gr
undef -9.99E+33
title EXP1
xdef  180 linear   0. 2.
...
EOF
#
cat>$outdata/ca_hcst.skill.${sst_analysis}.$modemax.$icseason.${mseason}ics_pc.${eof_range}.ctl<<EOF
dset ^ca_hcst.skill.${sst_analysis}.$modemax.$icseason.${mseason}ics_pc.${eof_range}.gr
undef -9.99E+33
title EXP1
xdef  180 linear   0. 2.
ydef   89 linear -88. 2.
...
EOF
#
cat>$outdata/ca_hcst.${sst_analysis}.$icseason.${mseason}ics_pc.${eof_range}.ctl<<EOF
dset ^ca_hcst.${sst_analysis}.$icseason.${mseason}ics_pc.${eof_range}.gr
undef -9.99E+33
title EXP1
xdef  180 linear   0. 2.
ydef   89 linear -88. 2.
