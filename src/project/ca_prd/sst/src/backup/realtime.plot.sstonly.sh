...
#
datadir=/cpc/home/wd52pp/data/season_fcst/ca/$cyr/$mcur
#
cd $tmp
#
var=sst
...
'run /cpc/home/wd52pp/bin/dline.gs 180 -45 180 45'
iframe=iframe+1
endwhile
'run /cpc/home/wd52pp/bin/cbarn2.gs 1. 1 7.6 5.25'
'print'
'printim ca'vr'_anom.-2_to_1.png gif x600 y800'
c
'set vpage off'
*---------------------------------------------------second page
nframe=4
...
'run /cpc/home/wd52pp/bin/cbarn2.gs 1. 1 7.6 5.25'
'print'
'printim ca'vr'_anom.2_to_5.png gif x600 y800'
c
'set vpage off'
*---------------------------------------------------third page
nframe=4
...
'run /cpc/home/wd52pp/bin/cbarn2.gs 1. 1 7.6 5.25'
'print'
'printim ca'vr'_anom.6_to_9.png gif x600 y800'
c
'set vpage off'
*---------------------------------------------------fourth page
nframe=4
...
'run /cpc/home/wd52pp/bin/cbarn2.gs 1. 1 7.6 5.25'
'print'
'printim ca'vr'_anom.10_to_13.png gif x600 y800'
c
'set vpage off'
*--------------------------------------------------- page
