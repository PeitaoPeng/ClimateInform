...
lcdir=/cpc/home/wd52pp/project/ca_prd/sst/src/backup
...
#
latest_mon=oct2015  #the end-mon of latest IC season
icmon_mid=sep2015   #the mid-mon of latest IC season
icseason=8
tmax=814  # 804=dec2014
nyear=67 # 1948-2014
