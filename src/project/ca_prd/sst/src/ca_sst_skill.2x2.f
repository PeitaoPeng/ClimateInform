...
C
      ...
      open(unit=35,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=36,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=37,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=38,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=39,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=40,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=41,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=42,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=43,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=44,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=45,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=46,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=47,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=48,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=49,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
      open(unit=50,form='unformatted',access='direct',recl=4*ims*jms) !obs$prd
c
...
c      do ie=5,neof  !for eof cutoffs of 35 40 45 50 55 60
       do ie=1,6  !for eof cutoffs of 15 20 25 30 35 40
