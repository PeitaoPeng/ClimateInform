...
c range for sst pat cor (ac_1d)
      parameter(imss=231,imse=300)   ! 230-300 for CONUS
      parameter(jmss=115,jmse=140)   ! 25N->75N
c
...
c
      ...
      it=it+1
      read(iu,rec=it) fld
      call f2d_2_4d(fld,o4d,ims,jms,nld,nseason,ld,is)
      it=it+1
      read(iu,rec=it) fld
      call f2d_2_4d(fld,p4d,ims,jms,nld,nseason,ld,is)
      Enddo
      Enddo
...
c
      subroutine f2d_2_4d(wk1,wk2,n1,n2,n3,n4,k,l)
      dimension wk1(n1,n2),wk2(n1,n2,n3,n4)
      do j=1,n2
      do i=1,n1
      wk2(i,j,k,l)=wk1(i,j)
      enddo
