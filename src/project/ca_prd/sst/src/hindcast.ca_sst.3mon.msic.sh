...
#outdata=$datadir
outdata=/cpc/consistency/id/ca_hcst/seasonal
#
cd $tmp
#
for icseason in jfm fma mam amj mjj jja jas aso son ond ndj djf; do
#for icseason in ndj djf; do
#
...
#for mseason in 3 4; do
#for modemax in  15 25 40; do
for modemax in  20 30 35 45 50 55 60; do
#for modemax in  55 60; do
