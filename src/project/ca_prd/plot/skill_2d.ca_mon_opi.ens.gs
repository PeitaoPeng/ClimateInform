...
*
'open /export-6/cacsrv1/wd52pp/ca_prd/ac_2d_ens_opi.79-cur_oct.mm10.ctl'
...
*'draw string 4.25 10.2 79/80-02/03 winters, Maxmode=10'
'draw string 4.25 10.2 79-03 winter, Maxmode=10'
*'draw string 2.4 9.5 CONSTRUCTED ANALOGUE'
'draw string 2.4 9.5 CA & PT ensembled'
'draw string 6.0 9.5 PERSISTENT'
*---------------------------set dimsnesion, page size and style
*
c 'define sd1=ac(t=2)+0.05'
c 'define sd2=ac(t=3)+0.05'
  'define sd1=ac(t=2)'
  'define sd2=ac(t=3)'
  'define sd3=pp(t=2)'
  'define sd4=pp(t=3)'
...
*
  iframe=iframe+1
'run /export-6/sgi9/wd52pp/bin/cbarn.gs 0.7 0 4.25 5.0'
endwhile
'print'
*
*'c'
