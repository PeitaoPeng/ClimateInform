...
*
'open /export-12/cacsrv1/wd52pp/ca_prd/ac_2d_ca_olr_pent.7980-0102DJFM.mm10.BP.ctl'
...
'draw string 4.25 10.5 Anom Corr of CA Prediction for 20-90day BP pentad OLR'
'draw string 4.25 10.2 DJFM 79/80-01/02, Maxmode=10'
*---------------------------set dimsnesion, page size and style
*
  'define sd1=0.00+ac(t=2)'
  'define sd2=0.00+ac(t=3)'
  'define sd3=0.00+ac(t=4)'
  'define sd4=ac(t=5)'
  'define sd5=ac(t=6)'
*
  'define sd6=ac(t=7)'
...
*
  iframe=iframe+1
'run /export/hobbes/wd52pp/bin/cbarn.gs 1. 0 4.25 1.8'
endwhile
