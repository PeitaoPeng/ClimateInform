...
cp $lcdir/hcast.ca_w34.p.f $tmp/prcp_prd.f
...
ln -s $tmp/real_prd_psi200_prcp_wkly.bin fort.86
ln -s $tmp/ca_prcp_wk34.bin fort.87
#
./ca.x > $lcdir/realtime.w34.ca.out
#
cat>$tmp/real_prd_psi200_prcp_wkly.ctl<<EOF
...
ocn   1 99 OCN prd
prd   1 99 psi-baed+trd or ocn
prb   1 99 prob format of prd
trd   1 99 trend per year
hss   1 99 HSS_2c
pic   1 99 psi ic
ostd  1 99 std of obs
pstd  1 99 std of prd
endvars
EOF

cp $tmp/ca_prcp_wk34.ctl /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
cp $tmp/ca_prcp_wk34.bin /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
