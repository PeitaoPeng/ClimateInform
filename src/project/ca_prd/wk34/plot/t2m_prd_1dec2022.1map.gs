...
*
'open /cpc/home/wd52pp/data/wk34_fcst/ca/2022/12/01/ca_sat_wk34.ctl'
*
*---------------------------string/caption
 'set string 1 tc 3'
 'set strsiz 0.13 0.13'
'draw string 5.5 8.0 CA T2m FCST, Issued Dec012022'
'draw string 5.5 7.75 Week-3/4 FCST Ending 29Dec2022'
*
*---------------------------string/caption
 'set string 1 tc 5'
...
endwhile
'printim ca_t2m_fcst_01dec2022.1map.png gif x1600 y1200'
'print'
*
*'c'
'set vpage off'
