...
'open /cpc/home/wd52pp/tmp/opr/ca_z500_wk34.2ics.35.ctl'
'open /cpc/home/wd52pp/tmp/opr/ca_z500_wk34.3ics.35.ctl'
'open /cpc/home/wd52pp/tmp/opr/ca_z500_wk34.4ics.35.ctl'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.13 0.13'
'draw string 5.5 8.2 CA Week3-4 Z500 Forecast, IC: Jun1,2017, Max-Modes:35'
*
*---------------------------string/caption
 'set string 1 tc 5'
...
endwhile
'printim wk34prd_4_mwic.z500.png gif x800 y600'
'print'
*
*'c'
'set vpage off'
