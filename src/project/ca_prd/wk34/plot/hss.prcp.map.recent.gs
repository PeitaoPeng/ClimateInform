...
*
'open /cpc/home/wd52pp/data/wk34/real_wk34_prcp.hss.ctl'
...
'draw string 4.25 10.25 HSS of Recent CA Week3-4 Prec Fcst'
...
endwhile
'print'
'printim hss_prec.recent.map.png gif x1200 y1600'
*'c'
* 'set vpage off'
*----------
