...
*
'open /cpc/home/wd52pp/data/wk34/ac3d.ca_psi200_sat.wkly.winter.ctl'
*
*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.14 0.14'
'draw string 5.5 8. CA SAT WK3-4 Skill(AC) vs # of EOFs and IC-Weeks'
...
'set string 1 tc 5 0'
  iframe=iframe+1
endwhile
'printim avgac_wk34.eof_vs_ic.winter.png gif x1600 y1200'
'print'
*
*'c'
'set vpage off'
