...
*
'open /cpc/home/wd52pp/data/wk34/ac_1d_ca_psi200_olr_trd.nmme_sat_wkly.winter.ctl'
'open /cpc/home/wd52pp/data/wk34/nino34_wkly.winter.ctl'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.13 0.13'
'draw string 4.25 10. Pattern COR for NA WK34 SAT Forecast'
'draw string 4.25 9.75 Based on OLR&PSI200, DJFM 1979/80-2012/13'
*
*---------------------------string/caption
 'set string 1 tc 5'
...
endwhile
'printim ac_1d.wk34.olr+psi.sat.png gif x600 y800'
'print'
*
*'c'
'set vpage off'
