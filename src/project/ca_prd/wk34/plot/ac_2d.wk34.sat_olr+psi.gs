...
*'draw string 5.5 7.75 DJFM 1979/80-2012/13, based on OLR, PSI200 & Linear Trend'
'draw string 5.5 7.75 DJFM 1979/80-2012/13, based on OLR&PSI200'
*
*---------------------------string/caption
 'set string 1 tc 5'
...
endwhile
'printim ac_2d.wk34.olr+psi_sat.png gif x800 y600'
'print'
*
*'c'
'set vpage off'
