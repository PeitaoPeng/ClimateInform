...
*
'open /cpc/home/wd52pp/data/wk34/real_wk34_prcp_prd.djf.ctl'
'open /cpc/home/wd52pp/data/wk34/real_wk34_prcp_prd.jja.ctl'
...
'draw string 4.25 10.25 HSS of CA WK3-4 Prec 2-Class Fcst'
...
*
  iframe=iframe+1
'run /cpc/home/wd52pp/bin/cbarn2.gs 0.9 0 4.25 1.'
endwhile
'print'
'printim hss_prec.map.png gif x1200 y1600'
*'c'
* 'set vpage off'
*----------
