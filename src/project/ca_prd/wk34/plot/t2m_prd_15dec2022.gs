...
*
'open /cpc/home/wd52pp/data/wk34_fcst/ca/2022/12/15/ca_sat_wk34.ctl'
*
*---------------------------string/caption
 'set string 1 tc 3'
 'set strsiz 0.13 0.13'
'draw string 5.5 8.2 CA SAT Forecast, IC: Dec13,2022'
*
*---------------------------string/caption
 'set string 1 tc 5'
...
endwhile
'printim ca_t2m_fcst_15dec2022.png gif x1600 y1200'
'print'
*
*'c'
'set vpage off'
