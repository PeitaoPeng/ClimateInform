...
*
'open /cpc/home/wd52pp/data/wk34/real_wk34_psi200.hss.ctl'
...
'draw string 4.25 9.75 HSS of Recent CA Week3-4 PSI200 Fcst'
*---------------------------set dimsnesion, page size and style
nframe=2
nframe2=2
xmin0=1.;  xlen=6.5;  xgap=0.75
ymax0=9.5; ylen=-3.5;  ygap=-0.5
*
iframe=1
while ( iframe <= nframe )
...
*
  iframe=iframe+1
'run /cpc/home/wd52pp/bin/cbarn2.gs 0.9 0 4.25 1.25'
endwhile
'print'
'printim hss_psi200.recent.map.png gif x1200 y1600'
*'c'
* 'set vpage off'
*----------
