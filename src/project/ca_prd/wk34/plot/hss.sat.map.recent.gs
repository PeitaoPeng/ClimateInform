...
*
'open /cpc/home/wd52pp/data/wk34/real_wk34_sat.hss.ctl'
...
'draw string 4.25 10.25 HSS of Recent CA Week3-4 SAT Fcst'
...
endwhile
'print'
'printim hss_sat.recent.map.png gif x1200 y1600'
*'c'
* 'set vpage off'
*----------
