...
*
'open /cpc/home/wd52pp/data/adam/test_prd.psi200_wkly.ctl'
*
*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.13 0.13'
'draw string 4.5 10.5 CA PSI200 Forecast with data throuch 5/5/2016'
'draw string 4.5 10.2 Unit: 1.e6 m*m/s'
*
*---------------------------string/caption
 'set string 1 tc 5'
...
*'run /cpc/home/wd52pp/bin/cbarn2.gs 0.5 0 'bx' 'by''
 ...
 'set strsiz 0.15 0.15'
endwhile
'printim test.psi.png gif x600 800'
'print'
*
*'c'
'set vpage off'
