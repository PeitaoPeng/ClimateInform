...
cp $lcdir/realtime.ca_w34.tz.3C.f $tmpdir/sat_prd.f
...
ln -s $tmpdir/real_prd_psi200_sat_wkly.bin fort.86
ln -s out.2.5x2.5.bin fort.87
#
./ca.x > $lcdir/realtime.w34.ca.out
#
cat>$tmpdir/real_prd_psi200_sat_wkly.ctl<<EOF
...
'set gxout fwrite'
'set fwrite $tmpdir/ca_sat_wk34.bin'
nt=1
while ( nt <= 12)
...
cat>$tmpdir/ca_sat_wk34.ctl<<EOF
...
cp $tmpdir/ca_sat_wk34.ctl /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
cp $tmpdir/ca_sat_wk34.bin /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
