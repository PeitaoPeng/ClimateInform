...
cp $lcdir/realtime.ca_w34.tz.mwic.f $tmpdir/z500_prd.f
...
ln -s $tmpdir/real_prd_psi200_z500_wkly.${mwic}ics.$modemax.bin fort.86
ln -s $tmpdir/ca_z500_wk34.${mwic}ics.$modemax.bin fort.87
#
./ca.x > $lcdir/realtime.w34.ca.${mwic}ics.$modemax.out
#
cat>$tmpdir/real_prd_psi200_z500_wkly.${mwic}ics.$modemax.ctl<<EOF
dset ^real_prd_psi200_z500_wkly.${mwic}ics.$modemax.bin
undef -9.99E+33
title EXP1
...
cat>$tmpdir/ca_z500_wk34.${mwic}ics.$modemax.ctl<<EOF
dset ^ca_z500_wk34.${mwic}ics.$modemax.bin
undef -9.99E+33
title EXP1
xdef  144 linear   0 2.5
ydef   73 linear  -90 2.5
...
#cp $tmpdir/ca_z500_wk34.${mwic}ics.ctl /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
#cp $tmpdir/ca_z500_wk34.${mwic}ics.bin /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
#
done # loop mode cut
done # loop ic
