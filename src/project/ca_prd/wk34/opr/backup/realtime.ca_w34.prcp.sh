...
ln -s $tmpdir/ca_prcp_wk34.2c.bin fort.87
#
...
cat>$tmpdir/ca_prcp_wk34.2c.ctl<<EOF
dset ^ca_prcp_wk34.2c.bin
undef -9.99E+33
...
cp $tmpdir/ca_prcp_wk34.2c.ctl /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
cp $tmpdir/ca_prcp_wk34.2c.bin /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
