...
cp $lcdir/realtime.ca_w34.tz.f $tmpdir/sat_prd.f
...
ln -s $tmpdir/ca_sat_wk34.2c.bin fort.87
#
...
cat>$tmpdir/ca_sat_wk34.2c.ctl<<EOF
dset ^ca_sat_wk34.2c.bin
undef -9.99E+33
title EXP1
xdef  144 linear   0 2.5
ydef   73 linear  -90 2.5
...
cp $tmpdir/ca_sat_wk34.2c.ctl /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
cp $tmpdir/ca_sat_wk34.2c.bin /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
