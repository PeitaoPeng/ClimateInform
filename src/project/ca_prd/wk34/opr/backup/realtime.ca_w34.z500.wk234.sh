...
cp $lcdir/realtime.ca_w34.tz.wk234.f $tmpdir/z500_prd.f
...
ln -s $tmpdir/ca_z500_wk34.bin fort.87
#
...
cat>$tmpdir/ca_z500_wk34.ctl<<EOF
dset ^ca_z500_wk34.bin
undef -9.99E+33
title EXP1
xdef  144 linear   0 2.5
ydef   73 linear  -90 2.5
...
cp $tmpdir/ca_z500_wk34.ctl /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
cp $tmpdir/ca_z500_wk34.bin /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/$fm2/$fd2
#cp $tmpdir/ca_z500_wk34.ctl /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/08/26
#cp $tmpdir/ca_z500_wk34.bin /cpc/home/wd52pp/data/wk34_fcst/ca/$fy4/08/26
