...
cp $lcdir/realtime.ca_w34.p.f $tmpp/prcp_prd.f
...
c
      ...
      parameter(imt=360,jmt=181)  !input  prcp dimension
c
...
gfortran -mcmodel=medium -g -o ca.x prcp_prd.f eof_4_ca.s.f
echo "done compiling"
...
ln -s $tmpdir/ca_prcp_wk34.bin fort.87
#
