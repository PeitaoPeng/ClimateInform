...
cp $lcdir/zp_sat_wkly_prd.skill.ass.mwic.f $tmpdir/sat_prd.skill.f
...
ln -s $outdata/psi200_sat_wk34.$season.${mwic}ics.mm$modemax.i3e  fort.55
ln -s $outdata/psi200_sat_wk34.$season.obs.i3e  fort.56
#
...
#
#ln -s $outdata/ac_1d_ca_psi200_sat_wkly.$season.${mwic}ics.mm$modemax.i3e fort.81
#ln -s $outdata/ac_2d_ca_psi200_sat_wkly.$season.${mwic}ics.mm$modemax.i3e fort.82
ln -s $outdata/ac_1d_ca_psi200_sat_wkly.$season.${mwic}ics.mm$modemax.detrd.i3e fort.81
ln -s $outdata/ac_2d_ca_psi200_sat_wkly.$season.${mwic}ics.mm$modemax.detrd.i3e fort.82
#
...
cat>$outdata/ac_1d_ca_psi200_sat_wkly.$season.${mwic}ics.mm$modemax.detrd.ctl<<EOF
dset ^ac_1d_ca_psi200_sat_wkly.$season.${mwic}ics.mm$modemax.detrd.i3e
undef -9.99E+33
title EXP1
xdef  $npp linear  0  1.
ydef  1 linear 1 1
...
cat>$outdata/ac_2d_ca_psi200_sat_wkly.$season.${mwic}ics.mm$modemax.detrd.ctl<<EOF
dset ^ac_2d_ca_psi200_sat_wkly.$season.${mwic}ics.mm$modemax.detrd.i3e
undef -9.99E+33
title EXP1
xdef  144 linear   0 2.5
