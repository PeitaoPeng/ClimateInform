...
cp $lcdir/zp_sat_wkly_prd.skill.ass.f $tmpdir/sat_prd.skill.f
...
ln -s $outdata/psi200_sat_wk.$season.cnst.i3e  fort.50
ln -s $outdata/psi200_sat_wk1.$season.prd.i3e  fort.51
ln -s $outdata/psi200_sat_wk2.$season.prd.i3e  fort.52
ln -s $outdata/psi200_sat_wk3.$season.prd.i3e  fort.53
ln -s $outdata/psi200_sat_wk4.$season.prd.i3e  fort.54
ln -s $outdata/psi200_sat_wk34.$season.prd.i3e  fort.55
#
ln -s $outdata/eof.psi200_wk.${season}_4_skill.i3e   fort.70
#
ln -s $outdata/ac_1d_ca_psi200_wkly.$season.mm$modemax.i3e fort.71
ln -s $outdata/ac_2d_ca_psi200_wkly.$season.mm$modemax.i3e fort.72
#
#ln -s $outdata/ac_1d_ca_psi200_sat_wkly.$season.mm$modemax.i3e fort.81
#ln -s $outdata/ac_2d_ca_psi200_sat_wkly.$season.mm$modemax.i3e fort.82
ln -s $outdata/ac_1d_ca_psi200_sat_wkly.$season.mm$modemax.detrd.i3e fort.81
ln -s $outdata/ac_2d_ca_psi200_sat_wkly.$season.mm$modemax.detrd.i3e fort.82
#
ca.x > $lcdir/ca_psi200_sat_wkly.$season.out
...
cat>$outdata/ac_1d_ca_psi200_wkly.$season.mm$modemax.ctl<<EOF
dset ^ac_1d_ca_psi200_wkly.$season.mm$modemax.i3e
undef -9.99E+33
title EXP1
xdef  $npp linear  0  1.
ydef  1 linear 1 1
...
cat>$outdata/ac_2d_ca_psi200_wkly.$season.mm$modemax.ctl<<EOF
dset ^ac_2d_ca_psi200_wkly.$season.mm$modemax.i3e
undef -9.99E+33
title EXP1
xdef  144 linear   0.  2.5
ydef   44 linear -20.  2.5
...
cat>$outdata/ac_1d_ca_psi200_sat_wkly.$season.mm$modemax.detrd.ctl<<EOF
dset ^ac_1d_ca_psi200_sat_wkly.$season.mm$modemax.detrd.i3e
undef -9.99E+33
title EXP1
xdef  $npp linear  0  1.
ydef  1 linear 1 1
...
cat>$outdata/ac_2d_ca_psi200_sat_wkly.$season.mm$modemax.detrd.ctl<<EOF
dset ^ac_2d_ca_psi200_sat_wkly.$season.mm$modemax.detrd.i3e
undef -9.99E+33
title EXP1
xdef  144 linear   0 2.5
