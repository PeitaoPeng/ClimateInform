...
*
'reinit'
'open /export-6/cacsrv1/wd52pp/ca_prd/ca_prd_opi_ic_'ICmon'.mm10.ctl'
*
...
*---------------------------string/caption
 ...
 'set strsiz 0.15 0.15'
  ...
  'draw string 5.5 7.7 OPI data through 'ICmon' are used ('monlead' month lead)'
...
if(iframe = 3); 'draw string 'titlx3' 'titly' (c) Historical Skill (AC over 1979-2003)'; endif
...
'printim 'tgtmon'.png gif x800 y600'
