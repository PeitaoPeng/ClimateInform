...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      parameter(imin=72,jmin=37) ! grid size of Z500
      parameter(imp=72,jmp=17)   ! grid size of prcp
...
C
      open(unit=10,form='unformatted',access='direct',recl=72*37) !pent data
      open(unit=20,form='unformatted',access='direct',recl=72*17) !pent data
      open(unit=21,form='unformatted',access='direct',recl=72*17) !pent data
      open(unit=22,form='unformatted',access='direct',recl=72*17) !pent data
      open(unit=23,form='unformatted',access='direct',recl=72*17) !pent data
      open(unit=24,form='unformatted',access='direct',recl=72*17) !pent data
      open(unit=25,form='unformatted',access='direct',recl=72*17) !pent data
      open(unit=26,form='unformatted',access='direct',recl=72*17) !pent data
      open(unit=27,form='unformatted',access='direct',recl=72*17) !pent data
...
c* read in data and save the tropics
      ...
      DO iw=1,nws              !ws -> winter seasons
        ...
        nkeeps=(iw-1)*73+68    !first of Dec
        nkeepe=iw*73+18        !Last  of Mar
        np=1
        do it=nkeeps,nkeepe    !read DJFM data
          read(10,rec=it) fldin
            do i=1,imp
            do j=1,jmp
            fld4d(i,j,np,iw)=fldin(i,j+10)
            fld2d(i,j)=fldin(i,j+10)
            enddo
            enddo
          write(20) fld2d
        np=np+1
