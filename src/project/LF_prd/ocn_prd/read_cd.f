      ...
      dimension t2102(102,nyear,14)
      dimension out(102),out2(102)
...
c     call loaddata(tt102,tt102ub,it,tt,rit,frak,ireg,jb,je,63,0,nyear)!phys units - soil moisture
      ...
      call loaddata(t2102,tt102ub,it,tt,rit,frak,ireg,jb,je,62,0,nyear)!phys units - precip
...
c*
      ...
      dimension it(nyear,14)
      dimension rit(nyear,12)
      do j=1,nyear
      do m=1,14
      it(j,m)=-9999
      enddo
