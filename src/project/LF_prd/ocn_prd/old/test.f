...
C===  select optimal K
        ...
        ms(k)=1000*score(k)
        enddo
c       mms=min0(ms(1),ms(2),ms(3),ms(4),ms(5),ms(6),ms(7),ms(8))
c       xac=amax1(ac(1),ac(2),ac(3),ac(4),ac(5),ac(6),ac(7),ac(8))
        mms=min0(ms(1),ms(2),ms(3),ms(4),ms(5),ms(6),ms(7))
        xac=amax1(ac(1),ac(2),ac(3),ac(4),ac(5),ac(6),ac(7))
c       mms=min0(ms(1),ms(2),ms(3),ms(4),ms(5),ms(6),ms(7),ms(8),
c    &ms(9),ms(10))
c       xac=amax1(ac(1),ac(2),ac(3),ac(4),ac(5),ac(6),ac(7),ac(8),
c    &ac(9),ac(10))
c       mms=min0(ms(1),ms(2),ms(3),ms(4),ms(5),ms(6),ms(7),ms(8),
c    &ms(9),ms(10),ms(11),ms(12),ms(13),ms(14),ms(15))
c       xac=amax1(ac(1),ac(2),ac(3),ac(4),ac(5),ac(6),ac(7),ac(8),
c    &ac(9),ac(10),ac(11),ac(12),ac(13),ac(14),ac(15))
c       mms=min0(ms(1),ms(2),ms(3),ms(4),ms(5),ms(6),ms(7),ms(8),
c    &ms(9),ms(10),ms(11),ms(12),ms(13),ms(14),ms(15),
c    &ms(16),ms(17),ms(18),ms(19),ms(20))
c       xac=amax1(ac(1),ac(2),ac(3),ac(4),ac(5),ac(6),ac(7),ac(8),
c    &ac(9),ac(10),ac(11),ac(12),ac(13),ac(14),ac(15),
c    &ac(16),ac(17),ac(18),ac(19),ac(20))
        do k=1,kp
          if (mms.eq.ms(k)) then
c         if (xac.eq.ac(k)) then
            maxk=k
            go to 1000
          end if
        enddo
