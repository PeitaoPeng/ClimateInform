...
c     do it=61,70  !61=1991; 70=2000
      do it=61,ltime  !61=1991; 70=2000
      kt=kt+1
         avg=0
         do k=it-kk,it-1
         avg=avg+fld2D(m,k)/float(kk)
...
c     do it=71,ltime  !71=2001
c     kt=kt+1
c        avg=0
c        do k=it-kk,it-1
c        avg=avg+fld2D(m,k)/float(kk)
c        end do
c        fldprd(kt)=avg-clm5
c        vrfy(kt)=fld2D(m,it)-clm5
c     end do
C== acc calculation
