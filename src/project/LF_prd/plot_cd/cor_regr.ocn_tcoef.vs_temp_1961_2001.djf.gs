...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/cor_regr.ocn_tcoef.vs_temp_1961_2001.djf.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 OCN(K=17) predicted EOF1 coef vs sfc temp'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.2 DJF (1961-2001)'
...
*----------
 ...
 if(iframe = 2); 'draw string 'titlx2' 'titly' regression(`ao`nK)'; endif
 'run /export-6/sgi9/wd52pp/bin/cbarn.gs 1 1 7.2 'bary''
*
  iframe=iframe+1
endwhile
'print'
