...
'define ff2=maskout(fd2/(fd2+fd3),mask.2(t=1)-1)'
'define ff3=maskout(fd3/(fd2+fd3),mask.2(t=1)-1)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
 'draw string 4.25 10.5 Variance of MAM sfc temp (1931-2001)'
...
if(iframe = 1); 'set clevs   1 2 3 4 5'; endif
if(iframe = 1); 'set ccols   0 21 23 25 27 29'; endif
'set csmooth on'
'd ff'%iframe
 'set string 1 tc 4'
