...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/eof.temp_102_anom_1931-2001.djf_jfm_fma.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 EOF of DJF_JFM_FMA sfc temp (1931-2001)'
...
'set gxout shaded'
'set grads off'
'set clevs  -0.2 -0.15 -0.1 0.1 0.15 0.2 '
