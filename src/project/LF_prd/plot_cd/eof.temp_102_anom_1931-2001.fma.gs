...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/eof.temp_102_anom_1931-2001.fma.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 EOFs of FMA sfc temp (1931-2001)'
...
*----------
 ...
 if(iframe = 2); 'draw string 'titlx' 'titly' mode2 22%'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' mode3 13%'; endif
*
  iframe=iframe+1
