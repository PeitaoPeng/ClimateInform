...
*----------
if(iframe = 1); 'draw string 'titlx' 'titly' 1974'; endif
if(iframe = 2); 'draw string 'titlx' 'titly' 1989'; endif
if(iframe = 3); 'draw string 'titlx' 'titly' 1990'; endif
if(iframe = 4); 'draw string 'titlx' 'titly' 1991'; endif
if(iframe = 5); 'draw string 'titlx' 'titly' 1997'; endif
if(iframe = 6); 'draw string 'titlx' 'titly' 1999'; endif
if(iframe = 7); 'draw string 'titlx' 'titly' 2000'; endif
if(iframe = 8); 'draw string 'titlx' 'titly' 1975'; endif
if(iframe = 9); 'draw string 'titlx' 'titly' 1990'; endif
if(iframe = 10); 'draw string 'titlx' 'titly' 1991'; endif
if(iframe = 11); 'draw string 'titlx' 'titly' 1992'; endif
if(iframe = 12); 'draw string 'titlx' 'titly' 1998'; endif
if(iframe = 13); 'draw string 'titlx' 'titly' 2000'; endif
