...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/eof.temp_102_anom_1931-2001.jfm.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 EOFs of JFM sfc temp (1931-2001)'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' mode1 49%'; endif
