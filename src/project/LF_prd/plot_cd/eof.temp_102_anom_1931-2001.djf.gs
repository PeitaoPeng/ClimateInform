...
'open grid.ctl'
'open maskus.ctl'
'open /export/hobbes/wd52pp/project/LF_prd/plot_cd/eof.temp_102_anom_1931-2001.djf.ctl'
*
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' mode1 48%'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly' mode2 28%'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' mode3 10%'; endif
*
  iframe=iframe+1
