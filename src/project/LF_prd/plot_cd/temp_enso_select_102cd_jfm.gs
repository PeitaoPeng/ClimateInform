...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/temp_enso_select_102cd_jfm.ctl'
*
...
'define fd4=oacres(grid.1(t=1),z.3(t=4))'
'define ff4=maskout(fd4,mask.2(t=1)-1)'
'define fd5=oacres(grid.1(t=1),z.3(t=5))'
'define ff5=maskout(fd5,mask.2(t=1)-1)'
'define fd6=oacres(grid.1(t=1),z.3(t=6))'
'define ff6=maskout(fd6,mask.2(t=1)-1)'
'define fd7=oacres(grid.1(t=1),z.3(t=7))'
'define ff7=maskout(fd7,mask.2(t=1)-1)'
'define fd8=oacres(grid.1(t=1),z.3(t=8))'
'define ff8=maskout(fd8,mask.2(t=1)-1)'
'define fd9=oacres(grid.1(t=1),z.3(t=9))'
'define ff9=maskout(fd9,mask.2(t=1)-1)'
'define fd10=oacres(grid.1(t=1),z.3(t=10))'
'define ff10=maskout(fd10,mask.2(t=1)-1)'
'define fd11=oacres(grid.1(t=1),z.3(t=11))'
'define ff11=maskout(fd11,mask.2(t=1)-1)'
'define fd12=oacres(grid.1(t=1),z.3(t=12))'
'define ff12=maskout(fd12,mask.2(t=1)-1)'
'define fd13=oacres(grid.1(t=1),z.3(t=13))'
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.7 JFM sfc temp for ENSO years'
...
*----------
if(iframe = 1); 'draw string 'titlx' 'titly' 1966'; endif
if(iframe = 2); 'draw string 'titlx' 'titly' 1969'; endif
if(iframe = 3); 'draw string 'titlx' 'titly' 1973'; endif
if(iframe = 4); 'draw string 'titlx' 'titly' 1983'; endif
if(iframe = 5); 'draw string 'titlx' 'titly' 1987'; endif
if(iframe = 6); 'draw string 'titlx' 'titly' 1992'; endif
if(iframe = 7); 'draw string 'titlx' 'titly' 1998'; endif
if(iframe = 8); 'draw string 'titlx' 'titly' 1971'; endif
if(iframe = 9); 'draw string 'titlx' 'titly' 1974'; endif
if(iframe = 10); 'draw string 'titlx' 'titly' 1976'; endif
if(iframe = 11); 'draw string 'titlx' 'titly' 1985'; endif
if(iframe = 12); 'draw string 'titlx' 'titly' 1989'; endif
if(iframe = 13); 'draw string 'titlx' 'titly' 1999'; endif
if(iframe = 14); 'draw string 'titlx' 'titly' 2000'; endif
*
  iframe=iframe+1
