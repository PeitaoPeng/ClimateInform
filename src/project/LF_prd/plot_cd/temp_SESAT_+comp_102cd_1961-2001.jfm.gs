...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/temp_SESAT_comp_102cd_1961-2001.jfm.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 JFM sfc temp composite (SESAT > stdv)'
...
*----------
 if(iframe = 1); 'draw string 'titlx1' 'titly'  0 year'; endif
 if(iframe = 2); 'draw string 'titlx2' 'titly' +1 year'; endif
*
  iframe=iframe+1
