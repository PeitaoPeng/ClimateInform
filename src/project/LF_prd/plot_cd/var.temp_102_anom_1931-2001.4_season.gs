...
'define ff1=sqrt(maskout(fd1,mask.2(t=1)-1))'
'define fd2=oacres(grid.1(t=1),z.5(t=1))'
'define ff2=sqrt(maskout(fd2,mask.2(t=1)-1))'
'define fd3=oacres(grid.1(t=1),z.4(t=1))'
'define ff3=sqrt(maskout(fd3,mask.2(t=1)-1))'
'define fd4=oacres(grid.1(t=1),z.6(t=1))'
'define ff4=sqrt(maskout(fd4,mask.2(t=1)-1))'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
 'draw string 4.25 10.5 STDV of seasonal sfc temp (`ao`nC) (1931-2001)'
