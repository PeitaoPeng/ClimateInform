...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/reof.temp_102_anom_1931-2002.jfm.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 REOFs of JFM sfc temp (1931-2002)'
*---------------------------set dimsnesion, page size and style
nframe=3
nframe2=3
xmin0=1.5;  xlen=5.5;  xgap=0.5
ymax0=9.5; ylen=-2.0;  ygap=-0.65
*
iframe=1
while ( iframe <= nframe )
...
*----------
 ...
 if(iframe = 2); 'draw string 'titlx' 'titly' REOF2 27%'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' REOF3 19%'; endif
*
  iframe=iframe+1
'run /export-6/sgi9/wd52pp/bin/cbarn.gs 1 1 6.75 5.85'
endwhile
'print'
*'c'
 'set vpage off'
