...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/rregr.temp_102_1931-2001.jfm.wang_HP.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 REOF of JFM HP sfc temp (`ao`nC) (1931-2001)'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' mode1 42%'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly' mode2 24%'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' mode3 20%'; endif
*
  iframe=iframe+1
