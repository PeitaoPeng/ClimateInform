...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/eof.temp_102_anom_1931-2001.son.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 EOFs of SON sfc temp (1931-2001)'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' mode1 43%'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly' mode2 31%'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' mode3  8%'; endif
*
  iframe=iframe+1
