...
*
'define fd20=oacres(grid.1(t=1),z.3(t=16))'
'define ff20=maskout(fd20,mask.2(t=1)-1)'
'define fd21=oacres(grid.1(t=1),z.3(t=18))'
'define ff21=maskout(fd21,mask.2(t=1)-1)'
'define fd22=oacres(grid.1(t=1),z.3(t=20))'
'define ff22=maskout(fd22,mask.2(t=1)-1)'
'define fd23=oacres(grid.1(t=1),z.3(t=22))'
'define ff23=maskout(fd23,mask.2(t=1)-1)'
'define fd24=oacres(grid.1(t=1),z.3(t=24))'
'define ff24=maskout(fd24,mask.2(t=1)-1)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
 'draw string 4.25 10.9 1931-2002 JFM sfc temp for RPC2 < -stdv'
