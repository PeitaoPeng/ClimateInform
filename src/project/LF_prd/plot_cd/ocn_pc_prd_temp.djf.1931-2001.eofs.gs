...
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/ocn_pc_prd_temp.djf.1931-2001.eof2.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/ocn_pc_prd_temp.djf.1931-2001.eof3.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/ocn_pc_prd_temp.djf.1931-2001.eof4.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/ocn_pc_prd_temp.djf.1931-2001.eof5.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/ocn_pc_prd_temp.djf.1931-2001.eof6.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 OCN prd skill by using single EOF component'
...
*----------
 if(iframe = 1); 'draw string 'titlx1' 'titly' EOF1 K=30'; endif
 if(iframe = 2); 'draw string 'titlx1' 'titly' EOF2 K=25'; endif
 if(iframe = 3); 'draw string 'titlx1' 'titly' EOF3 K= 4'; endif
 if(iframe = 4); 'draw string 'titlx1' 'titly' EOF4 K=29'; endif
 if(iframe = 5); 'draw string 'titlx1' 'titly' EOF5 K= 1'; endif
