...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/reof.temp_102_anom_1931-2001.djf_jfm_fma.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 REOF of DJF_JFM_FMA sfc temp (1931-2001)'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' mode1 38%'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly' mode2 26%'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' mode3 17%'; endif
*
  iframe=iframe+1
