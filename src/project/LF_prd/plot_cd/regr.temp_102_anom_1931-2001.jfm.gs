...
'open grid.ctl'
'open maskus.ctl'
'open /export-6/sgi9/wd52pp/project/LF_prd/plot_cd/reof.temp_102_anom_1931-2001.jfm.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 REOFs of JFM sfc temp (`ao`nC) (1931-2001)'
...
*----------
 ...
 if(iframe = 2); 'draw string 'titlx' 'titly' mode2 27%'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' mode3 19%'; endif
*
  iframe=iframe+1
