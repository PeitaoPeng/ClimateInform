...
*
'open /export-6/cacsrv1/wd52pp/LF_prd/rsd_rcoef.z200_5002jfm.wang_HP.ntd_ifrc_2.ctl'
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 RPCs of residual HP Z200 (JFM 50-02)'
...
*----------
 ...
 if(iframe = 4); 'draw string 'titlx' 'titly' RPC5'; endif
*
  iframe=iframe+1
