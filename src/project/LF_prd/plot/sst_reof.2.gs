...
*
  'define stdv1=-regr'
  'define stdv2=-regr.2(t=1)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
 'draw string 4.25 10.5 EOFs of detrended Pacific SST JFM(50-02)'
*'draw string 5.5 7.5 cmap prate clim (79-01) (mm/day)'
*---------------------------set dimsnesion, page size and style
nframe=2
nframe2=2
xmin0=1.75;  xlen=5.0;  xgap=0.5
ymax0=9.0; ylen=-1.6;  ygap=-0.8
*
iframe=1
while ( iframe <= nframe )
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' EOF1 of HP (50%)'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly' EOF1 of LP (45%)'; endif
*
  iframe=iframe+1
'run /export-6/sgi9/wd52pp/bin/cbarn.gs 0.7 0 4.25 4.0'
endwhile
'print'
*'c'
 'set vpage off'
