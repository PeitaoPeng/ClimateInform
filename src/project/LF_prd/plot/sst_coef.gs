...
*
'open /export-6/cacsrv1/wd52pp/LF_prd/coef.gpsst.5002jfm.wang_HP.ntd.ctl'
'open /export-6/cacsrv1/wd52pp/LF_prd/coef.gpsst.5002jfm.wang_LP.ntd.ctl'
...
*---------------------------string/caption
 ...
 'draw string 4.25 10.5 PCs of detrended Pacific SSTs JFM(50-02)'
*'draw string 5.5 7.5 cmap prate clim (79-01) (mm/day)'
*---------------------------set dimsnesion, page size and style
nframe=2
nframe2=2
xmin0=1.0;  xlen=6.5;  xgap=0.5
ymax0=9.0; ylen=-1.5;  ygap=-0.5
*
iframe=1
while ( iframe <= nframe )
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' PC1 of HP'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly' PC1 of LP'; endif
*
  iframe=iframe+1
