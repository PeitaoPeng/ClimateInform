...
*
  ...
  'define stdv1=sqrt(vtot)'
  'define stdv2=sqrt(vntd-vlp)'
  'define stdv3=sqrt(vtot-vntd)'
  'define stdv4=sqrt(vlp)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
 'draw string 4.25 10.5 STDV of JFM 2mt (50-02)'
...
*'set map 15 1 2'
'set gxout shaded'
'set clevs  0.5 1 1.5 2 2.5 3'
'set ccols  0 22 23 24 25 27 29'
'set xlab off'
'set ylab off'
'd stdv'%iframe
'set gxout contour'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' total'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly' 7yr HP'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly' trend'; endif
 if(iframe = 4); 'draw string 'titlx' 'titly' 7yr LP'; endif
*
  iframe=iframe+1
