...
*
  'define stdv1=regr.3'
  'define stdv2=-rregr(t=1)'
  'define stdv3=-rregr.2(t=1)'
  'define stdv4=rregr.2(t=2)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
 'draw string 4.25 10.5 regression of SST to Pacific SST indices JFM(50-02)'
*'draw string 5.5 7.5 cmap prate clim (79-01) (mm/day)'
*---------------------------set dimsnesion, page size and style
nframe=4
nframe2=4
xmin0=1.75;  xlen=5.0;  xgap=0.5
ymax0=9.8; ylen=-1.6;  ygap=-0.6
*
iframe=1
while ( iframe <= nframe )
