...
*
'open /export-6/cacsrv1/wd52pp/LF_prd/rsd_reof.z200_5002jfm.wang_HP.ntd_ifrc_2.ctl'
...
*
  ...
  'define stdv4=regr(t=7)'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
'draw string 4.25 10.5 REOFs of residual HP Z200 (JFM 50-02)'
...
*----------
 ...
 if(iframe = 4); 'draw string 'titlx' 'titly' REOF5'; endif
*
  iframe=iframe+1
