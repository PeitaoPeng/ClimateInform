...
*
'open /export-6/cacsrv1/wd52pp/LF_prd/coef.temp_102_anom_1931-2001.djf_jfm_fma.ctl'
'enable print  meta.clim'
'run /export-6/sgi9/wd52pp/bin/rgbset.gs'
*
*
  'define stdv1=rcoef(t=1)'
  'define stdv2=rcoef(t=2)'
  'define stdv3=rcoef(t=3)'
  'define zr=0.0'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
 'draw string 4.25 10.5 RPCs of US Tsfc (JFM 31-01)'
