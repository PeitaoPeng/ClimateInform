...
jmx=73
#
ngrd=145 # total non-undef grid number in the interested domain
nflds=`expr $ngrd + 1`
nt_tot=37 # N(year)
ntrain=36 # N-1 for CV test
...
ln -s $datadir/$model.SSTem.ss.${icmon}_ic.1982-2018.ld1-7.esm.anom.gr fort.15
ln -s $datadir2/obs.sst.ss.may_ic.1981-2019.ld1-7.anom.gr fort.25
#
...
#
ln -s $datadir/${model}_sst.${icmon}_ic.1982-2018.djf.bi  fort.50
ln -s $datadir/obs_sst.1982-2018.djf.bi               fort.51
ln -s $datadir/mlp.sst.${icmon}_ic.1982-2018.djf.bi   fort.52

#excute program
mlp.x > $lcdir/out
#
cat>$datadir/mlp.sst.${icmon}_ic.1982-2018.djf.ctl<<EOF
dset ^mlp.sst.${icmon}_ic.1982-2018.djf.bi
undef -9.99E+08
title EXP1
...
EOF
#
cat>$datadir/${model}_sst.${icmon}_ic.1982-2018.djf.ctl<<EOF2
dset ^${model}_sst.${icmon}_ic.1982-2018.djf.bi
undef -9.99E+8
title EXP1
XDEF  $imx LINEAR    0  2.5
YDEF  $jmx LINEAR  -90  2.5
...
cat>$datadir/obs_sst.1982-2018.djf.ctl<<EOF3
dset ^obs_sst.1982-2018.djf.bi
undef -9.99E+8
title EXP1
XDEF  $imx LINEAR    0  2.5
YDEF  $jmx LINEAR  -90  2.5
