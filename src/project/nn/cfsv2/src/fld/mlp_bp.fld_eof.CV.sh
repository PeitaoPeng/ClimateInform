...
ln -s $datadir/input_fld_CV.eof.model.${icmon}_ic.gr fort.15
...
#
ln -s $datadir/mlp.sst_coef.${icmon}_ic.bi   fort.50

# excute program
mlp.x > $datadir/out
#
cat>$datadir/mlp.sst_coef.${icmon}_ic.ctl<<EOF
dset ^mlp.sst_coef.${icmon}_ic.bi
undef -9.99E+08
title EXP1
