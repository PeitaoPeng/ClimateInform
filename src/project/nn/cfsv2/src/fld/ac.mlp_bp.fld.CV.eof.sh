...
C===========================================================
      ...
      real xn34m(nt),xn34o(nt),xn34c(nt)
c
...
C nino34
      ...
      jss=35
      jee=39
      call have_index(w3do,imx,jmx,nt,iss,iee,jss,jee,xn34o)
      call have_index(w3dm,imx,jmx,nt,iss,iee,jss,jee,xn34m)
      call have_index(w3dc,imx,jmx,nt,iss,iee,jss,jee,xn34c)

      call corr_t(xn34o,xn34c,nt,corr,rmse)
      write(6,*) 'ann cor&rms=',corr,rmse
      call corr_t(xn34o,xn34m,nt,corr,rmse)
      write(6,*) 'cfsv2 cor&rms=',corr,rmse
...
c
      ...
      SUBROUTINE have_index(f,imx,jmx,nt,is,ie,js,je,out)
      real f(imx,jmx,nt),out(nt)
...
ln -s $datadir/CFSv2.sst.${icmon}_ic.1982-2019.djf.gr     fort.11
ln -s $datadir2/oisst.1982-cur.djf.anom.gr                 fort.12
