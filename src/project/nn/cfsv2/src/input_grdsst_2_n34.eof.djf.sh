...
rm fort.*
 ...
 ln -s $datadir/eof.input_sst.${icmon}_ic.1982-2019.djf.$clim.gr fort.40
...
cat>$datadir/eof.input_sst.${icmon}_ic.1982-2019.djf.$clim.ctl<<EOF3
dset ^eof.input_sst.${icmon}_ic.1982-2019.djf.$clim.gr
undef -9.99E+8
title EXP1
