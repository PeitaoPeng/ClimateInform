...
'set y  1 73'
'set gxout fwrite'
'set fwrite $dataout/oisst.1982-cur.djf.anom.gr'
*
'set z $ld'
yt=1
while(yt<=$nyear)
...
#
cat>$dataout/oisst.1982-cur.djf.anom.ctl<<EOF2
dset ^oisst.1982-cur.djf.anom.gr
undef -9.99E+8
title EXP1
...
'set y 37'
'set gxout fwrite'
'set fwrite $dataout/oisst.nino34.1982-cur.djf.gr'
*
'set z $ld'
yt=1
while(yt<=$nyear)
...
#
cat>$dataout/oisst.nino34.1982-cur.djf.ctl<<EOF
dset ^oisst.nino34.1982-cur.djf.gr
undef -9.99E+8
title EXP1
XDEF 1 LINEAR   0  1.0
