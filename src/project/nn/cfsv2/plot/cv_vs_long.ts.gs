...
'open /cpc/home/wd52pp/data/nn/nmme/mlp.djf.grdsst_2_n34.'icmon'_ic.long.ctl'
...
'set string 1 tl 4'
'draw string 5 6.7 NN Corrected (CV)'
'set string 2 tl 4'
'draw string 5 6.4 NN Corrected (trained from 1983-2008)'
'print'
'printim cv_vs_long.ts.png gif x800 y600'
*'c'
 'set vpage off'
*----------
