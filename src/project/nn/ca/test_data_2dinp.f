...
c*************************************************
      ...
      do it=1,nt
        ...
        rout3(it)=((rand-0.5)*2)
        CALL RANDOM_NUMBER(rand)
        rout1(it)=(1-wt)*rout3(it)+wt*((rand-0.5)*2)
        CALL RANDOM_NUMBER(rand)
        rout2(it)=(1-wt)*rout3(it)+wt*((rand-0.5)*2)
      enddo
      ...
      write(6,*) 'rmse_13=',rmse
      call rms_err(rout2,rout3,nt,rmse)
      write(6,*) 'rmse_23=',rmse
