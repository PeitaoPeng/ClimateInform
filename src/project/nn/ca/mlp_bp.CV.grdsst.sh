...
ln -s $datadir/input_sst.${icss}_ic.djf.gr   fort.10
ln -s $datadir/prd_train.bi   fort.20
ln -s $datadir/mlp.djf.sst.${icss}_ic.bi    fort.30
ln -s $datadir/prd_val.bi     fort.40

#excute program
mlp.x > $datadir/out1
#
cat>$datadir/mlp.djf.sst.${icss}_ic.ctl<<EOF
dset ^mlp.djf.sst.${icss}_ic.bi
undef -9.99E+33
title EXP1
