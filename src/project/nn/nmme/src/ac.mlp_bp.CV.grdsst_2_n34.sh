...
ln -s $datadir2/nino34.oi.dec1982-feb2020.djf.gr  fort.10
ln -s $datadir2/NMME.nino34.may_ic.1982-2019.djf.gr fort.11
ln -s $datadir2/mlp.djf.grdsst_2_n34.may_ic.whole.bi  fort.12
