...
c      parameter(is=49,ie=65,js=29,je=45) !120-160; 20S-20N ngrd=31
c      parameter(is=49,ie=65,js=37,je=45) !120-160; 0N-20N ngrd=22
c      parameter(is=49,ie=65,js=39,je=45) !120-160; 5N-20N ngrd=18
c      parameter(is=49,ie=65,js=37,je=39) !120-160; 0N-5N ngrd=9
...
#ln -s $datadir/nino34.oi.dec1982-feb2020.djf.gr fort.20
 ln -s $datadir/nino34.oi.1982-2020.djf.gr fort.20
