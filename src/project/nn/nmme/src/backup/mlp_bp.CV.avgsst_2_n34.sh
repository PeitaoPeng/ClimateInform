...
ln -s $datadir/input_avgsst.may_ic.1982-2019.djf.gr fort.10
ln -s $datadir/prd_train.bi   fort.20
ln -s $datadir/mlp.djf.avgsst_2_n34.${icmon}_ic.bi  fort.30
ln -s $datadir/prd_val.bi     fort.40

#excute program
mlp.x > $datadir/out
#
cat>$datadir/mlp.djf.avgsst_2_n34.${icmon}_ic.ctl<<EOF
dset ^mlp.djf.avgsst_2_n34.${icmon}_ic.bi
undef -9.99E+33
title EXP1
