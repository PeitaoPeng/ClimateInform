...
ln -s $datadir/mlp.sst.${icmon}_ic.1982-2019.djf.bi   fort.13
#
ln -s $datadir/ac_t.mlp.sst.${icmon}_ic.1982-2019.djf.bi   fort.20
ln -s $datadir/ac_s.mlp.sst.${icmon}_ic.1982-2019.djf.bi   fort.30

#excute program
ac.x
#
cat>$datadir/ac_t.mlp.sst.${icmon}_ic.1982-2019.djf.ctl<<EOF
dset ^ac_t.mlp.sst.${icmon}_ic.1982-2019.djf.bi
undef -9.99E+08
title EXP1
...
EOF
#
cat>$datadir/ac_s.mlp.sst.${icmon}_ic.1982-2019.djf.ctl<<EOF
dset ^ac_s.mlp.sst.${icmon}_ic.1982-2019.djf.bi
undef -9.99E+08
title EXP1
XDEF  1 LINEAR    0  2.5
