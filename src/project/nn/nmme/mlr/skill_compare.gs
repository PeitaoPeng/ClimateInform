...
#model=NMME
model=CFSv2
#'open /cpc/consistency/nn/nmme/skill.nino34.ld1-'nlead'.ctl'
'open /cpc/consistency/nn/cfsv2/mlr.skill.nino34.ld1-'nlead'.ctl'
...
'draw ylab AC'
'print'
'printim mlr.skill.'model'.png gif x800 y600'
*'c'
'set vpage off'
*----------
