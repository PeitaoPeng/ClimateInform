...
'set string 1 tl 4'
'draw string 5 6.7 OBS'
'set string 2 tl 4'
'draw string 5 6.4 NN trained with TP: AC=0.88, RMS=0.64'
'set string 4 tl 4'
'draw string 5 6.1 NN trained with NWTP: AC=0.87, RMS=0.64'
'print'
'printim whole_vs_nwp.png gif x800 y600'
*'c'
 'set vpage off'
*----------
