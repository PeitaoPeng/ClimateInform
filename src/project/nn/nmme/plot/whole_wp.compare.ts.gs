...
'open /cpc/home/wd52pp/data/nn/nmme/mlp.djf.grdsst_2_n34.'icmon'_ic.w160.ctl'
...
'set string 1 tl 4'
'draw string 5 6.7 NN trained with whole TP (ac=0.88)'
'set string 2 tl 4'
'draw string 5 6.4 NN trained with west to 160E (ac=0.86)'
'print'
'printim whole_vs_w160.png gif x800 y600'
*'c'
 'set vpage off'
*----------
