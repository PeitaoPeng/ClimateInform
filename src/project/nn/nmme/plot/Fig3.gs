...
'enable print Fig3.meta'
*
'open /cpc/home/wd52pp/data/nn/nmme/ac_t.mlp_bp.CV.grdsst_2_n34.ctl'
*
'set string 1 tc 5'
'set strsiz 0.15 0.15'
*'draw string 4.25 10.2 AC(NINO34 vs SST) DJF 1983-2020'
...
if(iframe = 4); 'draw string 'tlx' 'tly' d) ANN vs NMME'; endif
'set string 1 tl 5 0'
...
'print'
'printim Fig3.png gif x600 y800'
