...
'set string 2 tl 5'
if(iframe = 1);'draw string 'lx3' 'ly31' ANN (TP SST input)';endif
if(iframe = 2);'draw string 'lx3' 'ly32' ANN (TP SST input)';endif
'set string 1 tl 5'
...
endwhile
'print'
'printim skill_vs_ld.ts.png gif x600 y800'
*'c'
 'set vpage off'
*----------
