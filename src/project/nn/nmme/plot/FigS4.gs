...
'open /cpc/home/wd52pp/data/nn/nmme/mlp.djf.grdsst_2_n34.'icmon'_ic.NWTPnoeq.ctl'
...
'set string 1 tl 4'
'draw string 3.0 6.8 OBS'
'set string 2 tl 4'
'draw string 3. 6.55 ANN trained with NWTP(0-20N): AC=0.87, RMS=0.64'
'set string 4 tl 4'
'draw string 3. 6.3 ANN trained with NWTP(5N-20N): AC=0.85, RMS=0.66'
...
'print'
'printim FigS4.png gif x800 y600'
*'printim Fig5.eps'
*'c'
 'set vpage off'
*----------
