...
tool=pls
nmod=7
'open /cpc/consistency/nn/cfsv2_ww/skill.'tool'.tgtss.4V.SSTem_sst_d20_ssttdc_2_nino34.ld1-7.mode'nmod'.ctl'
...
'draw string 5.5 8. Skill of Nino34: CFSv2 vs PLS(CFSv2,SST,D20_SSTTDC)'
...
'set string 1 tl 5'
if(iframe = 1); 'draw string 'tx' 'ty' a) AC of PLS'; endif
if(iframe = 3); 'draw string 'tx' 'ty' b) AC of CFSv2'; endif
if(iframe = 2); 'draw string 'tx' 'ty' c) RMSE of PLS'; endif
...
endwhile
'print'
'printim skill.tgtss_vs_lead.'tool'.hybrid.4V.mode'nmod'.png gif x800 y600'
*'c'
 'set vpage off'
*----------
