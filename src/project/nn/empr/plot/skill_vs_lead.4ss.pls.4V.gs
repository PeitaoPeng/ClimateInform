...
nt=8
nmod=7
'open /cpc/consistency/nn/cfsv2_ww/skill.pls.tgtss.4V.SSTem_sst_d20_ssttdc_2_nino34.ld1-7.mode'nmod'.ctl'
...
'draw string 5.5 7.75 Skill of Nino34: CFSv2 vs PLS(CFS_SST,OBS_SST_D20_SSTTDC)'
...
if(iframe = 3);'set vrange 0.5 1';endif
if(iframe = 2);'set vrange 0.0 0.9';endif
if(iframe = 4);'set vrange 0.0 0.9';endif
...
'set string 2 tl 4'
if(iframe = 1);'draw string 'lx1' 'ly12' PLS_winter'; endif
'set string 4 tl 4'
if(iframe = 1);'draw string 'lx1' 'ly13' CFSv2_summer'; endif
'set string 3 tl 4'
if(iframe = 1);'draw string 'lx1' 'ly14' PLS_summer'; endif

'set string 1 tl 4'
if(iframe = 2);'draw string 'lx2' 'ly21' CFSv2_winter'; endif
'set string 2 tl 4'
if(iframe = 2);'draw string 'lx2' 'ly22' PLS_winter'; endif
'set string 4 tl 4'
if(iframe = 2);'draw string 'lx2' 'ly23' CFSv2_summer'; endif
'set string 3 tl 4'
if(iframe = 2);'draw string 'lx2' 'ly24' PLS_summer'; endif

'set string 1 tl 4'
if(iframe = 3);'draw string 'lx1' 'ly11' CFSv2_spring'; endif
'set string 2 tl 4'
if(iframe = 3);'draw string 'lx1' 'ly12' PLS_spring'; endif
'set string 4 tl 4'
if(iframe = 3);'draw string 'lx1' 'ly13' CFSv2_fall'; endif
'set string 3 tl 4'
if(iframe = 3);'draw string 'lx1' 'ly14' PLS_fall'; endif

'set string 1 tl 4'
if(iframe = 4);'draw string 'lx2' 'ly21' CFSv2_spring'; endif
'set string 2 tl 4'
if(iframe = 4);'draw string 'lx2' 'ly22' PLS_spring'; endif
'set string 4 tl 4'
if(iframe = 4);'draw string 'lx2' 'ly23' CFSv2_fall'; endif
'set string 3 tl 4'
if(iframe = 4);'draw string 'lx2' 'ly24' PLS_fall'; endif
...
endwhile
'print'
'printim skill_vs_lead.4ss.hybrid.4V.pls.mode'nmod'.png gif x800 y600'
*'c'
 'set vpage off'
*----------
