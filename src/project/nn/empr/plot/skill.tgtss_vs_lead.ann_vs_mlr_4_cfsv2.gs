...
'draw string 5.5 8. Skill of Nino34: ANN vs MLR for CFSv2 Correction'
...
if(iframe = 3); 'd acn.2'; endif
if(iframe = 4); 'd rmsn.2'; endif

'set string 1 tl 5'
if(iframe = 1); 'draw string 'tx' 'ty' a) AC of ANN'; endif
if(iframe = 3); 'draw string 'tx' 'ty' b) AC of MLR'; endif
if(iframe = 2); 'draw string 'tx' 'ty' c) RMSE of ANN'; endif
if(iframe = 4); 'draw string 'tx' 'ty' d) RMSE of MLR'; endif

iframe=iframe+1
'run /cpc/home/wd52pp/bin/cbarn2.gs 0.9 0 5.5 0.5'
endwhile
'print'
'printim skill.tgtss_vs_lead.mlr_vs_ann_4_cfsv2.png gif x800 y600'
*'c'
 'set vpage off'
*----------
