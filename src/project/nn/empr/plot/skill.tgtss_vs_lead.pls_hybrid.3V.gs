...
tool=pls
nmod=7
'open /cpc/consistency/nn/cfsv2_ww/skill.'tool'.tgtss.3V.SSTem_sst_d20_2_nino34.ld1-7.mode'nmod'.ctl'
...
'draw string 5.5 8. Skill of Nino34: CFSv2 vs PLS(CFSv2,SST,D20)'
...
endwhile
'print'
'printim skill.tgtss_vs_lead.'tool'.hybrid.3V.mode'nmod'.png gif x800 y600'
*'c'
 'set vpage off'
*----------
