...
'draw string 5.5 8. Skill of Nino34: CFSv2 vs MLR(SST,D20)'
...
'set string 1 tl 5'
if(iframe = 1); 'draw string 'tx' 'ty' a) AC of MLR(SST,D20)'; endif
if(iframe = 3); 'draw string 'tx' 'ty' b) AC of CFSv2'; endif
if(iframe = 2); 'draw string 'tx' 'ty' c) RMSE of MLR(SST,D20)'; endif
