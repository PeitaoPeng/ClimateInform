...
if(iframe = 2);'set vrange 0.0 0.8';endif
...
'set string 2 tl 5'
if(iframe = 1);'draw string 'lx1' 'ly12' MLR'; endif
'set string 3 tl 5'
if(iframe = 1);'draw string 'lx1' 'ly13' ANN'; endif

'set string 1 tl 5'
if(iframe = 2);'draw string 'lx2' 'ly11' CFSv2'; endif
'set string 2 tl 5'
if(iframe = 2);'draw string 'lx2' 'ly12' MLR'; endif
'set string 3 tl 5'
if(iframe = 2);'draw string 'lx2' 'ly13' ANN'; endif
...
endwhile
'print'
'printim skill_vs_lead.allss.hybrid.png gif x800 y600'
*'c'
 'set vpage off'
*----------
