...
'draw string 5.5 7.75 Skill of Nino34: CFSv2 vs MLR(SST,D20)'
...
if(iframe = 2);'set vrange 0.0 1.';endif
if(iframe = 4);'set vrange 0.0 1.';endif
...
if(iframe = 3); 'd ave(ac.2,e=2,e=4)'; endif
'set cmark 3'
'set cstyle 1'
'set cthick 6'
'set ccolor 3'
if(iframe = 1); 'd ave(ac.2,e=5,e=7)'; endif
if(iframe = 3); 'd ave(ac.2,e=8,e=10)'; endif
'set cmark 3'
'set cstyle 1'
'set cthick 6'
'set ccolor 1'
...
if(iframe = 4); 'd ave(rms.2,e=2,e=4)'; endif
'set cmark 3'
'set cstyle 1'
'set cthick 6'
'set ccolor 3'
if(iframe = 2); 'd ave(rms.2,e=5,e=7)'; endif
if(iframe = 4); 'd ave(rms.2,e=8,e=10)'; endif
*----------
'set string 1 tl 4'
...
'set string 2 tl 4'
if(iframe = 2);'draw string 'lx2' 'ly12' MLR_winter'; endif
'set string 4 tl 4'
if(iframe = 2);'draw string 'lx2' 'ly13' CFSv2_summer'; endif
'set string 3 tl 4'
if(iframe = 2);'draw string 'lx2' 'ly14' MLR_summer'; endif
...
'set string 1 tl 4'
if(iframe = 4);'draw string 'lx2' 'ly11' CFSv2_spring'; endif
'set string 2 tl 4'
if(iframe = 4);'draw string 'lx2' 'ly12' MLR_spring'; endif
'set string 4 tl 4'
if(iframe = 4);'draw string 'lx2' 'ly13' CFSv2_fall'; endif
'set string 3 tl 4'
if(iframe = 4);'draw string 'lx2' 'ly14' MLR_fall'; endif
