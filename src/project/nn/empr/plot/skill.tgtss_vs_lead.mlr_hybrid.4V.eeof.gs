...
'draw string 5.5 8. Skill of Nino34: CFSv2 vs MLR(CFSv2,CA,SST,D20)'
...
'set string 1 tl 5'
if(iframe = 1); 'draw string 'tx' 'ty' a) AC of MLR'; endif
if(iframe = 3); 'draw string 'tx' 'ty' b) AC of CFSv2'; endif
if(iframe = 2); 'draw string 'tx' 'ty' c) RMSE of MLR'; endif
...
endwhile
'print'
'printim skill.tgtss_vs_lead.'tool'.hybrid.4V.nmod'nmod'.eeof.png gif x800 y600'
*'c'
 'set vpage off'
*----------
