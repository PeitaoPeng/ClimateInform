...
nt=8
nmod=7
'open /cpc/consistency/nn/cfsv2_ww/skill.pls.tgtss.2V.sst_d20_2_nino34.ld1-7.mode'nmod'.ctl'
...
'draw string 5.5 7.75 Skill of Nino34: CFSv2 vs PLS(OBS_SST_D20)'
...
endwhile
'print'
'printim skill_vs_lead.4ss.hybrid.2V.pls.mode'nmod'.png gif x800 y600'
*'c'
 'set vpage off'
*----------
