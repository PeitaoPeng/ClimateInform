...
'set string 2 tl 4'
if(iframe = 1);'draw string 'lx1' 'ly12' ANN(CFSv2_SST)'; endif
'set string 3 tl 4'
if(iframe = 1);'draw string 'lx1' 'ly13' MLR(CFSv2_SST)'; endif

'set string 1 tl 4'
if(iframe = 2);'draw string 'lx1' 'ly21' CFSv2'; endif
'set string 2 tl 4'
if(iframe = 2);'draw string 'lx1' 'ly22' ANN(CFSv2_SST)'; endif
'set string 3 tl 4'
if(iframe = 2);'draw string 'lx1' 'ly23' MLR(CFSv2_SST)'; endif
...
endwhile
'print'
'printim skill_vs_lead.allss.ann_vs_mlr_4_cfsv2.png gif x800 y600'
*'c'
 'set vpage off'
*----------
