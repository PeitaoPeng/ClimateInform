...
tool=mlr
nmod=5
'open /cpc/consistency/nn/cfsv2_ww/skill.'tool'.tgtss.4V.SSTem_casst_d20_sst_2_nino34.ld1-7.nmod'nmod'.eeof.ctl'
...
'draw string 5.5 7.75 Skill of Nino34: CFSv2 vs MLR(CFS,CA,SST,D20)'
...
endwhile
'print'
'printim skill_vs_lead.4ss.hybrid.4V.nmod'nmod'eeof.png gif x800 y600'
*'c'
 'set vpage off'
*----------
