...
nt=8
nmod=7
'open /cpc/consistency/nn/cfsv2_ww/skill.pls.tgtss.3V.SSTem_sst_d20_2_nino34.ld1-7.mode'nmod'.ctl'
...
'draw string 5.5 7.75 Skill of Nino34: CFSv2 vs PLS(CFS_SST,OBS_SST_D20)'
...
endwhile
'print'
'printim skill_vs_lead.4ss.hybrid.3V.pls.mode'nmod'.png gif x800 y600'
*'c'
 'set vpage off'
*----------
