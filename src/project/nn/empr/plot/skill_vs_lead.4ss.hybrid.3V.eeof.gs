...
*
nt=8
'open /cpc/consistency/nn/cfsv2_ww/skill.mlr.tgtss.3V.SSTem_sst_d20_2_nino34.ld1-7.nmod5.eeof.ctl'
...
'draw string 5.5 7.75 Skill of Nino34: CFSv2 vs MLR(CFS_SST,OBS_SST_D20)'
...
endwhile
'print'
'printim skill_vs_lead.4ss.hybrid.3V.eeof.png gif x800 y600'
*'c'
 'set vpage off'
*----------
