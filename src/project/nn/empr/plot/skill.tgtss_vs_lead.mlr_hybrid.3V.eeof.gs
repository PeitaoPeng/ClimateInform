...
tool=mlr
nmod=7
'open /cpc/consistency/nn/cfsv2_ww/skill.'tool'.tgtss.3V.SSTem_sst_d20_2_nino34.ld1-7.nmod'nmod'.eeof.ctl'
...
'draw string 5.5 8. Skill of Nino34: CFSv2 vs MLR(CFSv2,SST,D20)'
...
endwhile
'print'
'printim skill.tgtss_vs_lead.'tool'.hybrid.3V.nmod'nmod'eeof.png gif x800 y600'
*'c'
 'set vpage off'
*----------
