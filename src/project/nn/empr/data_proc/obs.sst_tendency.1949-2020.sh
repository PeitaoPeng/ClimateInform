...
totmon2=`expr $totmon + 12` # from jan1948 to Mar of this year
data_bgn=jan$yyyys 
data_end=mar$thisyr # past month
#
outfile=obs.${var}_tendency  #sst(t)-sst(t-1)
#outfile=obs.${var}_tendency2  #sst(t)-sst(t-2)
#
undef_data=-9.99E+8
#
imx=144
...
outfile1=$outfile.$mon.$yyyys-$lastyr
#
