...
#
mv ac.12 $datadir/skill.$model.2V.${var1}_${var2}_2_nino34.nmod${nmod1}_${nmod2}.gr

cat>$datadir/skill.$model.2V.${var1}_${var2}_2_nino34.nmod${nmod1}_${nmod2}.ctl<<EOF
dset ^skill.$model.2V.${var1}_${var2}_2_nino34.nmod${nmod1}_${nmod2}.gr
undef -9.99e+33
*
TITLE model
*
