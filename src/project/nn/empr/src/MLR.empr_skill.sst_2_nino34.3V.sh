...
#
mv ac.12 $datadir/skill.$model.3V.${var1}_${var2}_${var3}_2_nino34.nmod${nmod1}_${nmod2}_${nmod3}.gr

cat>$datadir/skill.$model.3V.${var1}_${var2}_${var3}_2_nino34.nmod${nmod1}_${nmod2}_${nmod3}.ctl<<EOF
dset ^skill.$model.3V.${var1}_${var2}_${var3}_2_nino34.nmod${nmod1}_${nmod2}_${nmod3}.gr
undef -9.99e+33
*
TITLE model
*
