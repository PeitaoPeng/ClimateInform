...
cat > parm.h << eof
       ...
       parameter(ngrd=$ngrd1,nfld=$nmod+1)
...
#
mv ac.12 $datadir/skill.$model.1V.${var}_2_nino34.nmod${nmod}.std.gr

cat>$datadir/skill.$model.1V.${var}_2_nino34.nmod${nmod}.std.ctl<<EOF
dset ^skill.$model.1V.${var}_2_nino34.nmod${nmod}.std.gr
undef -9.99e+33
*
TITLE model
*
