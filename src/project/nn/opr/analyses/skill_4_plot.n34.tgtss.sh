...
cp $lcdir/skill_4_plot.n34.tgtss.f skill.f
 ...
 ln -s $datadir/skill.$tool.$varn.${var}_2_nino34.ld1-$nlead.nmod$nmod.gr fort.10
 ln -s $datadir/skill.$tool.tgtss.$varn.${var}_2_nino34.ld1-$nlead.nmod$nmod.gr fort.40

 skill.x 
#
cat>$datadir/skill.$tool.tgtss.$varn.${var}_2_nino34.ld1-$nlead.nmod$nmod.ctl<<EOF2
dset ^skill.$tool.tgtss.$varn.${var}_2_nino34.ld1-$nlead.nmod$nmod.gr
undef -9.99E+8
XDEF  1 LINEAR    0.  2.5
