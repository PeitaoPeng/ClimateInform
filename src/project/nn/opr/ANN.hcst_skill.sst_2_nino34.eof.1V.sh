...
mv acrms.$nlead $datadir2/skill.$tool.$varn.${var}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.nmod$nmod.gr

cat>$datadir2/skill.$tool.$varn.${var}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.nmod$nmod.ctl<<EOF
dset ^skill.$tool.$varn.${var}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.nmod$nmod.gr
undef -9.99e+33
*
TITLE model
*
