...
c      parameter(is=49,ie=121,js=29,je=45) !120-300 20S-20N
...
c      parameter(is=1,ie=144,js=29,je=45) !0-360 20S-20N
       parameter(is=1,ie=144,js=29,je=57) !0-360 20S-50N
c
...
C read model sst & obs nino34
      ...
      do it=1,nt
        ...
        read(12,rec=ir) w2d       !model hcst sst
...
C combine the all data together
      ...
      do i=is,ie
        ...
        w3dc(ic+im1+im1,jc,it)=w3d3(i,j,it)
        w3dc(ic+im1+im1+im1,jc,it)=w3d4(i,j,it)
      enddo  ! i loop
      enddo  ! j loop
      enddo  ! it loop
...
\rm fort.*
 ...
 ln -s $datadir2/$model.$var1.$tp.${icmonw}_ic.1982-2020.ld1-$nlead.esm.anom.$clim.gr fort.12
ln -s $datadir3/obs.$var2.$oicmonw.1979-2020.anom.gr           fort.13
ln -s $datadir3/obs.$var3.$oicmonw.1979-2020.anom.gr           fort.14
ln -s $datadir3/obs.$var4.$oicmonw.1979-2020.anom.gr           fort.15
#
#pls.x > $lcdir/out.$ld
pls.x
#
...
mv acrms.$nlead $datadir2/skill.$tool.$varn.${var1}_${var2}_${var3}_${var4}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.mode$mode.gr

cat>$datadir2/skill.$tool.$varn.${var1}_${var2}_${var3}_${var4}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.mode$mode.ctl<<EOF
dset ^skill.$tool.$varn.${var1}_${var2}_${var3}_${var4}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.mode$mode.gr
undef -9.99e+8
*
TITLE model
*
