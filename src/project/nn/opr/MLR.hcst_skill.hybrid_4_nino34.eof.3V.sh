...
#=========================================================
# hybrid scheme combining model nino3.4 with obs_sst_d20 fields for Nino3.4 hindcast skill 
#=========================================================
...
C calculate model nino34
      ...
      do j=js,je
        ...
        ig=ig+1
        rn34=rn34+w3d(i,j,it)
        endif
      enddo
      enddo
      xn34(it)=rn34/float(ig)
      enddo
c
C write out model nino34 and obs nino34
      do it=1,nt
