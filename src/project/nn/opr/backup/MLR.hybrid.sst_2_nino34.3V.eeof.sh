...
#=========================================================
# Hybrid_MLR combing CFSv2_SSTem and obbs SST and D20 for Nino3.4 hindcast skill
# for particular IC month and lead
#=========================================================
...
\rm fort.*
 ...
 ln -s $datadir3/obs.$var2.$icmonw.1979-2020.anom.gr           fort.21
