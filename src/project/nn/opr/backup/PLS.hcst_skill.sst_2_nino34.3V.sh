...
c      parameter(is=74,ie=75,js=37,je=38)  !120-300 ngrd=1061
c
...
\rm fort.*
 ...
 ln -s $datadir3/obs.$var2.$icmonw.1979-2020.anom.gr           fort.13
 ln -s $datadir3/obs.$var3.$icmonw.1979-2020.anom.gr           fort.14
#
#pls.x > $lcdir/out.$ld
pls.x
#
...
cat>$datadir2/skill.$tool.$varn.${var1}_${var2}_${var3}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.mode$mode.eeof.ctl<<EOF
dset ^skill.$tool.$varn.${var1}_${var2}_${var3}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.mode$mode.eeof.gr
undef -9.99e+8
*
TITLE model
*
