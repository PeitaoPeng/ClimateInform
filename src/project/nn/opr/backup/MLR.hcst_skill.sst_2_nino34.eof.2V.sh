...
mv acrms.$nlead $datadir2/skill.$tool.$varn.${var1}_${var2}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.nmod${nmod1}_${nmod2}.gr

cat>$datadir2/skill.$tool.$varn.${var1}_${var2}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.nmod${nmod1}_${nmod2}.ctl<<EOF
dset ^skill.$tool.$varn.${var1}_${var2}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.nmod${nmod1}_${nmod2}.gr
undef -9.99e+33
*
TITLE model
*
