...
#\rm fort.*
 ...
 ln -s $datadir2/$model.$var.$tp.${icmonw}_ic.1982-2020.ld1-$nlead.esm.anom.$clim.gr fort.20
 ln -s input_sst_nino34.$tp.${icmonw}_ic.gr                  fort.30
 input.x
#
cat>input_sst_nino34.$tp.${icmonw}_ic.ctl<<EOF3
...
ln -s input_sst_nino34.$tp.${icmonw}_ic.gr  fort.10
...
mv acrms.$nlead $datadir2/skill.${var}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.$clim.gr

cat>$datadir2/skill.${var}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.$clim.ctl<<EOF
dset ^skill.${var}_2_nino34.$tp.${icmonw}_ic.1982-$lastyr.ld1-$nlead.$clim.gr
undef -9.99e+33
*
TITLE model
*
