...
C===========================================================
      ...
      open(unit=95,form='unformatted',access='direct',recl=4*ifld)
      open(unit=80,form='unformatted',access='direct',recl=4*ngrd)
      open(unit=81,form='unformatted',access='direct',recl=4*ngrd)
      open(unit=85,form='unformatted',access='direct',recl=4*ngrd)
      open(unit=86,form='unformatted',access='direct',recl=4*ngrd)
...
ccc...CORR between coef and data
      ...
      write(85,rec=m) fld3     !correlation
      write(86,rec=m) fld4     !regression
