...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/prcp_102_anom_1931-2010.jas.2x2.ctl'
...
'draw string 5.5 7.35 STDV of CONUS Prec(mm/day) (JAS 1931-2010)'
...
endwhile
'print'
'printim prcp_stdv.map.jas.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
