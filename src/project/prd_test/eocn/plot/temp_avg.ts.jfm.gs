...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/temp_usavg_1931-2010.jfm.ctl'
...
'draw string 5.5 7.3 CONUS AVG Temp (JFM 1931-2010)'
...
'print'
'printim temp_avg.ts.jfm.png gif x800 y600'
*'c'
 'set vpage off'
