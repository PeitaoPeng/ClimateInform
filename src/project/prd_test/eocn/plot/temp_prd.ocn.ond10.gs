...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/gocnv1prd_sfcT_102CD.jfm1995-djf2010.2x2.ctl'
*'open /export-12/cacsrv1/wd52pp/prd_skill/eocnprd_sfcT_102CD.jfm1995-djf2010.2x2.ctl'
...
'draw string 5.5 7.5 OCN(K=10) Forecast OND2010 Temp'
...
endwhile
'print'
'printim temp_prd.gocn.ond10.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
