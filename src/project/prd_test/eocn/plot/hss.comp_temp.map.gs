...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/hss_enso_comp.temp.jfm95-djf09.2x2.ctl'
...
'draw string 5.5 7.35 HSS of Seasonal Temp with ENSO-Composite'
...
endwhile
'print'
'printim hss_temp.map.enso_comp.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
