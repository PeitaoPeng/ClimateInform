...
'enable print reof_rpc.temp.jas.mega'
*
*---------------------------string/caption
*
'set string 1 tc 4'
...
if(iframe > 6); ylen=ylen2; ymax0=ymax2; ygap=ygap2; endif
  ...
  titly2=ymax+0.17
if(iframe < 7);
'open /cpc/home/wd52pp/data/prd_skill/reof.temp_102_anom_1931-2011.jas.2x2.ctl'
endif
if(iframe > 6);
'open /cpc/home/wd52pp/data/prd_skill/rpc.temp_102_anom_1931-2011.jas.ctl'
endif
*
...
'set strsiz 0.12 0.12'
 if(iframe = 1); 'draw string 'titlx' 'titly1' REOF1 29%'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly1' REOF2 23%'; endif
 if(iframe = 3); 'draw string 'titlx' 'titly1' REOF3 10%'; endif
 if(iframe = 4); 'draw string 'titlx' 'titly1' REOF4  9%'; endif
 if(iframe = 5); 'draw string 'titlx' 'titly1' REOF5  8%'; endif
 if(iframe = 6); 'draw string 'titlx' 'titly1' REOF6  5%'; endif
if(iframe > 6) ;
...
endwhile
'print'
'printim reof_rpc.temp.jas.png gif x600 y800'
* 'c'  
* 'set vpage off'
*----------
