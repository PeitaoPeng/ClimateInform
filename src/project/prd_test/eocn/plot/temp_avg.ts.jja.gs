...
*
'open /cpc/home/wd52pp/data/prd_test/temp_usavg_1931-2012.jja.ctl'
...
'draw string 5.5 7.3 CONUS AVG Temp (JJA 1931-2012)'
...
'set string 3 tl 4'
'draw string 1.8 6.8 9-year running mean'
'print'
'printim temp_avg.ts.jja.png gif x800 y600'
*'c'
 'set vpage off'
