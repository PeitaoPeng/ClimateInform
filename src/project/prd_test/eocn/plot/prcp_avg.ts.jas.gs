...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/prcp_usavg_1931-2010.jas.ctl'
...
'draw string 5.5 7.3 CONUS AVG Prec(mm/day) (JAS 1931-2010)'
...
'print'
'printim prcp_avg.ts.jas.png gif x800 y600'
*'c'
 'set vpage off'
