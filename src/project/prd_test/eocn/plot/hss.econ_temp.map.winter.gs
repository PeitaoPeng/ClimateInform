...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/hss_eocn.temp.uscd.95-09.winter.2x2.ctl'
...
'draw string 5.5 7.9 HSS of EOCN Forecast of Winter Temp (95-10)'
...
endwhile
'print'
'printim hss_temp.map.eocn.winter.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
