...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/rpc.temp_102_anom_1931-2010.jas.ctl'
'run /export/hobbes/wd52pp/bin/rgbset2.gs'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.17 0.17'
 'draw string 4.25 10.0 RPCs of US T`bsfc`n (JAS 1931-2010)'
...
endwhile
'print'
'printim rpc.temp_102.31-10.jas.1-3.png gif x600 y800'
*'c'
'set vpage off'
*----------
'reinit'
...
endwhile
'print'
'printim rpc.temp_102.31-10.jas.4-6.png gif x600 y800'
*'c'
'set vpage off'
*----------
