...
'set strsiz 0.13 0.13'
'set string 1 tl 4'
'draw string 1.6 6.9 CPC(all grid pts) mean=11.1'
'set string 2 tl 4'
'draw string 1.6 6.7 CFSv1 mean=9.5'
'set string 3 tl 4'
'draw string 1.6 6.5 OCN mean=15.5'
'set string 5 tl 4'
...
'print'
'printim hss_temp.ts.sm.2cur.png gif x800 y600'
*'c'
 'set vpage off'
