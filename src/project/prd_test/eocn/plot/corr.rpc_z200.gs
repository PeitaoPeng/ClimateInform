...
'open /export-12/cacsrv1/wd52pp/prd_skill/corr.usp_rpc.vs.z200.49-10jfm.ctl'
*
...
*---------------------------string/caption
 ...
 'draw string 5.5 8.125 CORR (CONUS JFM Prec RPCs vs Z200) over 1949-2010'
...
endwhile
'print'
'printim corr.usp_rpc_z200.jfm.png gif x800 y600'
*'c'
