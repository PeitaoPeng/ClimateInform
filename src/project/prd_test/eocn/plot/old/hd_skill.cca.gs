...
*
'open /disk50/data/wd52pp/amip_skill/heidke_cca.sfct.uscd.56-03.ctl'
'run /export-6/sgi9/wd52pp/bin/rgbset2.gs'
'enable print HS_cca.gr'
*
*---------------------------string/caption
*
 'set string 1 tc 4'
 'set strsiz 0.18 0.18'
'draw string 5.5 7.5 CCA Heidke Skill (48MRM SS1) for US sfc T'
...
endwhile
'print'
'printim HS_cca.png gif x800 y600'
*'c'
 'set vpage off'
*----------
