...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/rpc.prcp_102_anom_1931-2010.jfm.ctl'
'run /export/hobbes/wd52pp/bin/rgbset2.gs'
*
*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.17 0.17'
 'draw string 4.25 10.0 RPCs of US Prec (JFM 1931-2010)'
...
endwhile
'print'
'printim rpc.prcp_102.31-10.jfm.1-3.png gif x600 y800'
*'c'
'set vpage off'
*----------
'reinit'
...
endwhile
'print'
'printim rpc.prcp_102.31-10.jfm.4-6.png gif x600 y800'
*'c'
'set vpage off'
*----------
