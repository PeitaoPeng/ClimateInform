...
*
*---------------------------string/caption
 'define c1=ave(t+t.2+t.3+t.4,t=5,t=19)/4.'
 'define c2=ave(t,t=5,t=19)'
 'define c3=ave(t.2,t=5,t=19)'
 'define c4=sqrt(ave(((t+t.2+t.3+t.4)/4-c1)*((t+t.2+t.3+t.4)/4-c1),t=5,t=19))'
 'define c5=sqrt(ave((t-c2)*(t-c2),t=5,t=19))'
 'define c6=sqrt(ave((t.2-c3)*(t.2-c3),t=5,t=19))'
*
 'set string 1 tc 4'
 'set strsiz 0.16 0.16'
'draw string 4.25 10.5 OCN Forecasted Temp (1995-2009)'
 'set strsiz 0.15 0.15'
'draw string 2.125 10.0 MEAN'
'draw string 6.375 10.0 STDV'
*---------------------------set dimsnesion, page size and style
nframe=6
nframe2=3
xmin0=0.5; xlen=3.5;  xgap=0.5
ymax0=9.75; ylen=-2.5;  ygap=-0.2
*
iframe=1
while ( iframe <= nframe )
...
*
  iframe=iframe+1
'run /export/hobbes/wd52pp/bin/cbarn2.gs 1 0 4.25 1.25'
endwhile
'print'
