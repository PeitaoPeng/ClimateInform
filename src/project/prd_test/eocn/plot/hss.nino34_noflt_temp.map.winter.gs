...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/hss_nino34_noflt.temp.uscd.95-09.winter.2x2.ctl'
...
'draw string 5.5 7.9 HSS of Nino34 Regr based fcst of Winter Temp (95-10)'
...
endwhile
'print'
'printim hss_temp.map.nino34_noflt.winter.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
