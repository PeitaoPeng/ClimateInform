...
'enable print corr.ust_rpc.vs.dec_sst.jfm.mega'
*
*---------------------------string/caption
*
'set string 1 tc 4 0'
'set strsiz 0.12 0.12'
'draw string 4.25 10.8 Corr of RPCs of JFM US Temp vs Dec(-1) SST'
*---------------------------set dimsnesion, page size and style
nframe=6
nframe2=6
xmin0=2.5;  xlen=3.75;  xgap=-0.2
...
if(iframe > 6); ylen=ylen2; ymax0=ymax2; ygap=ygap2; endif
  ...
  ty=ymax-0.75
if(iframe < 7);
'open /cpc/home/wd52pp/data/prd_skill/corr.jfm_ust_rpc.vs.dec_sst.1931-2011jfm.ctl'
endif
*
...
*----------
if(iframe=6);
'run /cpc/home/wd52pp/bin/cbarn2.gs 1.0 1 6.5 6.0'
endif
...
endwhile
'print'
'printim corr.ust_rpc.vs.dec_sst.jfm.png gif x600 y800'
* 'c'  
* 'set vpage off'
*----------
