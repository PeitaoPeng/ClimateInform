...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/hss_eocn.temp.jfm95-djf09.2x2.ctl'
'open /export-12/cacsrv1/wd52pp/prd_skill/hss_gocn.temp.jfm95-djf09.2x2.ctl'
...
'draw string 5.5 7.35 HSS of Seasonal Temp Forecast: EOCN-OCN(opt K)'
...
endwhile
'print'
'printim hss_temp.map.eocn-gocn.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
