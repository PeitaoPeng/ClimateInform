...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/prcp_102_anom_1931-2010.jfm.2x2.ctl'
...
'draw string 5.5 7.35 STDV of CONUS Prec(mm/day) (JFM 1931-2010)'
...
*'set gxout grfill'
'set gxout shaded'
'set clevs   0.25 0.5 0.75 1 1.25 1.5'
'set ccols   22 23 24 25 26 27 29'
*'set xlab off'
*'set ylab off'
*'set yaxis -80 80 20'
'd sqrt(ave(t*t,t=1,t=80))/30'
...
endwhile
'print'
'printim prcp_stdv.map.jfm.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
