...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/temp_usavg_1931-2010.jas.ctl'
...
'draw string 5.5 7.3 CONUS AVG Temp (JAS 1931-2010)'
...
'set string 3 tl 4'
'draw string 1.6 6.75 9-year running mean'
'print'
'printim temp_avg.ts.jas.png gif x800 y600'
*'c'
 'set vpage off'
