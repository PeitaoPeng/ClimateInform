...
'enable print corr.ust_rpc.vs.sst_z200.jas.mega'
*
*---------------------------string/caption
*
'set string 1 tc 4 0'
'set strsiz 0.12 0.12'
'draw string 4.25 10.8 Corr of RPCs of US Temp vs SST(left) and Z200(right) for JAS'
...
if(iframe > 6); ylen=ylen2; ymax0=ymax2; ygap=ygap2; endif
  ...
  ty=ymax-0.75
if(iframe < 7);
'open /cpc/home/wd52pp/data/prd_skill/corr.ust_rpc.vs.sst.1931-2011jas.ctl'
endif
if(iframe > 6);
'open /cpc/home/wd52pp/data/prd_skill/corr.ust_rpc.vs.z200.49-11jas.ctl'
endif
*
...
endwhile
'print'
'printim corr.ust_rpc.vs.sst_z200.jas.png gif x600 y800'
* 'c'  
* 'set vpage off'
*----------
