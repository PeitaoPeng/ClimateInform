...
'define cc=ave(hs1.2,t+0,t=180,1yr)'
'define cf=ave(hs1.3,t+0,t=168,1yr)'
'define en=ave(hss.4,t+0,t=180,1yr)'
'set cmark 0'
'set cstyle 1'
'set cthick 6'
'set ccolor 1'
...
'set string 3 tl 4'
'draw string 1.6 6.5 CFSv1 mean=8.5'
'set string 4 tl 5'
*'draw string 1.6 6.3 Nino34 Tele mean=5.5'
'print'
'printim hss_temp.ts.clim.png gif x800 y600'
*'c'
 'set vpage off'
