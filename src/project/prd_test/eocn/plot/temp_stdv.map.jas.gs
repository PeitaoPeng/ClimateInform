...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/temp_102_anom_1931-2010.jas.2x2.ctl'
...
'draw string 5.5 7.35 STDV of CONUS Temp (JAS 1931-2010)'
...
*'set gxout grfill'
'set gxout shaded'
'set clevs   0 0.25 0.5 0.75 1 1.25 1.5'
...
endwhile
'print'
'printim temp_stdv.map.jas.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
