...
*
'open /export-12/cacsrv1/wd52pp/prd_skill/eocnprd_temp.djf.1961-2009.non-norm.2x2.ctl'
'open /export-12/cacsrv1/wd52pp/prd_skill/eocnprd_temp.jja.1961-2009.non-norm.2x2.ctl'
'run /export/hobbes/wd52pp/bin/rgbset2.gs'
*'enable print hdks_t2m.map.cpc.gr'
*
*---------------------------string/caption
 'define temp1=ave(t,t=35,t=49)'
 'define temp2=ave(t.2,t=35,t=49)'
*'define temp1=ave(t,t=30,t=40)'
*'define temp2=ave(t.2,t=30,t=40)'
*
 'set string 1 tc 4'
 'set strsiz 0.18 0.18'
'draw string 5.5 7.5 EOCN Forecasted Temp (1995-2009 avg)'
...
endwhile
'print'
'printim avg_temp.eocn.map.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
