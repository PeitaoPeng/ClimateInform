     ...
     &f1d,f3d,f2d,pco,ptc,ptr,var,cosl,undef,ID)
C======================================================
...
C ptc: cor pattern from residual 
C ptr: regr pattern from residual
C cosl: cos of lat
...
C=====================================================
      ...
      dimension pc(nt,mode),ptc(im,jm,mode),ptr(im,jm,mode),var(mode)
      dimension pco(mode)
