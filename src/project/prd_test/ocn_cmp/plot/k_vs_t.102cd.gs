...
*
'open /cpc/home/wd52pp/data/prd_test/gocn.ocn.vs.cd_ss_t.rms.ctl'
*
...
'draw string 5.5 7.8 OCN of DJF Mean Temp'
...
'set ccols  0 42 44 45 46 48 32 33 34 36 38 62 64 65 66 67 69' 
'd k12'
'set string 1 tc 5'
'set strsiz 0.18 0.18'
'draw string 'tlx' 'tly' Climate Division Number'
*
'set string 1 tl 5'
iframe=iframe+1
endwhile
...
'print'
'printim k_vs_t.102cd.djf.png gif x800 y600'
*'set vpage off'
