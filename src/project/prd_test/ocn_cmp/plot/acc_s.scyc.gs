...
'draw string 5.5 7.3 Seasonal Cycle of Spatial Corr Skill'
...
*
'set t 1 12'
'define clm10=ave(acc10,t+0,t=264,1yr)'
'define clm15=ave(acc15,t+0,t=264,1yr)'
'define clmkt=ave(acc.3,t+0,t=264,1yr)'
'define clme=ave(ac.2,t+0,t=264,1yr)'
'modify clm10 seasonal'
'modify clm15 seasonal'
'modify clmkt seasonal'
'modify clme seasonal'
'set t 1'
*'set frame off'
'set grads off'
*'set grid off'
...
'set strsiz 0.13 0.13'
'set string 1 tl 4'
'draw string 1.6 6.9 K=10: mean=0.26'
'set string 2 tl 4'
...
'print'
'printim acc.scyc.png gif x800 y600'
*'c'
 'set vpage off'
*----------
