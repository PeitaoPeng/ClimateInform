...
'draw string 5.5 7.9 COR(%) Skill for 1991-2012'
...
'define sk3=acc(t=6)'
'define sk4=acc(t=9)'
'define sk5=acc.3(t=12)'
'define sk6=acc.3(t=3)'
'define sk7=acc.3(t=6)'
'define sk8=acc.3(t=9)'
'define sk9=acc15(t=12)'
'define sk10=acc15(t=3)'
'define sk11=acc15(t=6)'
'define sk12=acc15(t=9)'
'define sk13=ac.2(t=12)'
'define sk14=ac.2(t=3)'
'define sk15=ac.2(t=6)'
'define sk16=ac.2(t=9)'
...
'set string 1 tc 5 0'
if(iframe = 1); 'draw string 'tlx2' 'tly2' K(ss,cd)'; endif;
if(iframe = 9); 'draw string 'tlx2' 'tly2' K=15'; endif;
if(iframe = 5); 'draw string 'tlx2' 'tly2' K(ss)'; endif;
...
if(iframe = 9); 'draw string 'tlx4' 'tly4' 28'; endif;
if(iframe = 10); 'draw string 'tlx4' 'tly4' 28'; endif;
if(iframe = 11); 'draw string 'tlx4' 'tly4' 23'; endif;
if(iframe = 12); 'draw string 'tlx4' 'tly4' 20'; endif;
if(iframe = 5); 'draw string 'tlx4' 'tly4' 27'; endif;
if(iframe = 6); 'draw string 'tlx4' 'tly4' 27'; endif;
if(iframe = 7); 'draw string 'tlx4' 'tly4' 26'; endif;
if(iframe = 8); 'draw string 'tlx4' 'tly4' 21'; endif;
if(iframe = 13); 'draw string 'tlx4' 'tly4' 34'; endif;
if(iframe = 14); 'draw string 'tlx4' 'tly4' 17'; endif;
if(iframe = 15); 'draw string 'tlx4' 'tly4' 31'; endif;
if(iframe = 16); 'draw string 'tlx4' 'tly4' 32'; endif;
iframe=iframe+1
'set strsiz 0.18 0.18'
endwhile
'run /cpc/home/wd52pp/bin/cbarn2.gs 1. 0 5.5 1.2'
'print'
'printim skill_acc.4p.png gif x800 y600'
*'set vpage off'
