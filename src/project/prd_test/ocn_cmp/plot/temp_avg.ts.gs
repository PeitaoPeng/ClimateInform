...
'draw string 5.5 7.3 CONUS AVG Seasonal Mean Temp (JFM1991-DJF2012)'
...
'set string 2 tl 4'
'draw string 1.8 6.8 9-point running mean'
'print'
'printim temp_usavg.1991-2012.ts.png gif x800 y600'
*'c'
 'set vpage off'
