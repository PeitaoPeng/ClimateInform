...
'draw string 4.45 10.25 CORR(%) Diff'
...
'set t 1'
'define sk1=ac.2(t=12)-acc10(t=12)'
'define sk2=ac.2(t=3)-acc10(t=3)'
'define sk3=ac.2(t=6)-acc10(t=6)'
'define sk4=ac.2(t=9)-acc10(t=9)'
'define sk5=ac.2(t=12)-acc15(t=12)'
'define sk6=ac.2(t=3)-acc15(t=3)'
'define sk7=ac.2(t=6)-acc15(t=6)'
'define sk8=ac.2(t=9)-acc15(t=9)'
...
'set string 1 tc 5 0'
if(iframe = 1); 'draw string 'tlx2' 'tly2' EOCN-K10'; endif;
if(iframe = 5); 'draw string 'tlx2' 'tly2' EOCN-K15'; endif;
*
'set string 4 tc 6'
'set strsiz 0.15 0.15'
if(iframe = 1); 'draw string 'tlx4' 'tly4'  2'; endif;
if(iframe = 2); 'draw string 'tlx4' 'tly4'  1'; endif;
if(iframe = 3); 'draw string 'tlx4' 'tly4' 15'; endif;
if(iframe = 4); 'draw string 'tlx4' 'tly4'  7'; endif;
if(iframe = 5); 'draw string 'tlx4' 'tly4'  6'; endif;
if(iframe = 6); 'draw string 'tlx4' 'tly4' -10'; endif;
if(iframe = 7); 'draw string 'tlx4' 'tly4'  8'; endif;
if(iframe = 8); 'draw string 'tlx4' 'tly4' 12'; endif;
iframe=iframe+1
'set strsiz 0.18 0.18'
endwhile
'run /cpc/home/wd52pp/bin/cbarn2.gs 1. 0 4.55 1.2'
'print'
'printim diff.acc.2.png gif x600 y800'
*'set vpage off'
