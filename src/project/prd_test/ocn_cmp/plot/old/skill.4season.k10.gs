...
'draw string 4.45 10.25 Forecast Skill for K=10'
...
'set t 1'
'define acc12=acc10(t=12)'
'define acc3=acc10(t=3)'
'define acc6=acc10(t=6)'
'define acc9=acc10(t=9)'
'define rms12=rms10(t=12)'
'define rms3=rms10(t=3)'
'define rms6=rms10(t=6)'
'define rms9=rms10(t=9)'
...
if(iframe = 1); 'draw string 'tlx4' 'tly4' 32'; endif;
if(iframe = 2); 'draw string 'tlx4' 'tly4' 16'; endif;
if(iframe = 3); 'draw string 'tlx4' 'tly4' 16'; endif;
if(iframe = 4); 'draw string 'tlx4' 'tly4' 25'; endif;
if(iframe = 5); 'draw string 'tlx4' 'tly4' 0.91'; endif;
if(iframe = 6); 'draw string 'tlx4' 'tly4' 0.99'; endif;
if(iframe = 7); 'draw string 'tlx4' 'tly4' 0.96'; endif;
if(iframe = 8); 'draw string 'tlx4' 'tly4' 0.94'; endif;
iframe=iframe+1
'set strsiz 0.18 0.18'
endwhile
'print'
'printim skill.k10.png gif x600 y800'
*'set vpage off'
