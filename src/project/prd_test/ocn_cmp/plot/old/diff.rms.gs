...
'draw string 4.45 10.25 RMSE Diff wrt K10'
...
'set t 1'
'define sk1=rms(t=12)-rms10(t=12)'
'define sk2=rms(t=3)-rms10(t=3)'
'define sk3=rms(t=6)-rms10(t=6)'
'define sk4=rms(t=9)-rms10(t=9)'
'define sk5=rms15(t=12)-rms10(t=12)'
'define sk6=rms15(t=3)-rms10(t=3)'
'define sk7=rms15(t=6)-rms10(t=6)'
'define sk8=rms15(t=9)-rms10(t=9)'
...
if(iframe = 1); 'draw string 'tlx4' 'tly4' -0.05'; endif;
if(iframe = 2); 'draw string 'tlx4' 'tly4' -0.10'; endif;
if(iframe = 3); 'draw string 'tlx4' 'tly4' -0.09'; endif;
if(iframe = 4); 'draw string 'tlx4' 'tly4' -0.06'; endif;
if(iframe = 5); 'draw string 'tlx4' 'tly4'  0.01'; endif;
if(iframe = 6); 'draw string 'tlx4' 'tly4' -0.07'; endif;
if(iframe = 7); 'draw string 'tlx4' 'tly4' -0.05'; endif;
if(iframe = 8); 'draw string 'tlx4' 'tly4'  0.00'; endif;
iframe=iframe+1
'set strsiz 0.18 0.18'
endwhile
'run /cpc/home/wd52pp/bin/cbarn2.gs 1. 0 4.55 1.2'
'print'
'printim diff.rms.png gif x600 y800'
*'set vpage off'
