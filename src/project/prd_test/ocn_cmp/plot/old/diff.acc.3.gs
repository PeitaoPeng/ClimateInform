...
'set t 1'
'define sk1=ac.2(t=12)-acc(t=12)'
'define sk2=ac.2(t=3)-acc(t=3)'
'define sk3=ac.2(t=6)-acc(t=6)'
'define sk4=ac.2(t=9)-acc(t=9)'
...
'set string 1 tc 5 0'
if(iframe = 1); 'draw string 'tlx2' 'tly2' EOCN-K(t,s)'; endif;
if(iframe = 5); 'draw string 'tlx2' 'tly2' EOCN-K15'; endif;
*
'set string 4 tc 6'
'set strsiz 0.15 0.15'
if(iframe = 1); 'draw string 'tlx4' 'tly4' -5'; endif;
if(iframe = 2); 'draw string 'tlx4' 'tly4' -18'; endif;
if(iframe = 3); 'draw string 'tlx4' 'tly4' -3'; endif;
if(iframe = 4); 'draw string 'tlx4' 'tly4' -1'; endif;
...
'print'
'printim diff.acc.3.png gif x600 y800'
*'set vpage off'
