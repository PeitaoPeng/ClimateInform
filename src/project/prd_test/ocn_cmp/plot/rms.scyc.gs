...
'draw string 5.5 7.3 Seasonal Cycle of RMSE Skill'
...
*
'set t 1 12'
'define clm=ave(rms,t+0,t=264,1yr)'
'define clm15=ave(rms15,t+0,t=264,1yr)'
'define clm10=ave(rms10,t+0,t=264,1yr)'
'modify clm seasonal'
...
'print'
'printim rms.scyc.png gif x800 y600'
*'c'
 'set vpage off'
*----------
