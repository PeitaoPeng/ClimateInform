...
undef=-9.99e+8
#=======================================
# hss calculation for 1982-last_year
#=======================================
cat >have.hss.f<<EOF
