...
#
infile1=NMME.$var.$tmean.${icmon}_ic.1982-$yre.ld1-5.esm.anom
infile2=obs.$var.$tmean.${icmon}_ic.1981-$yre.ld1-5.anom

outfile1=HSS.NMME.$var.$tmean.${icmon}_ic.$yrs-$yre
