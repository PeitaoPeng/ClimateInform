#-----/u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/RMSE2_skill01a.gs
# RMSE  SEASONAL obs and CFSv2 hindcasts
#
rm tmp2.gs
cat << EOR > tmp2.gs
*-----------------------------------------------------------
...
'enable print RMSE2_skill01a.met'
*----------------------------------------------------------
lat1=23.0
lat2=72.0
lon1=360.0-170
...
'set gxout shaded'
'set clevs   0.1  0.5  1.0  1.5  2.0  2.5  3.0  3.5'
'set ccols 47    43   0    23   24   25   26   28   29'
'd maskout(RMSE,land.2(z=1,t=1)-0.5)'
...
'draw string 5.5 8.40 Prec Seasonal RMSE CFSv2 Forecasts (CAMS; Jan1982-Dec2015, 'Lead0' Month Lead)'
...
'set string 1 c 3 0'
'draw string 5.9 0.15 /u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/RMSE2_skill01.scr&RMSE2_skill01a.gs'
'print'
...
'printim RMSE2_skill01a.jpg jpg white'
*'printim RMSE2_skill01a.gif gif white'
'disable print'
pull dummy
'quit'
EOR
...
#gxeps -c -i RMSE2_skill01a.met -o RMSE2_skill01a.eps
rm tmp2.gs RMSE2_skill01a.met

scp RMSE2_skill01a.jpg hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp RMSE2_skill01a.gs hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp RMSE2_skill01.scr hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
