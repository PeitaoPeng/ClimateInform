#-----/u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/Heidke3_skill02b.gs
# Lead 0-8 Month of Mean of Jan-Dec
# Heidke (3 Deciles) skill of Seasonal CFSv2 hindcasts
#
rm tmp2.gs
cat << EOR > tmp2.gs
*-----------------------------------------------------------
...
'enable print Heidke3_skill02b.met'
*----------------------------------------------------------
lat1=23.0
lat2=72.0
lon1=360.0-170
...
'draw string 5.5 8.40 Seasonal Prec Heidke (3 Deciles) Score (%) of FSv2 Forecasts (Jan1982-Dec2015, Jan-Dec Mean)'
...
'set string 1 c 3 0'
'draw string 5.9 0.15 /u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/Heidke3_skill02.scr&Heidke3_skill02b.gs'
'print'
...
'printim Heidke3_skill02b.jpg jpg white'
*'printim Heidke3_skill02b.gif gif white'
'disable print'
pull dummy
'quit'
EOR
...
#gxeps -c -i Heidke3_skill02b.met -o Heidke3_skill02b.eps
rm tmp2.gs Heidke3_skill02b.met

scp Heidke3_skill02b.jpg hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp Heidke3_skill02b.gs hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
