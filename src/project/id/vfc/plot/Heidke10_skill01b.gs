#-----/u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/Heidke10_skill01b.gs
# Lead 0-8 Month of Mean of Jan-Dec
# Heidke (10 Deciles) skill of monthly CFSv2 hindcasts
#
rm tmp2.gs
cat << EOR > tmp2.gs
*-----------------------------------------------------------
...
'enable print Heidke10_skill01b.met'
*----------------------------------------------------------
lat1=23.0
lat2=72.0
lon1=360.0-170
...
'draw string 5.5 8.40 Monthly Prec Heidke (10 Deciles) Score (%) of FSv2 Forecasts (Jan1982-Dec2015, Jan-Dec Mean)'
...
'set string 1 c 3 0'
'draw string 5.9 0.15 /u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/Heidke10_skill01.scr&Heidke10_skill01b.gs'
'print'
...
'printim Heidke10_skill01b.jpg jpg white'
*'printim Heidke10_skill01b.gif gif white'
'disable print'
pull dummy
'quit'
EOR
...
#gxeps -c -i Heidke10_skill01b.met -o Heidke10_skill01b.eps
rm tmp2.gs Heidke10_skill01b.met

scp Heidke10_skill01b.jpg hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp Heidke10_skill01b.gs hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
