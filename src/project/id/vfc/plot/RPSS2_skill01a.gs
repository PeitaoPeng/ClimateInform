#-----/u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/RPSS2_skill01a.gs
# RPSS Seasonal obs and CFSv2 hindcasts
#
rm tmp2.gs
cat << EOR > tmp2.gs
*-----------------------------------------------------------
...
'enable print RPSS2_skill01a.met'
*----------------------------------------------------------
lat1=23.0
lat2=72.0
lon1=360.0-170
...
'set ccols 48  46 45 44 43  0 23 24 25 26 28'
'd maskout(RPSS,land.2(z=1,t=1)-0.5)'
*'define mask0=lterp(land.2(z=1,t=1),RPSS)-0.5'
*'d maskout(RPSS,mask0)'
...
'draw string 5.5 8.40 Seasonal Prec RPSS (%) of CFSv2 Forecasts (CAMS; Jan1982-Dec2015, 'Lead0' Month Lead)'
...
'set string 1 c 3 0'
'draw string 5.9 0.15 /u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/RPSS2_skill01.scr&RPSS2_skill01a.gs'
'print'
...
'set clevs  -10 -8 -6 -4 -2  2  4  6  8  10'
'set ccols 48  46 45 44 43  0 23 24 25 26 28'
'd maskout(ave(RPSS,z=1,z=12),land.2(z=1,t=1)-0.5)'
...
'printim RPSS2_skill01a.jpg jpg white'
*'printim RPSS2_skill01a.gif gif white'
'disable print'
pull dummy
'quit'
EOR
...
#gxeps -c -i RPSS2_skill01a.met -o RPSS2_skill01a.eps
rm tmp2.gs RPSS2_skill01a.met

scp RPSS2_skill01a.jpg hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp RPSS2_skill01a.gs hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp RPSS2_skill01.scr hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
