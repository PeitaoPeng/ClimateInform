#-----/u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/Heidke3_skill02a.gs
# Heidke3 seasonal obs and CFSv2 hindcasts
#
rm tmp2.gs
cat << EOR > tmp2.gs
*-----------------------------------------------------------
...
'enable print Heidke3_skill02a.met'
*----------------------------------------------------------
lat1=23.0
lat2=72.0
lon1=360.0-170
...
'set gxout shaded'
'set clevs  -8  -4  4   8   12 16 20 24'
'set ccols 47  43  0  23  24 25 26 28 29'
'd maskout(Heidke3,land.2(z=1,t=1)-0.5)'
...
'draw string 5.5 8.40 Seasonal Prec Heidke (3 Deciles) Score (%) of CFSv2 Forecasts (CAMS; Jan1982-Dec2015, 'Lead0' Month Lead)'
...
'set string 1 c 3 0'
'draw string 5.9 0.15 /u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/Heidke3_skill02.scr&Heidke3_skill02a.gs'
'print'
...
'printim Heidke3_skill02a.jpg jpg white'
*'printim Heidke3_skill02a.gif gif white'
'disable print'
pull dummy
'quit'
EOR
...
#gxeps -c -i Heidke3_skill02a.met -o Heidke3_skill02a.eps
rm tmp2.gs Heidke3_skill02a.met

scp Heidke3_skill02.scr hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp Heidke3_skill02a.jpg hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp Heidke3_skill02a.gs hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
