#-----/u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/Heidke3_skill01a.gs
# Heidke3  monthly obs and CFSv2 hindcasts
#
rm tmp2.gs
cat << EOR > tmp2.gs
*-----------------------------------------------------------
...
'enable print Heidke3_skill01a.met'
*----------------------------------------------------------
lat1=23.0
lat2=72.0
lon1=360.0-170
...
'draw string 5.5 8.40 Monthly Prec Heidke (3 Deciles) Score (%) of CFSv2 Forecasts (CAMS; Jan1982-Dec2015, 'Lead0' Month Lead)'
...
'set string 1 c 3 0'
'draw string 5.9 0.15 /u/Zeng-Zhen.Hu/nfs/WorkGroup/CFSV2skill/Prec/Heidke3_skill01.scr&Heidke3_skill01a.gs'
'print'
...
'printim Heidke3_skill01a.jpg jpg white'
*'printim Heidke3_skill01a.gif gif white'
'disable print'
pull dummy
'quit'
EOR
...
#gxeps -c -i Heidke3_skill01a.met -o Heidke3_skill01a.eps
rm tmp2.gs Heidke3_skill01a.met

scp Heidke3_skill01a.jpg hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp Heidke3_skill01a.gs hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
scp Heidke3_skill01.scr hzz@cpc-ls-work1:/cpc/home/hzz/WorkGroup/skillCFSv2/Prec/.
