...
cp $lcdir/us_consl.f    $TMPDIR/regr.f
...
#
 ...
 ln -s $datadir/skill_spd_t2m_jfm_1982-2006.i3e     fort.50
#
...
cat>$datadir/skill_spd_t2m_jfm_1982-2006.ctl<<EOF
dset $datadir/skill_spd_t2m_jfm_1982-2006.gr
dtype station
options sequential
stnmap $datadir/skill_spd_t2m_jfm_1982-2006.map
undef 10e10
title ac_skill
tdef 11 linear 00z01jan1998  1hr
vars   1
z 0 0 weight of cca
endvars
EOF
...
f77 -o cd_2_grads.x cd_2_grads.f
   ...
   ln -s      $datadir/skill_spd_t2m_jfm_1982-2006.i3e         fort.11
#
   ln -s      $source1/convert/data_102/lalo102       fort.12

#
   ln -s      $datadir/skill_spd_t2m_jfm_1982-2006.gr    fort.55

   cd_2_grads.x

 stnmap -i $datadir/skill_spd_t2m_jfm_1982-2006.ctl       #create map file
done
