...
C===========================================================
      PARAMETER (nesm=1,ltime=45)  ! # of 45yr long esm avg
      PARAMETER (imax=72,jmax=37,nyr=ltime*nesm,nyin=nyr-nesm)
c     PARAMETER (imax=72,jmax=37,nyr=ltime*nesm,nyin=nyr)
...
ccc read target year data and avg

c        call setzero(obs2d,imax,jmax)
c        call setzero(b9x2d,imax,jmax)
c        call setzero(echam2d,imax,jmax)
c        call setzero(ccm32d,imax,jmax)
c        call setzero(gfdl2d,imax,jmax)

c        do ir=icase,nyr,ltime

c        read(10,rec=ir) wk1
c        read(11,rec=ir) wk11
c        read(20,rec=ir) wk2
c        read(30,rec=ir) wk3
c        read(40,rec=ir) wk4
c        read(50,rec=ir) wk5
         
c        call add_mean(obs2d,wk1,imax,jmax,nesm)
c        call add_mean(b9x2d,wk2,imax,jmax,nesm)
c        call add_mean(echam2d,wk3,imax,jmax,nesm)
c        call add_mean(ccm32d,wk4,imax,jmax,nesm)
c        call add_mean(gfdl2d,wk5,imax,jmax,nesm)
...
c        end do
      ...
      do 2000 iyear=1,nyr
        ...
        ELSE                      ! there is cross validation
          ic1=icase
          ic2=45+icase
          ic3=2*45+icase
          ic4=3*45+icase
          ...
          ic18=icase-8*45
          ic19=icase-9*45
          if(iyear.ne.ic1.and.iyear.ne.ic2.and.iyear.ne.ic3
     &.and.iyear.ne.ic4.and.iyear.ne.ic5.and.iyear.ne.ic6
     &.and.iyear.ne.ic7.and.iyear.ne.ic8.and.iyear.ne.ic9
     &.and.iyear.ne.ic10.and.iyear.ne.ic11.and.iyear.ne.ic12
     &.and.iyear.ne.ic13.and.iyear.ne.ic14.and.iyear.ne.ic15
     &.and.iyear.ne.ic16.and.iyear.ne.ic17.and.iyear.ne.ic18
     &.and.iyear.ne.ic19) then
          iy=iy+1
          do i=1,imax
          do j=1,jmax
...
999   format(2x,I2,2x,6(f7.2,2x))
      ...
      SUBROUTINE add_mean(fld,wk,n,m,nt)
      DIMENSION fld(n,m),wk(n,m)
      do i=1,n
      do j=1,m
         fld(i,j)=fld(i,j)+wk(i,j)/float(nt)
      enddo
      enddo
      return
      end
