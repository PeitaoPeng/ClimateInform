...
'open /cpc/home/wd52pp/data/ca_proj/corr.z200rpc_vs_sst.djf.yb1979.ctl'

*---------------------------string/caption
 'set string 1 tc 4'
 'set strsiz 0.15 0.15'
 'draw string 5.5 8.5 Regr of SST to RPC of Z200 (AMIP100_esm,1979-2022)'
...
'run /cpc/home/wd52pp/bin/dline.gs 180 -90 180 90'
 ...
 'set strsiz 0.12 0.12'
*----------
if(iframe = 1); 'draw string 'titlx' 'titly' RPC1 11.7%'; endif
if(iframe = 2); 'draw string 'titlx' 'titly' RPC2 5.0%'; endif
if(iframe = 3); 'draw string 'titlx' 'titly' RPC3 3.8%'; endif
...
'printim corr.amip100esm_z200rpc_2_sst.djf.png gif x1600 y1200'
