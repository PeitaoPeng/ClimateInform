...
'open /cpc/home/wd52pp/data/ca_proj/rsd_reof.precip.djf.'eof_range'.'mtx'.wtd.ctl'
'open /cpc/home/wd52pp/data/ca_proj/trd.rsd_rpc.precip.djf.'eof_range'.'mtx'.wtd.ctl'
*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.12 0.12'
* 'draw string 4.25 10.65 REOF/RPC of DJF rsd_AMIP_precip'
 'set strsiz 0.12 0.12'
...
'set strsiz 0.12 0.12'
if(iframe = 5);'draw string 'xstr' 'ystr' RPC1'; endif
if(iframe = 6);'draw string 'xstr' 'ystr' RPC2'; endif
if(iframe = 7);'draw string 'xstr' 'ystr' RPC3'; endif
if(iframe = 8);'draw string 'xstr' 'ystr' RPC4'; endif
...
endwhile
*
'printim rsd_reof_rpc.precip.djf.'eof_range'.'mtx'.wtd.4m.png gif x1200 y1600'
