...
'open /cpc/home/wd52pp/data/ca_proj/corr.sstrpc_vs_cmap.djf.tp.ctl'
'open /cpc/home/wd52pp/data/ca_proj/corr.sstrpc_vs_obs_z200.djf.tp.ctl'
*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.11 0.11'
 'draw string 4.25 11. Regr of SST_RPC to OBS Prec&Z200'
...
'set strsiz 0.12 0.12'
if(iframe = 1);'draw string 'xstr' 'ystr' RPC1'; endif
if(iframe = 2);'draw string 'xstr' 'ystr' RPC2'; endif
if(iframe = 3);'draw string 'xstr' 'ystr' RPC3'; endif
if(iframe = 4);'draw string 'xstr' 'ystr' RPC4'; endif
if(iframe = 5);'draw string 'xstr' 'ystr' RPC5'; endif
if(iframe = 6);'draw string 'xstr' 'ystr' RPC6'; endif
if(iframe = 7);'draw string 'xstr' 'ystr' RPC7'; endif
...
endwhile
*
'printim corr.sstrpc_vs_OBS_prec_z200.djf.tp.7m.png gif x1200 y1600'
