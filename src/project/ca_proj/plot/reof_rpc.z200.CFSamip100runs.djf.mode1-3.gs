...
'd maskout(-cf.2, cf.2)'
 ...
 'set strsiz 0.12 0.12'
*----------
if(iframe = 4); 'draw string 'titlx' 'titly' RPC1 58.2%'; endif
if(iframe = 5); 'draw string 'titlx' 'titly' RPC2 16.2%'; endif
if(iframe = 6); 'draw string 'titlx' 'titly' RPC3  8.9%'; endif
...
'printim reof_rpc.z200.CFSamip100runs.djf.m1-3.png gif x1600 y1200'
