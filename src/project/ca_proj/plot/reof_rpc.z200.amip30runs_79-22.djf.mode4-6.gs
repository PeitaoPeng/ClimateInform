...
'd maskout(cf.2,-cf.2)'
 ...
 'set strsiz 0.12 0.12'
*----------
if(iframe = 4); 'draw string 'titlx' 'titly' RPC4 2.6%'; endif
if(iframe = 5); 'draw string 'titlx' 'titly' RPC5 2.6%'; endif
if(iframe = 6); 'draw string 'titlx' 'titly' RPC6 2.3%'; endif
*
*
...
'printim reof_rpc.z200.amip30runs_79-22.djf.m4-6.png gif x1600 y1200'
