...
'open /cpc/home/wd52pp/data/ca_proj/rsd_reof.cmap.djf.tp.var.wtd.ctl'
'open /cpc/home/wd52pp/data/ca_proj/rsd_rpc.cmap.djf.tp.var.wtd.ctl'
*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.11 0.11'
 'draw string 4.25 11. RSD_REOF/RPC of DJF CMAP (0E-360E,15.5S-15.5N)'
...
'set string 1 tc 6 0'
if(iframe = 1);'draw string 'xstr2' 'ystr2' 34.4%'; endif
if(iframe = 2);'draw string 'xstr2' 'ystr2' 11.5%'; endif
if(iframe = 3);'draw string 'xstr2' 'ystr2'  5.4%'; endif
if(iframe = 4);'draw string 'xstr2' 'ystr2'  4.6%'; endif
if(iframe = 5);'draw string 'xstr2' 'ystr2'  4.5%'; endif
if(iframe = 6);'draw string 'xstr2' 'ystr2'  3.5%'; endif
if(iframe = 7);'draw string 'xstr2' 'ystr2'  3.5%'; endif
endif
if(iframe > 7);
'set ylab on'
*'set xlab off'
...
endwhile
*
'printim rsd_reof_rpc.cmap.djf.'eof_range'.7m.png gif x1200 y1600'
