...
C===========================================================)
      ...
      integer nfa(10),nfb(10)
      real wrga(10),wrgb(10)                  !for each bin
      real xx(10)
c
      real xlat(jmx)
      real coslat(jmx)
...
cc write out for ROC curves
      write(61,*)'CFSv2 Seasonal Temp Forecast: Upper Tercile'
c     write(61,*)'CFSv2 Seasonal Prec Forecast: Upper Tercile'
...
c     enddo
      ...
      write(61,666)areaoa
c
      write(62,*)'CFSv2 Seasonal Temp Forecast: Lower Tercile'
c     write(62,*)'CFSv2 Seasonal Prec Forecast: Lower Tercile'
...
c
      ...
      write(6,*) 'xx=',xx
c call regression
      call wregr(nfa,hoa,xx,10,10,nnfb,xma,yma,wrga)
      call wregr(nfb,hob,xx,10,10,nnfa,xmb,ymb,wrgb)
      write(65,rec=7) wrga
      write(6,*) 'rga=',wrga
