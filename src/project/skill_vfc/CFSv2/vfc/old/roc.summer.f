...
c read obs data
c
      do it=1,nss ! JFM 1995 to DJF of 2009
        read(14,rec=it) wk1
        do i=1,imx
        do j=1,jmx
          kvfc(i,j,it)=wk1(i,j)
...
c       fpb(ib)=(ib-1)*0.1
      ...
      do it=4,nss,12  !AMJ for it=1 corresponds to JFM
      ...
      do it=5,nss,12  !MJJ for it=1 corresponds to JFM
      ...
      do it=6,nss,12  !JJA for it=1 corresponds to JFM
      ...
      do it=7,nss,12  !JAS for it=1 corresponds to JFM
...
cc write out for ROC curves
      write(61,*)'Summer Season FCST: Upper Tercile'
...
c     call roca(ob,nob,11,areaob)
c     write(61,666)areaoa,areaob
      write(61,666)areaoa
c
      write(62,*)'Summer Season FCST: Lower Tercile'
...
c     enddo
c     call roca(oa,noa,11,areaoa)
      call roca(ob,nob,11,areaob)
c     write(62,666)areaoa,areaob
      write(62,666)areaob
c
      write(65,rec=1) hoa
      write(6,*) 'hoa=',hoa
