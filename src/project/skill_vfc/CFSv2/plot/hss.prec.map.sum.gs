...
*
'open /export-12/cacsrv1/wd52pp/CFSv2_vfc/skill/hss_prec_t.95-cur.cfsv2.ctl'
...
'draw string 5.5 7.35 HSS of CFSv2 Prec Fcst for Summer Seasons'
...
endwhile
'print'
'printim hss_prec.map.cfsv2.sum.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
