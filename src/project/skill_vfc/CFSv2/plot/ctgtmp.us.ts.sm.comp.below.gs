...
'set gxout line'
'set t 7 174'
'define obs=ave(100*obsb/232,t-6,t+6)'
'define cv1=ave(100*v1b/232,t-6,t+6)'
'define cv2=ave(100*v2b/232,t-6,t+6)'
'define op=ave(100*opb/232,t-6,t+6)'
'set t 1 180'
'set cmark 0'
'set cstyle 1'
'set cthick 6'
...
'print'
'printim ctgtmp_us.below.ts.sm.comp.png gif x800 y600'
*'c'
 'set vpage off'
