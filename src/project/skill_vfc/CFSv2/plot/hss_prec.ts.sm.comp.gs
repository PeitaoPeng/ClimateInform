...
'open /export-12/cacsrv1/wd52pp/CFSv2_vfc/skill/hss_prec.95-cur.cfsv2.ctl'
...
'draw string 5.5 7.3 HSS of Seasonal Prec Forecast (13mon mean)'
...
'print'
'printim hss_prec.ts.sm.comp.png gif x800 y600'
*'c'
 'set vpage off'
