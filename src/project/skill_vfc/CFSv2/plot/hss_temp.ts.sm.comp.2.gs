...
'open /export-12/cacsrv1/wd52pp/CFSv2_vfc/skill/hss_temp.95-cur.cfsv2.ctl'
...
'define ocn=ave(hss.4,t-6,t+6)'
'define nino=ave(hss.5,t-6,t+6)'
'define cmp=ave(hss.6,t-6,t+6)'
'define eocn=ave(hss.7,t-6,t+6)'
'set t 1 180'
'set cmark 0'
'set cstyle 1'
'set cthick 6'
...
'print'
'printim hss_temp.ts.sm.compare.2.png gif x800 y600'
*'c'
 'set vpage off'
