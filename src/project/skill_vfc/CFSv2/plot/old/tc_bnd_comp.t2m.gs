...
'draw string 5.5 8.25 Tercile Boundaries of JFM T2m: New vs Old'
...
'set gxout grfill'
'set mpdset mres'
'set clevs   0.2 0.4 0.6 0.8 1. 1.2 1.4 1.6 1.8 2.0'
'set ccols   31 0 21 22 23 24 25 26 27 28 29'
'd a'
endif
if(iframe = 2)
*'set gxout contour'
...
'set gxout grfill'
'set mpdset mres'
'set clevs   -2 -1.8 -1.6 -1.4 -1.2 -1 -0.8 -0.6 -0.4 -0.2'
'set ccols   49 48 47 46 45 44 43 42 41 0 51'
'd b'
endif
if(iframe = 3)
*'set gxout contour'
...
'set mpdset mres'
'set clevs   0.2 0.4 0.6 0.8 1. 1.2 1.4 1.6 1.8 2.0'
'set ccols   0 31 21 22 23 24 25 26 27 28 29'
'd a.2(t=2)'
endif
if(iframe = 4)
'set gxout contour'
...
endwhile
'print'
'printim tc_bnd_comp.t2m.png.png gif x800 y600'
*----------
