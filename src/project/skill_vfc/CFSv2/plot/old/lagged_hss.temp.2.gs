...
*
*'open /export-12/cacsrv1/wd52pp/CFS_vfc/skill/lagged_hss.temp.95-cur.cfs.ctl'
...
'draw string 4.25 10.5 Lagged HSS of Seasonal T2m'
...
if(iframe = 1); 'draw string 'titlx' 'titly' HSS of FCST (verified against lagged OBS)'; endif
if(iframe = 2); 'draw string 'titlx' 'titly' AUTO HSS (verified against lagged itself)'; endif
*'set frame off'
'set grads off'
*'set grid off'
*'set xlab off'
...
*if(iframe = 1);'set vrange -20 20'; endif
...
*----------
'set line 1 1 8'
if(iframe = 2);'draw line 'lx1' 'ly1' 'lx2' 'ly1''; endif
if(iframe = 2);'draw string 'lxx' 'lyy1' FCST'; endif
'set line 2 1 8'
*'draw line 'lx1' 'ly2' 'lx2' 'ly2''
if(iframe = 2);'draw string 'lxx' 'lyy2' OBS'; endif
if(iframe = 2); then
'set line 3 1 8'
'draw line 'lx1' 'ly2' 'lx2' 'ly2''
...
*'c'
'print'
'printim lagged_hss.temp.2.png gif x600 y800'
*'c'
 'set vpage off'
*----------
