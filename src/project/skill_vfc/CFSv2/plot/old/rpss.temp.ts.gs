...
*
'open /export-12/cacsrv1/wd52pp/CFS_vfc/skill/rpss_temp.95-cur.cfs.ctl'
...
'draw string 5.5 7.3 RPSS of CFS Seasonal Temp Forecast'
'draw string 7.5 6.5 mean=-0.04'
...
endwhile
'print'
'printim rpss_temp.ts.cfs.png gif x800 y600'
*'c'
 'set vpage off'
*----------
