...
#
 ln -s $datadir1/$model.$var.ss.${ss_bgn}1982-djf$yend.ld$nlead.esm_anom.gr fort.11
 ln -s $datadir2/obs.$var.ss.${ss_bgn}1982-djf$yend.anom.gr                       fort.12
