...
'draw string 5.5 7.6 Global Lag-1 Spatial Corr of 'model' & OBS'
...
'set strsiz 0.15 0.15'
'set string 1 tl 4'
'draw string 1.65 2.9 'model': mean=0.94'
'set string 2 tl 4'
'draw string 1.65 2.6 OBS:   mean=0.79'
'print'
'printim 'model'.lag1_cor.o_p.ts.glb.png gif x800 y600'
*'c'
 'set vpage off'
*----------
