...
'draw string 5.5 7.6 Extratropical Lag-1 Spatial Corr of 'model' & OBS'
...
'set strsiz 0.15 0.15'
'set string 1 tl 4'
'draw string 1.65 2.9 'model': mean=0.92'
'set string 2 tl 4'
'draw string 1.65 2.6 OBS:   mean=0.76'
'print'
'printim 'model'.lag1_cor.o_p.ts.etp.png gif x800 y600'
*'c'
 'set vpage off'
*----------
