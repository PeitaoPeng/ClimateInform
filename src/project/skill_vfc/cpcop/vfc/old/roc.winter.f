...
c       fpb(ib)=(ib-1)*0.1
      ...
      do it=10,nss,12  !OND for it=1 corresponds to JFM
      ...
      do it=11,nss,12  !NDJ for it=1 corresponds to JFM
      ...
      do it=12,nss,12  !DJF for it=1 corresponds to JFM
      ...
      do it=1,nss,12  !JFM for it=1 corresponds to JFM
...
cc write out for ROC curves
      write(61,*)'Winter Season T2m FCST: Upper Tercile'
...
c     write(61,666)areaoa,areaob
      write(61,666)areaoa
c
      write(62,*)'Winter Season T2m FCST: Lower Tercile'
