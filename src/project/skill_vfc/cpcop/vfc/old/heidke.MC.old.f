...
c
      ...
      dimension wk1d1(nss-1),wk1d2(nss-1)
      dimension wk1d3(nss-1),wk1d4(nss-1)
      dimension wk1d5(nss-1),wk1d6(nss-1)
c
...
c for fma to djf
      ...
      do it=is-1,nss,12
        ...
        hdk2cyc(is)=hdk2cyc(is)+hdk2(it)/nyr
...
c for jfm
      ...
      do it=12,nss,12  !for jfm
        ...
        hdk2cyc(1)=hdk2cyc(1)+hdk2(it)/nyr
...
c for all seasons
      ...
      IF(mask(i,j).eq.1) then
        ...
        call hss_t_MC(mw1d1,mw1d2,nss-1,nss-1,nsp,hsmc1,hsmc2)
...
c for summer(AMJ,MJJ,JJA,JAS)
      ...
      IF(mask(i,j).eq.1) then
        ...
        call heidke2_t(mw1d1,mw1d2,hs2,tot2,nss-1,48)
        call hss_t_MC(mw1d1,mw1d2,nss-1,48,nsp,hsmc1,hsmc2)
        call hss_stat(hs1,hs2,hsmc1,hsmc2,nsp,
     &hsm1,hsm2,sdv1,sdv2,ct1,ct2)
          hdk1_t(i,j)=hs1
          hdk2_t(i,j)=hs2
