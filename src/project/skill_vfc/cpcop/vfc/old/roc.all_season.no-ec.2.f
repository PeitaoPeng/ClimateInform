...
C===========================================================)
      ...
      dimension np(10)
      real hhob(10),hhoa(10),ffob(10),ffoa(10)  !for each bin
      real hhon(10),ffon(10)                  !for each bin
c
      data np/90,80,70,60,50,40,33,20,10,0/
c
...
c     open(65,form='unformatted',access='direct',recl=4*7)
c
ccc have coslat
      dl=2.
      do j=1,jmx
