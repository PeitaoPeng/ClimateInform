...
c     write(61,*)'CPC Seasonal Temp Forecast: Upper Tercile'
...
c     enddo
      call roca(oa,noa,21,areaoa)
      write(61,666)areaoa
c
c     write(62,*)'CPC Seasonal Temp Forecast: Lower Tercile'
      write(62,*)'CPC Seasonal Prec Forecast: Lower Tercile'
