      subroutine hss_all_MC(mask,prd,vfc,coslat,
     &imx,jmx,nss,nsp,hss1,hss2)
CC============================================================
...
CC============================================================
      parameter(nar=750000)
      dimension ran(nar)
      integer   mask(imx,jmx),vfc(imx,jmx,nss),prd(imx,jmx,nss)
...
C have 1-d data set for prd and vfc
      nda=0.
      do k=2,nss  !first season is missing
      do i=1,imx
      do j=1,jmx
