...
cc and calculate lagged HEIDKE skill time series
      do jt=0,maxlag
       ...
       do it=1,lt 
        ...
        call heidke12(mask,mwk1,mwk4,coslat,hs7,ntot1,imx,jmx)
        call heidke2(mask,mwk1,mwk4,coslat,hs8,ntot2,imx,jmx)
        write(6,*) 'ntot1=',ntot1,'  ntot2=',ntot2
        write(6,*) 'hs7=',hs7,'  hs8=',hs8
...
c
 ...
 777  format(A7,1x,21f7.2)
      ...
      enddo
      write(6,777) 'avghs7=',avghs7
      write(6,777) 'avghs8=',avghs8
c
      stop
      end
...
c     write(6,*) 'h=',h,'tot=',tot,'hs=',hs
      ...
      subroutine heidke12(mask,mw1,mw2,coslat,hs,ntot,m,n) 
cc hss with EC as a kind of real forecast
      dimension mask(m,n),mw1(m,n),mw2(m,n),coslat(n)
