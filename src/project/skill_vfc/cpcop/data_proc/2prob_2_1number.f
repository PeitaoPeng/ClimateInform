...
C  EOF applied to probabilistic fld
C==========================================================
...
c== have a&b prob data and convert them to one field
      do it=1,ltime
        read(10,rec=it) wk1
        read(11,rec=it) wk2
        ...
        if(wk1(i,j).gt.0) then
        a=wk1(i,j)
        b=wk2(i,j)
        if(a.gt.b) wk3(i,j)=a/100.
        if(b.gt.a) wk3(i,j)=-b/100.
        else
        wk3(i,j)=-9.99e8
        endif
