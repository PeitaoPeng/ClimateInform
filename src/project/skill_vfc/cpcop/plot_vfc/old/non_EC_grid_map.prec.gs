...
'draw string 5.5 7.35 non-EC season number of CPC seasonal Prec fcst (%)'
*'draw string 5.5 7.35 % time forecast was made'
...
endwhile
'print'
'printim non_EC_grid_map.prec.cpc.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
