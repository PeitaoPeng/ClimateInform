...
*
'open /export-12/cacsrv1/wd52pp/cpc_vfc/skill/eco_valu_summer.above.prob.t2m.95-07.ctl'
...
*
'set string 1 tl 6'
'draw string 1.8 6.4 Pt=50%'
'set string 2 tl 6'
'draw string 1.8 6.1 Pt=40%'
'set string 3 tl 6'
'draw string 1.8 5.8 Pt=30%'
*
'set clopts -1 3 0.05'
'set string 1 tc 4'
...
endwhile
'print'
'printim ec_valu_prob.t2m.summer.a.png gif x800 y600'
*'c'
 'set vpage off'
*----------
