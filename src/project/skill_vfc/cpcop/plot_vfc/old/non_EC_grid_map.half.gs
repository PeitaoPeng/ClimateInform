...
*
'open /export-12/cacsrv1/wd52pp/cpc_vfc/skill/heidke_t2m_t.half.cons.ctl'
...
*'draw string 5.5 7.35 non-EC season # of seasonal T2m fcst (%), 95-00'
'draw string 5.5 7.35 non-EC season # of seasonal T2m fcst (%), 01-07'
...
endwhile
'print'
*'printim non_EC_grid_map.t2m.95-00.png gif x800 y600'
'printim non_EC_grid_map.t2m.01-07.png gif x800 y600'
*'c'
* 'set vpage off'
*----------
