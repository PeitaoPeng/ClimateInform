...
'draw string 4.25 10.55 "Below Normal" Prob Fcst with Max Value > 70%'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' FMA 1998'; endif
...
endwhile
'print'
'printim prob_fcst.2.png gif x600 y800'
*'c'
* 'set vpage off'
*----------
