...
*
'open /export-12/cacsrv1/wd52pp/cpc_vfc/skill/heidke_t2m_t.half.ctl'
...
*'draw string 4.25 10.25 Heidke Skill of CPC Seasonal T2m Fcst, 95-00'
'draw string 4.25 10.25 Heidke Skill of CPC Seasonal T2m Fcst, 01-07'
*---------------------------set dimsnesion, page size and style
nframe=2
nframe2=2
xmin0=1.;  xlen=6.5;  xgap=0.75
ymax0=9.5; ylen=-3.5;  ygap=-0.85
*
iframe=1
while ( iframe <= nframe )
...
endwhile
'print'
*'printim hdks_t2m.map.cpc.95-00.png gif x600 y800'
'printim hdks_t2m.map.cpc.01-07.png gif x600 y800'
*'c'
* 'set vpage off'
*----------
