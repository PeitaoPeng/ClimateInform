...
*
'open /export-12/cacsrv1/wd52pp/cpc_vfc/skill/eco_valu_winter.t2m.95-07.ctl'
...
'draw string 5.5 7.75 Economic Value of CPC Winter Season T2m Forecast'
...
endwhile
'print'
'printim ec_valu_dtm.t2m.winter_a.png gif x800 y600'
*'c'
 'set vpage off'
*----------
'reinit'
...
endwhile
'print'
'printim ec_valu_dtm.t2m.winter_b.png gif x800 y600'
*'c'
 'set vpage off'
*----------
