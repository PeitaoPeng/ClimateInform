...
'draw string 4.25 10.5 Statistics of HSS1 in Monte Calo Test'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' Mean'; endif
 if(iframe = 2); 'draw string 'titlx' 'titly' Standard Deviation'; endif
*
  iframe=iframe+1
endwhile
'print'
'printim hssm_stdv.t2m.map.MC.png gif x600 y800'
*'c'
* 'set vpage off'
*----------
