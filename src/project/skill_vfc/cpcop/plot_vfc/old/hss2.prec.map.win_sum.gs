...
'draw string 4.25 10.25 non-EC HSS of CPC Seasonal Prec Fcst'
...
*----------
 if(iframe = 1); 'draw string 'titlx' 'titly' Winter'; endif
...
endwhile
'print'
'printim hss2_prec.map.cpc.win_sum.png gif x600 y800'
*'c'
* 'set vpage off'
*----------
