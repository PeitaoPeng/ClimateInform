...
*
 ...
 'draw string 5.5 7.4 Non-EC Grid Number (%) of CPC Prec FCST'
 'draw string 8. 6.5 mean=30.8%'
*'draw string 5.5 7.4 Non-EC Grid Number (%) of CPC Prec FCST, ave=29.9%'
...
endwhile
'print'
'printim non_EC_grid.prec.ts.cpc.png gif x800 y600'
*'c'
 'set vpage off'
*----------
