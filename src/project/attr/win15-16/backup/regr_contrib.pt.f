...
c== trd and PCs for 2016
      ...
      t11=tcof(11,67)
       ...
       if(abs(p1(i,j)).lt.1000) then
          ...
          fld8(i,j)=t8*p8(i,j)
          fld9(i,j)=t9*p9(i,j)
          fld10(i,j)=t10*p10(i,j)
          fld11(i,j)=t11*p10(i,j)
        else
          fld1(i,j)=undef
          fld2(i,j)=undef
          fld3(i,j)=undef
      ...
      iw=iw+1
      write(51,rec=iw) fld9
      iw=iw+1
      write(51,rec=iw) fld10
      iw=iw+1
      write(51,rec=iw) fld11
c
c== trd and PCs for 1982
      ...
      iw=iw+1
      write(52,rec=iw) fld9
      iw=iw+1
      write(52,rec=iw) fld10
      iw=iw+1
      write(52,rec=iw) fld11
c
c== trd and PCs for 1998
      ...
      iw=iw+1
      write(53,rec=iw) fld9
      iw=iw+1
      write(53,rec=iw) fld10
      iw=iw+1
      write(53,rec=iw) fld11
c
      stop
      end
