...
C===========================================================
      PARAMETER (ng1=2034)
c     PARAMETER (ng2=(late2-lats2+1)*(lone2-lons2+1))
      PARAMETER (ng2=2376)
c
...
C
      open(11,form='unformatted',access='direct',recl=4*imx1*jmx1) !3_d sst
      open(12,form='unformatted',access='direct',recl=4*imx2*jmx2) !3_d z200
C
      open(21,form='unformatted',access='direct',recl=4) ! nino34
c
      open(31,form='unformatted',access='direct',recl=4*imx1*jmx1)
      open(32,form='unformatted',access='direct',recl=4*imx1*jmx1)
c
      open(41,form='unformatted',access='direct',recl=4*imx2*jmx2)
      open(42,form='unformatted',access='direct',recl=4*imx2*jmx2)
c
...
c for var1
      ...
      iw=iw+1
      write(31,rec=iw) corr1
      write(32,rec=iw) corr12
      iw=iw+1
      write(31,rec=iw) regr1
      write(32,rec=iw) regr12
c
c for var2
      do j=1,jmx2
      do i=1,imx2
      ...
      iw2=iw2+1
      write(41,rec=iw2) corr2
      write(42,rec=iw2) corr22
      iw2=iw2+1
      write(41,rec=iw2) regr2
      write(42,rec=iw2) regr22
