...
'open /cpc/home/wd52pp/data/attr/win15-16/z200_82.djf.contrib.ctl'

*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.75 Reconstruction of Z200 for 1982/83 DJF'
 'set strsiz 0.12 0.12'
...
endwhile
*
'printim z200.contrib.83.png gif x600 y800'
