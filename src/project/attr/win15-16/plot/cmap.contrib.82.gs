...
'open /cpc/home/wd52pp/data/attr/win15-16/cmap_82.djf.contrib.ctl'

*---------------------------string/caption
 'set string 1 tc 5 0'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.75 Reconstruction of Prate for 1982/83 DJF'
 'set strsiz 0.12 0.12'
...
if(iframe = 9);'draw string 'xstr' 'ystr' i)Nino34+Trend+PC1+PC4'; endif
...
endwhile
*
'printim cmap.contrib.83.png gif x600 y800'
