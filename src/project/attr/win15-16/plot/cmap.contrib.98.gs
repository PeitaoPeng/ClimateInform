...
'open /cpc/home/wd52pp/data/attr/win15-16/cmap_98.djf.contrib.ctl'

*---------------------------string/caption
 'set string 1 tc 5 0'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.75 Reconstruction of Prate for 1997/98 DJF'
 'set strsiz 0.12 0.12'
...
endwhile
*
'printim cmap.contrib.98.png gif x600 y800'
