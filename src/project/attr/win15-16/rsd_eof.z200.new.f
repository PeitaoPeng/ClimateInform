...
c
      open(31,form='unformatted',access='direct',recl=4*imx*jmx) !rsd fld (no NESO)
c
...
c
      do it=1,ltime
        do i=1,imx
        do j=1,jmx
          w3d2(i,j,it)=w3d(i,j,it)-ts1(it)*regr(i,j)
        enddo
        enddo
      enddo
c
