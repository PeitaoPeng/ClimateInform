...
C===========================================================
      ...
      real corr(imx,jmx),xidx(ncor),xidx2(ncor)
      real pc(ltime,nmod)
      real wk1(ncor),wk2(ltime),rcf(ltime)
      real mask(imx,jmx)
c
...
c
      ...
      if(fld1(i,j).lt.-100) then
        ...
        call anom(wk1,ncor)
        call normal(xidx,xidx2,sd,ncor)
        call regr_t(xidx2,wk1,ncor,corr(i,j),regr(i,j))
