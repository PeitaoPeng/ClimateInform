...
if(iframe = 2); 'draw string 'tlx' 'tly' (b) CMP for COR>0.6; 6 samples'; endif
if(iframe = 3); 'draw string 'tlx' 'tly' (c) -CMP for COR<-0.6, 8 sample'; endif
...
'print'
'printim sst_z200.comp.obs.na.png gif x600 y800'
