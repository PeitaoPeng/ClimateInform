...
'open /cpc/home/wd52pp/data/attr/winter13-14/bmout.mar14.ttfrc.ctl'
...
'define st3=sfo.3'
'define st4=sfo.4'
'define p1=p.5(time=dec2013)'
'define p2=p.5(time=jan2014)'
'define p3=p.5(time=feb2014)'
'define p4=p.5(time=mar2014)'
*'define u1=xflxo'
*'define u2=xflxo.2'
*'define u3=xflxo.3'
*'define u4=xflxo.4'
