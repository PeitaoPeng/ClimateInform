...
'draw string 5.5 7.5 TOGA Prate (mm/day) and 200mb PSI(10`a6`nm`a2`n/s) Anom, DJFM2013/14'
*---------------------------set dimsnesion, page size and style
'define prate=86400*ave(z.2,t=2,t=5)'
'define psi=ave(psi,t=2,t=5)'
nframe=1
nframe2=1
nframe3=1
...
'print'
'printim prate_psi.djfm.toga.png gif x800 y600'
