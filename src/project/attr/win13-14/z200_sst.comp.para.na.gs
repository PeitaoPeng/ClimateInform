...
'draw string 4.25 10.5 AMIP DJFM Z200 and SST Composite'
'draw string 4.25 10.3 (based on NA Z200 COR to DJFM2013/14 data)'
...
if(iframe = 2); 'draw string 'tlx' 'tly' (b) CMP for COR>0.6; 16 samples'; endif
if(iframe = 3); 'draw string 'tlx' 'tly' (c) -CMP for COR<-0.6, 14 samples'; endif
...
'print'
'printim sst_z200.comp.para.na.png gif x600 y800'
