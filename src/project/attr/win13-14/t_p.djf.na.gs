...
*
'open stdprate.oct13-feb14.ctl'
'open mask_land_sea_edge.lnx.ctl'
'open stdt2m.oct13-feb14.ctl'
*
'set string 1 tc 5'
'set strsiz 0.15 0.15'
'draw string 4.25 10.2 Standardized Prate & T2m Anom, DJF 2013/14'
...
*
'define pt1=maskout((p(t=3)+p(t=4)+p(t=5))/3.,mask.2(t=1)-1)'
'define pt2=(t2m.3(t=3)+t2m.3(t=4)+t2m.3(t=5))/3.'
iframe=1
while ( iframe <= nframe )
...
'print'
'printim t_p.djf.na.png gif x600 y800'
