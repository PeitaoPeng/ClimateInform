...
'draw string 5.5 7.5 TOGA SST and 200mb PSI(10`a6`nm`a2`n/s) Anom'
...
*'set map 15 1 2'
'set gxout shaded'
'set clevs    -1 -0.5 -0.25 0.25 0.5 1 1.5 2 2.5 3 7 11 15'
'set ccols   43 42 41 0 21 22 23 25 27 29 62 64 66 68'
'd sst'
'set gxout contour'
'set ccolor 1'
*'set cint 3'
'd strm-ave(strm,lon=0,lon=360)'
...
'print'
'printim sst_psi.djfm13-14.toga.png gif x800 y600'
