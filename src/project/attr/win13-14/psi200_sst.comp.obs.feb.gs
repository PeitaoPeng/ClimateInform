...
'draw string 4.25 10.3 (based on NPNA COR to Feb2014 data)'
...
if(iframe = 1); 'draw string 'tlx' 'tly' (a) Feb2014'; endif
...
'print'
'printim sst_psi200.comp.obs.feb.png gif x600 y800'
