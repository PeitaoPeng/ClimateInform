...
if(iframe = 1); 'draw string 'tlx' 'tly' (a) Dec75'; endif
if(iframe = 2); 'draw string 'tlx' 'tly' (b) Jan76'; endif
if(iframe = 3); 'draw string 'tlx' 'tly' (c) Feb76'; endif
if(iframe = 4); 'draw string 'tlx' 'tly' (d) Mar76'; endif
'set string 1 tl 5 0'
...
'print'
'printim sst_z200.djfm75.png gif x600 y800'
