...
'draw string 4.25 10.3 (based on NPNA COR to Dec2013 data)'
...
if(iframe = 2); 'draw string 'tlx' 'tly' (b) CMP for COR>0.55; 4 samples'; endif
...
'print'
'printim sst_psi200.comp.obs.dec.png gif x600 y800'
