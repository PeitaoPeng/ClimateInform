...
'draw string 4.25 10.4 Prate(mm/day) & 200mb VPOT(10`a6`nm`a2`n/s) Anom'
...
*
'define p1=p(t=2)-aave(p(t=2),x=1,x=144,y=1,y=73)'
'define p2=p(t=3)-aave(p(t=3),x=1,x=144,y=1,y=73)'
'define p3=p(t=4)-aave(p(t=4),x=1,x=144,y=1,y=73)'
'define p4=p(t=5)-aave(p(t=5),x=1,x=144,y=1,y=73)'
'define st1=vpot.2(t=2)'
'define st2=vpot.2(t=3)'
'define st3=vpot.2(t=4)'
'define st4=vpot.2(t=5)'
'set t 1'
'set lon 0 360'
'set lat  -40 90'
'set yaxis -40 90 30'
...
'print'
'printim p_vpot.oct13-feb14.png gif x600 y800'
