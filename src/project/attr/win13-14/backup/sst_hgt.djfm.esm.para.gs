...
'open /cpc/home/wd52pp/data/para/z200.ndjfm2013-14.mon.para.esm.ctl'
*
'set string 1 tc 5'
'set strsiz 0.15 0.15'
'draw string 5.5 7.5 AMIP 200mb HGT(m) and SST(K), DJFM2013/14'
...
'print'
'printim sst_z200.djfm14.para.png gif x800 y600'
