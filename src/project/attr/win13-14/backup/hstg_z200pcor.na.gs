...
'draw string 4.25 10.2 Histogram of OBS Z200 Pat Cor over NA for NDJFM'
...
if(iframe = 1); 'draw string 'tlx' 'tly'  0-mon Lag, 260 CORs'; endif
if(iframe = 1); 'draw string 'tlx' 'tly2' Mean=0.23 STD=0.35'; endif
if(iframe = 2); 'draw string 'tlx' 'tly'  1-mon Lag, 195 CORs'; endif
if(iframe = 2); 'draw string 'tlx' 'tly2' Mean=0.07 STD=0.38'; endif
if(iframe = 3); 'draw string 'tlx' 'tly'  2-mon Lag, 130 CORs'; endif
if(iframe = 3); 'draw string 'tlx' 'tly2' Mean=0.04 STD=0.37'; endif
if(iframe = 4); 'draw string 'tlx' 'tly'  3-mon Lag,  65 CORs'; endif
...
'print'
'printim hstg.z200.na.png gif x600 y800'
