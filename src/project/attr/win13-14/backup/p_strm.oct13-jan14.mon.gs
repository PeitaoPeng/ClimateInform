...
'define p3=p(t=3)'
'define p4=p(t=4)'
'define st1=strm.2(t=1)'
'define st2=strm.2(t=2)'
'define st3=strm.2(t=3)'
'define st4=strm.2(t=4)'
'set t 1'
'set lon 0 360'
'set lat  -40 90'
'set yaxis -40 90 30'
...
'print'
'printim p_st.oct13-jan14.png gif x600 y800'
