...
if(iframe = 1); 'draw string 'tlx' 'tly' (a) Nov76'; endif
if(iframe = 2); 'draw string 'tlx' 'tly' (b) Dec76'; endif
if(iframe = 3); 'draw string 'tlx' 'tly' (c) Jan77'; endif
if(iframe = 4); 'draw string 'tlx' 'tly' (d) Feb77'; endif
'set string 1 tl 5 0'
...
'print'
'printim sst_z200.ndjf76.png gif x600 y800'
