...
*
'open /cpc/home/wd52pp/data/attr/winter13-14/bmout.djfm.tpdiv.ctl'
*
'set string 1 tc 5'
'set strsiz 0.15 0.15'
'draw string 5.5 7.5 Trop ADIV(10`a-6`n/s) Forced PSI(10`a6`nm`a2`n/s) at 200mb, R1, DJFM2013/14'
...
'set gxout contour'
'set cint 1'
'd 0.000001*(psi-ave(psi,x=1,x=64))'
'set gxout vector'
*'set arrscl  0.5 100'
*'set arrowhead 0.05'
*'d xflxd;yflxd'
...
'print'
'printim bmout.psi_tpdiv.djfm.png gif x800 y600'
