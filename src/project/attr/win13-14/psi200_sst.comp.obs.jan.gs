...
'draw string 4.25 10.3 (based on NPNA COR to Jan2014 data)'
...
if(iframe = 1); 'draw string 'tlx' 'tly' (a) Jan2014'; endif
if(iframe = 2); 'draw string 'tlx' 'tly' (b) CMP for COR>0.55; 1 samples'; endif
if(iframe = 3); 'draw string 'tlx' 'tly' (c) -CMP for COR<-0.55, 0 sample'; endif
...
'print'
'printim sst_psi200.comp.obs.jan.png gif x600 y800'
