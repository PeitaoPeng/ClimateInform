...
'draw string 4.25 10.3 (based on NPNA COR to Mar2014 data)'
...
if(iframe = 1); 'draw string 'tlx' 'tly' (a) Mar2014'; endif
if(iframe = 2); 'draw string 'tlx' 'tly' (b) CMP for COR>0.55; 3 samples'; endif
if(iframe = 3); 'draw string 'tlx' 'tly' (c) -CMP for COR<-0.55, 1 sample'; endif
...
'print'
'printim sst_psi200.comp.obs.mar.png gif x600 y800'
