...
'open nino34.ndjfm.oisst.1949-2013.ctl'
*
...
'open nino34.ndjfm.oisst.1957-2013.ctl'
'set cmark 8'
'set t 1 65'
'set vrange2 0 9 1'
'set ccolor 1'
...
'run /cpc/home/wd52pp/bin/dline.gs 0 0 2.5 9'
endif

iframe=iframe+1
endwhile
'print'
'printim pers_vs_nino34.scatter.obs-para.png gif x600 y800'
*'c'
*'set vpage off'
*----------
*
