...
'define s6=-reg3(t=2)'
'define s7=-reg3(t=3)'
'define s8=-reg3(t=4)+0.03'
'define u1=skip(-ureg1.2(t=1),2,2)'
'define u2=skip(-ureg1.2(t=2),2,2)'
'define u3=skip(-ureg1.2(t=3),2,2)'
'define u4=skip(-ureg1.2(t=4),2,2)'
'define u5=skip(-ureg3.2(t=1),2,2)'
'define u6=skip(-ureg3.2(t=2),2,2)'
'define u7=skip(-ureg3.2(t=3),2,2)'
'define u8=skip(-ureg3.2(t=4),2,2)'
'define v1=skip(-vreg1.2(t=1),2,2)'
'define v2=skip(-vreg1.2(t=2),2,2)'
'define v3=skip(-vreg1.2(t=3),2,2)'
'define v4=skip(-vreg1.2(t=4),2,2)'
'define v5=skip(-vreg3.2(t=1),2,2)'
'define v6=skip(-vreg3.2(t=2),2,2)'
'define v7=skip(-vreg3.2(t=3),2,2)'
'define v8=skip(-vreg3.2(t=4),2,2)'
'set t 1'
'set lon 120 290'
'set lat  -30 60'
'set yaxis -30 60 20'
...
endwhile
'print'
'printim sstuv_lead_pc3.png x1200 y1600'
