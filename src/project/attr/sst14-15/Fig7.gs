...
*
'define s1=-reg3(t=4)+0.03'
'define s2=-reg3(t=5)'
'define s3=-reg3(t=6)'
'define s4=-reg3(t=7)'
'define s5=-reg3(t=8)'
'define u1=skip(-ureg3.2(t=4),2,2)'
'define u2=skip(-ureg3.2(t=5),2,2)'
'define u3=skip(-ureg3.2(t=6),2,2)'
'define u4=skip(-ureg3.2(t=7),2,2)'
'define u5=skip(-ureg3.2(t=8),2,2)'
'define v1=skip(-vreg3.2(t=4),2,2)'
'define v2=skip(-vreg3.2(t=5),2,2)'
'define v3=skip(-vreg3.2(t=6),2,2)'
'define v4=skip(-vreg3.2(t=7),2,2)'
'define v5=skip(-vreg3.2(t=8),2,2)'
'set t 1'
'set lon 120 290'
'set lat  -30 60'
'set yaxis -30 60 20'
...
if(iframe = 1); 'draw string 'tlx' 'tly'  a) DJF(-1/0)'; endif
if(iframe = 2); 'draw string 'tlx' 'tly'  b) MAM(0)'; endif
if(iframe = 3); 'draw string 'tlx' 'tly'  c) JJA(0)'; endif
if(iframe = 4); 'draw string 'tlx' 'tly'  d) SON(0)'; endif
if(iframe = 5); 'draw string 'tlx' 'tly'  e) DJF(0)'; endif
'set string 1 tl 5 0'
