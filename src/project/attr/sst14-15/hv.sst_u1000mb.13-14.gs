...
'define uc=ave(u.2,t+384,t=744,1yr)'
...
'set gxout shaded'
'set arrlab off'
'set clevs    -1. -0.75 -0.5 -0.25 0 0.25 0.5 0.75 1'
'set ccols    49 47 45 43 41 21 23 25 27 29'
*'set t 780 800'
'set t 773 783'
'd ave(sst-sstc,lat=-5,lat=5)'
'set dfile 2'
'set gxout contour'
'set clevs -1.5 -1. -0.5  0.5 1 1.5 2'
'd ave(u.2-uc,lat=-5,lat=5)'
'set clevs 0'
'set cthick 6'
'set ccolor 1'
'd ave(u.2-uc,lat=-5,lat=5)'
...
endwhile
'print'
'printim hv.sst_u1000mb.may13-mar14.png gif x1200 y1600'
