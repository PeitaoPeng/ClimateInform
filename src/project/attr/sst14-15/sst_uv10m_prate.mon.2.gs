...
'draw string 4. 10.5 Oberved SST and 10m-U'
...
if(iframe = 1); 'draw string 'tlx' 'tly'  May14'; endif
if(iframe = 2); 'draw string 'tlx' 'tly'  Jun14'; endif
if(iframe = 3); 'draw string 'tlx' 'tly'  Jul14'; endif
if(iframe = 4); 'draw string 'tlx' 'tly'  Aug14'; endif
if(iframe = 5); 'draw string 'tlx' 'tly'  Sep14'; endif
'set string 1 tl 5 0'
...
endwhile
'print'
'printim sst_uv10m_prate.mon.2.png gif x1200 y1600'
