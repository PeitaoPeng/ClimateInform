...
C===========================================================
      ...
      real obs(imx,jmx,ltime),cons(imx,jmx,2,nmod)
      real regr(imx,jmx,2,nmod),pc(ltime,2,nmod)
C
...
c
      ...
      do m=1,nmod
      ir=ir+1
      read(12,rec=ir) pc(it,1,m)
      ir=ir+1
      read(12,rec=ir) pc(it,2,m)
      enddo
      enddo
c     write(6,*) pc
c
