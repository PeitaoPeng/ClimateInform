...
*
'open /cpc/home/wd52pp/data/obs/sst/ersst.jan1949-cur.mon.ctl'
*
'set string 1 tc 5'
'set strsiz 0.15 0.15'
*'draw string 5.5 7.65 ERSST Diff: avg(2000-2010)-avg(1990-1999)'
'draw string 5.5 7.65 Sea Surface Temperature 2000s-1990s'
...
'd s2-s1'
'run /cpc/home/wd52pp/bin/dline.gs 120 0 300 0'
'run /cpc/home/wd52pp/bin/dline.gs 180 -10 180 60'
'set string 1 tl 6 0'
...
'print'
'printim sst.decadal_diff.png gif x1600 y1200'
