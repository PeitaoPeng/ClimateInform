...
'open /cpc/home/wd52pp/data/attr/sst14-15/uv.10m.R1.jan1949-cur.mon.2.5x2.5.ctl'
'open /cpc/home/wd52pp/data/attr/sst14-15/prate.1979-cur.cmap.mon.R15.ctl'
*
'set string 1 tc 5'
'set strsiz 0.15 0.15'
*'draw string 4.25 10.1 Oberved SST, 10m-wind and Prate(contours)'
'draw string 4.25 10.1 Oberved SST and 10m-wind'
...
'define s4=sst(t=788)'
'define s5=sst(t=789)'
'define u1=skip(u.2(t=785),2,2)'
'define u2=skip(u.2(t=786),2,2)'
'define u3=skip(u.2(t=787),2,2)'
'define u4=skip(u.2(t=788),2,2)'
'define u5=skip(u.2(t=789),2,2)'
'define v1=skip(v.2(t=785),2,2)'
'define v2=skip(v.2(t=786),2,2)'
'define v3=skip(v.2(t=787),2,2)'
'define v4=skip(v.2(t=788),2,2)'
'define v5=skip(v.2(t=789),2,2)'
'define p1=p.3(t=425)'
'define p2=p.3(t=426)'
'define p3=p.3(t=427)'
'define p4=p.3(t=428)'
...
if(iframe = 1); 'draw string 'tlx' 'tly'  a) May14'; endif
if(iframe = 2); 'draw string 'tlx' 'tly'  b) Jun14'; endif
if(iframe = 3); 'draw string 'tlx' 'tly'  c) Jul14'; endif
if(iframe = 4); 'draw string 'tlx' 'tly'  d) Aug14'; endif
if(iframe = 5); 'draw string 'tlx' 'tly'  e) Sep14'; endif
'set string 1 tl 5 0'
...
endwhile
'print'
'printim sst_uv10m_prate.mon.png x1200 y1600'
