...
'draw string 5.5 7.5 Constructed SST 2014-2015'
...
*
'define s1=con3(time=apr2014)-0*con1(time=apr2014)'
'define s2=con3(time=jun2014)-0*con1(time=jun2014)'
'define s3=con3(time=aug2014)-0*con1(time=aug2014)'
'define s4=con3(time=oct2014)-0*con1(time=oct2014)'
'define s5=con3(time=dec2014)-0*con1(time=dec2014)'
'define s6=con3(time=feb2015)-0*con1(time=feb2015)'
'set t 1'
'set lon 0 360'
'set lat  -30 65'
'set yaxis -30 65 15'
...
'print'
'printim sst.construct.14-15.png gif x1600 y1200'
