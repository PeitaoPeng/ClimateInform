...
*
'open /cpc/home/wd52pp/data/attr/sst14-15/corr.slppc.vs.sst.lag-lead.ctl'
'open /cpc/home/wd52pp/data/attr/sst14-15/corr.slppc.vs.uv1000mb.lag-lead.ctl'
*
'set string 1 tc 5'
'set strsiz 0.15 0.15'
'draw string 4.25 10.5 SLP-PC vs SST & 1000mb Wind'
*---------------------------set dimsnesion, page size and style
nframe=8
nframe2=4
nframe3=8
xmin0=0.75;  xlen=3.5;  xgap=0.1
ymax0=10.3; ylen=-2.5;  ygap=0.2
*
iframe=1
while ( iframe <= nframe )
...
'define s7=-reg3(t=7)'
'define s8=-reg3(t=8)'
'define u1=skip(-ureg3.2(t=1),2,2)'
'define u2=skip(-ureg3.2(t=2),2,2)'
'define u3=skip(-ureg3.2(t=3),2,2)'
'define u4=skip(-ureg3.2(t=4),2,2)'
'define u5=skip(-ureg3.2(t=5),2,2)'
'define u6=skip(-ureg3.2(t=6),2,2)'
'define u7=skip(-ureg3.2(t=7),2,2)'
'define u8=skip(-ureg3.2(t=8),2,2)'
'define v1=skip(-vreg3.2(t=1),2,2)'
'define v2=skip(-vreg3.2(t=2),2,2)'
'define v3=skip(-vreg3.2(t=3),2,2)'
'define v4=skip(-vreg3.2(t=4),2,2)'
...
endwhile
'print'
'printim sstuv_lead_lag_slppc2.png x1200 y1600'
