...
*'set map 15 1 2'
 'set gxout shaded'
'set arrlab off'
*'set clevs    -1.0 -0.5  0.5 1.0 1.5 2.0 2.5'
 'set clevs    -0.6 -0.3  0.3 0.6 1.0 1.5 2.0'
 'set ccols    43 41 0 21 23 24 26 28'
'd s'%iframe
'set ccolor 1' 
'set arrscl  0.5 6' 
'set arrowhead 0.05' 
...
if(iframe = 5)
'd maskout(u5,sqrt(u5*u5+v5*v5)-0.75);maskout(v5,sqrt(u4*u5+v5*v5)-0.75)'
endif
...
if(iframe = 5);'run /cpc/home/wd52pp/bin/cbarn2.gs 0.6 0 'bx' 'by'';endif
iframe=iframe+1
endwhile
'print'
