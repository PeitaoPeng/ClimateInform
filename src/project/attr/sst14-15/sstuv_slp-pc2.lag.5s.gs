...
*
'define s1=-reg2(t=4)+0.03'
'define s2=-reg2(t=5)'
'define s3=-reg2(t=6)'
'define s4=-reg2(t=7)'
'define s5=-reg2(t=8)'
'define u1=skip(-ureg2.2(t=4),2,2)'
'define u2=skip(-ureg2.2(t=5),2,2)'
'define u3=skip(-ureg2.2(t=6),2,2)'
'define u4=skip(-ureg2.2(t=7),2,2)'
'define u5=skip(-ureg2.2(t=8),2,2)'
'define v1=skip(-vreg2.2(t=4),2,2)'
'define v2=skip(-vreg2.2(t=5),2,2)'
'define v3=skip(-vreg2.2(t=6),2,2)'
'define v4=skip(-vreg2.2(t=7),2,2)'
'define v5=skip(-vreg2.2(t=8),2,2)'
'set t 1'
'set lon 120 290'
'set lat  -30 60'
'set yaxis -30 60 20'
...
if(iframe = 1); 'draw string 'tlx' 'tly'  a) DJF(0)'; endif
if(iframe = 2); 'draw string 'tlx' 'tly'  b) MAM(+1)'; endif
if(iframe = 3); 'draw string 'tlx' 'tly'  c) JJA(+1)'; endif
if(iframe = 4); 'draw string 'tlx' 'tly'  d) SON(+1)'; endif
if(iframe = 5); 'draw string 'tlx' 'tly'  e) DJF(+1)'; endif
'set string 1 tl 5 0'
...
endwhile
'print'
'printim sstuv_slp-pc2.lag.5s.png x1200 y1600'
