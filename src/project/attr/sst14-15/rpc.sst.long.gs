...
*
'open /cpc/home/wd52pp/data/attr/sst14-15/pc.sst.had-oi.3mon.tnp.ctl'
...
'set cmark 0'
*'d rpc6'
'run /cpc/home/wd52pp/bin/dline.gs 0 0 432 0'
'set string 1 tl 5 0'
...
endwhile
'print'
'printim rpc.sst.long.png gif x800 y600'
*'c'
*'set vpage off'
*----------
*
