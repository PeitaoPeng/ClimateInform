...
'define s2=-reg1(t=2)'
'define s3=-reg1(t=3)'
'define s4=-reg1(t=4)+0.03'
'define s5=-reg1(t=5)'
'define s6=-reg1(t=6)'
'define s7=-reg1(t=7)'
'define s8=-reg1(t=8)'
'define u1=skip(-ureg1.2(t=1),2,2)'
'define u2=skip(-ureg1.2(t=2),2,2)'
'define u3=skip(-ureg1.2(t=3),2,2)'
'define u4=skip(-ureg1.2(t=4),2,2)'
'define u5=skip(-ureg1.2(t=5),2,2)'
'define u6=skip(-ureg1.2(t=6),2,2)'
'define u7=skip(-ureg1.2(t=7),2,2)'
'define u8=skip(-ureg1.2(t=8),2,2)'
'define v1=skip(-vreg1.2(t=1),2,2)'
'define v2=skip(-vreg1.2(t=2),2,2)'
'define v3=skip(-vreg1.2(t=3),2,2)'
'define v4=skip(-vreg1.2(t=4),2,2)'
'define v5=skip(-vreg1.2(t=5),2,2)'
'define v6=skip(-vreg1.2(t=6),2,2)'
'define v7=skip(-vreg1.2(t=7),2,2)'
'define v8=skip(-vreg1.2(t=8),2,2)'
'set t 1'
'set lon 120 290'
'set lat  -30 60'
'set yaxis -30 60 20'
...
'set arrowhead 0.05'
'set arrlab off'
if(iframe = 8);'set arrlab on';endif
if(iframe = 1)
...
if(iframe = 8)
'd maskout(u8,sqrt(u8*u8+v8*v8)-0.15);maskout(v8,sqrt(u8*u8+v8*v8)-0.15)'
endif
...
if(iframe = 1); 'draw string 'tlx' 'tly'  Lead 3(MAM)'; endif
if(iframe = 2); 'draw string 'tlx' 'tly'  Lead 2(JJA)'; endif
if(iframe = 3); 'draw string 'tlx' 'tly'  Lead 1(SON)'; endif
if(iframe = 4); 'draw string 'tlx' 'tly'  Lead 0(DJF)'; endif
if(iframe = 5); 'draw string 'tlx' 'tly'  Lag 1(MAM)'; endif
if(iframe = 6); 'draw string 'tlx' 'tly'  Lag 2(JJA)'; endif
if(iframe = 7); 'draw string 'tlx' 'tly'  Lag 3(SON)'; endif
if(iframe = 8); 'draw string 'tlx' 'tly'  Lag 4(DJF)'; endif
'set string 1 tl 5 0'
...
endwhile
'print'
'printim sstuv_lead_lag_pc1.png x1200 y1600'
