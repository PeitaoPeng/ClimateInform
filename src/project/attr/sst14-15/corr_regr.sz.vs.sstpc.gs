...
if(iframe = 4); 'draw string 'tlx' 'tly'  PC4'; endif
if(iframe = 5); 'draw string 'tlx' 'tly'  PC5'; endif
if(iframe = 6); 'draw string 'tlx' 'tly'  PC6'; endif
'set string 1 tl 5 0'
...
'print'
'printim regr.psi.vs.sstpc.3mon.png gif x1600 y1200'
