...
'open /cpc/home/wd52pp/data/attr/telcon/pc.hadoisst.djf.80-21.ctl'
...
'set grid on'
'set grads off'
'set xaxis 1980 2021 5'
'set bargap 50'
'set time jan1980 jan2021'
'set t 1 42'
'set ccolor 29'
...
if(iframe = 2);'draw string 'xstr' 'ystr' b)SST Regr to PC2 (11.3%)'; endif
*----------
'set string 1 tc 5 0'
...
endwhile
*
'printim modoki.ts_pat.png gif x1200 y1600'
