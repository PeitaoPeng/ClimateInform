...
'open /cpc/home/wd52pp/data/attr/telcon/z200_21.'ts'.djf.contrib.'zonal'.ctl'

*---------------------------string/caption
 'set string 1 tc 5 0'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.75 Reconstruction of Z200 for 2020/21 DJF'
 'set strsiz 0.12 0.12'
...
if(iframe = 2);'draw string 'xstr' 'ystr' b)Nino3.4 COR=0.26'; endif
if(iframe = 3);'draw string 'xstr' 'ystr' c)RPC1 COR=0.07';endif
if(iframe = 4);'draw string 'xstr' 'ystr' d)RPC2 COR=0.40'; endif
if(iframe = 5);'draw string 'xstr' 'ystr' e)RPC3 COR=-0.41'; endif
if(iframe = 6);'draw string 'xstr' 'ystr' f)RPC4 COR=0.45'; endif
if(iframe = 7);'draw string 'xstr' 'ystr' g)Trend COR=0.66'; endif
if(iframe = 8);'draw string 'xstr' 'ystr' h)All COR=0.68'; endif
*endif
*----------
'set string 1 tl 5'
...
endwhile
*
'printim z200.'ts'.contrib.21.'area'.'zonal'.png gif x1200 y1600'
