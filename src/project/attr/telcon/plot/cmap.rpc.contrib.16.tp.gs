...
if(iframe = 9);'draw string 'xstr' 'ystr' i)Nino34+Trend+RPC3-4'; endif
if(iframe = 10);'draw string 'xstr' 'ystr' j)Nino34+trend+RPC1-6'; endif
*endif
*----------
'set string 1 tl 5'
...
endwhile
*
'printim cmap.'ts'.contrib.16.tp.png gif x600 y800'
