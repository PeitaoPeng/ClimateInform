...
'open /cpc/home/wd52pp/data/attr/telcon/corr.cmaprsd_pc_vs_z200.djf.wtd.ctl'
...
while ( iframe <= nframe )
  ...
  if(iframe >  2); ylen=-2.75; endif
*  if(iframe >  4); xlen=2.75; endif
  if(iframe >  2); ygap=-0.4; endif
  if(iframe >  2); ymax0=10.25; endif
...
'set string 1 tc 5 0'
'set strsiz 0.12 0.12'
if(iframe = 1);'draw string 'xstr' 'ystr' a)PC1'; endif
if(iframe = 2);'draw string 'xstr' 'ystr' b)PC2'; endif
if(iframe = 3);'draw string 'xstr' 'ystr' c)PC3'; endif
if(iframe = 4);'draw string 'xstr' 'ystr' d)PC4'; endif
if(iframe = 5);'draw string 'xstr' 'ystr' e)PC5'; endif
if(iframe = 6);'draw string 'xstr' 'ystr' f)PC6'; endif
endif
*----------
'set string 1 tc 5 0'
if(iframe = 4);'run /cpc/home/wd52pp/bin/cbarn.gs 0.8 0 'bx' 'by'';endif
*
...
endwhile
*
'printim regr.cmaprsd_pc.vs.z200.wtd.4m.png gif x600 y800'
