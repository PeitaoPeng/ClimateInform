...
'open /cpc/home/wd52pp/data/attr/telcon/reof.cmap.djf.'eof_range'.'mtx'.ctl'
'open /cpc/home/wd52pp/data/attr/telcon/rpc.cmap.djf.'eof_range'.'mtx'.ctl'

*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.65 Nino34 Regr & REOF/RPC of DJF CMAP'
 'set strsiz 0.12 0.12'
...
'set strsiz 0.12 0.12'
if(iframe = 6);'draw string 'xstr' 'ystr' RPC1'; endif
if(iframe = 7);'draw string 'xstr' 'ystr' RPC2'; endif
if(iframe = 8);'draw string 'xstr' 'ystr' RPC3'; endif
if(iframe = 9);'draw string 'xstr' 'ystr' RPC4'; endif
if(iframe = 10);'draw string 'xstr' 'ystr' RPC5'; endif
endif
*----------
'set string 1 tc 5 0'
...
endwhile
*
'printim reof_rpc.cmap.djf.'eof_range'.'mtx'.png gif x600 y800'
