...
'open /cpc/home/wd52pp/data/attr/telcon/corr.sstpc_vs_z200.djf.ctl'
'open /cpc/home/wd52pp/data/attr/telcon/corr.cmaprsd_rpc_vs_z200.djf.wtd.raw.ctl'
*---------------------------string/caption
 'set string 1 tc 5 0'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.3 Z200 Regression to Indices'
 'set strsiz 0.12 0.12'
...
if(iframe = 2);'draw string 'xstr' 'ystr' b)RPC1 of Rainfall endifdual'; endif
*endif
*----------
'set string 1 tl 5'
...
endwhile
*
'printim z200_modoki.png gif x1200 y1600'
's1=sqrt(aave(p1*p1,lon=0,lon=360,lat=-90,lat=90))'
's2=sqrt(aave(p2*p2,lon=0,lon=360,lat=-90,lat=90))'
'xy=aave(p1*p2,lon=0,lon=360,lat=-90,lat=90)'
'cor=xy/(s1*s2)'
