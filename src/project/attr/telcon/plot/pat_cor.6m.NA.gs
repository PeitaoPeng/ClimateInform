...
*global corr
*
'define p8=n34+trd+c1+c2+c3+c4+c5+c6'
*
...
'define c55=sqrt(aave(c5*c5,x=1,x=144,y=1,y=73))'
'define c66=sqrt(aave(c6*c6,x=1,x=144,y=1,y=73))'
...
'define oc5=aave(obs*c5,x=1,x=144,y=1,y=73)'
'define oc6=aave(obs*c6,x=1,x=144,y=1,y=73)'
...
'define coc5=oc5/(oo*c55)'
'define coc6=oc6/(oo*c66)'
'define cot=ot/(oo*tt)'
'define cop=op/(oo*pp)'
