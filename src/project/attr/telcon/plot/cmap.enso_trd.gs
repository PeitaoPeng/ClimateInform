...
'open /cpc/home/wd52pp/data/attr/telcon/trd_rsd_rpc.cmap.djf.wtd.ctl'

*---------------------------string/caption
 'set string 1 tc 5 0'
 'set strsiz 0.12 0.12'
* 'draw string 4.25 10.5 DJF Prate Patterns: ENSO and Trend'
 'set strsiz 0.12 0.12'
...
endwhile
*
*'printim cmap.enso_trd.png gif x1200 y1600'
'printim Fig8.png x1200 y1600'
