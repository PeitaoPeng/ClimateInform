...
*---------------------------string/caption
 ...
 'draw string 4.25 10.75 Reconstruction of Z200 Eddy for 2019/20 DJF'
 'set strsiz 0.12 0.12'
...
if(iframe = 2);'draw string 'xstr' 'ystr' b)Nino3.4 COR=0.00'; endif
if(iframe = 3);'draw string 'xstr' 'ystr' c)RPC1 COR=-0.10';endif
if(iframe = 4);'draw string 'xstr' 'ystr' d)RPC2 COR=0.67'; endif
if(iframe = 5);'draw string 'xstr' 'ystr' e)RPC3 COR=0.00'; endif
if(iframe = 6);'draw string 'xstr' 'ystr' f)RPC4 COR=-0.22'; endif
if(iframe = 7);'draw string 'xstr' 'ystr' g)Trend COR=0.30'; endif
if(iframe = 8);'draw string 'xstr' 'ystr' h)All COR=0.69'; endif
*endif
*----------
'set string 1 tl 5'
...
endwhile
*
'printim z200.'ts'.contrib.20.'area'.'zonal'.png gif x600 y800'
