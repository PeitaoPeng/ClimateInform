...
'open /cpc/home/wd52pp/data/attr/telcon/regr.raw_cmap_boxes.vs.cmap.djf.80-cur.ctl'
'open /cpc/home/wd52pp/data/attr/telcon/ts.raw_cmap_boxes.djf.80-cur.ctl'

*---------------------------string/caption
 'set string 1 tc 5'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.6 RAW Prate Regression to the Anomales in the Boxed Regions'
...
*
'set gxout shaded'
'set clevs -4 -3.5 -3.0 -2.5 -2.0 -1.5 -1.0 -0.5 -0.2 0.2 0.5 1.0 1.5 2.0 2.5 3.0 3.5 4.'
'set ccols  79 78 77 76 75 74 73 72 71 0 31 32 33 34 35 36 37 38 39'
...
endwhile
*
'printim regr.raw_cmap_box.vs.cmap.ts.png gif x600 y800'
