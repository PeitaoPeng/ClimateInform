...
'open /cpc/home/wd52pp/data/attr/telcon/z200_17.'ts'.djf.contrib.'zonal'.ctl'

*---------------------------string/caption
 'set string 1 tc 5 0'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.75 Reconstruction of Z200 for 2016/17 DJF'
 'set strsiz 0.12 0.12'
...
if(iframe = 2);'draw string 'xstr' 'ystr' b)Nino3.4 COR=-0.21'; endif
if(iframe = 3);'draw string 'xstr' 'ystr' c)RPC1 COR=-0.17';endif
if(iframe = 4);'draw string 'xstr' 'ystr' d)RPC2 COR=0.01'; endif
if(iframe = 5);'draw string 'xstr' 'ystr' e)RPC3 COR=0.62'; endif
if(iframe = 6);'draw string 'xstr' 'ystr' f)RPC4 COR=0.31'; endif
if(iframe = 7);'draw string 'xstr' 'ystr' g)Trend COR=0.25'; endif
if(iframe = 8);'draw string 'xstr' 'ystr' h)All COR=0.50'; endif
*endif
*----------
'set string 1 tl 5'
...
endwhile
*
'printim z200.'ts'.contrib.17.'area'.'zonal'.png gif x1200 y1600'
