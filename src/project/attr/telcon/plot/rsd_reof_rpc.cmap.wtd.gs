...
*'d skip(cc-cc,4,2)'
if(iframe=1);'/cpc/home/wd52pp/bin/hatch1.gs c1 0.257 1';endif
if(iframe=1);'/cpc/home/wd52pp/bin/hatch1.gs c1 -1 -0.257';endif
if(iframe=2);'/cpc/home/wd52pp/bin/hatch1.gs c2 0.257 1';endif
if(iframe=2);'/cpc/home/wd52pp/bin/hatch1.gs c2 -1 -0.257';endif
if(iframe=3);'/cpc/home/wd52pp/bin/hatch1.gs c3 0.257 1';endif
if(iframe=3);'/cpc/home/wd52pp/bin/hatch1.gs c3 -1 -0.257';endif
if(iframe=4);'/cpc/home/wd52pp/bin/hatch1.gs c4 0.257 1';endif
if(iframe=4);'/cpc/home/wd52pp/bin/hatch1.gs c4 -1 -0.257';endif
if(iframe=5);'/cpc/home/wd52pp/bin/hatch1.gs c5 0.257 1';endif
if(iframe=5);'/cpc/home/wd52pp/bin/hatch1.gs c5 -1 -0.257';endif
if(iframe=6);'/cpc/home/wd52pp/bin/hatch1.gs c6 0.257 1';endif
if(iframe=6);'/cpc/home/wd52pp/bin/hatch1.gs c6 -1 -0.257';endif

'run /cpc/home/wd52pp/bin/dline.gs 0 0 360 0'
'run /cpc/home/wd52pp/bin/dline.gs 180 -20 180 45'
...
'set string 1 tc 6 0'
if(iframe = 1);'draw string 'xstr2' 'ystr2' 13.0%'; endif
if(iframe = 2);'draw string 'xstr2' 'ystr2'  6.2%'; endif
if(iframe = 3);'draw string 'xstr2' 'ystr2'  5.3%'; endif
if(iframe = 4);'draw string 'xstr2' 'ystr2'  5.0%'; endif
if(iframe = 5);'draw string 'xstr2' 'ystr2'  3.8%'; endif
if(iframe = 6);'draw string 'xstr2' 'ystr2'  3.2%'; endif
endif
if(iframe > 6);
'set ylab on'
*'set xlab off'
...
endwhile
*
'printim rsd_reof_rpc.cmap.djf.'eof_range'.'mtx'.wtd.png gif x600 y800'
