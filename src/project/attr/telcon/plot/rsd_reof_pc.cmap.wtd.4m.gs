...
while ( iframe <= nframe )
  ...
  if(iframe >  4); ylen=-1.125; endif
  if(iframe >  4); xlen=3.5; endif
  if(iframe >  4); ygap=-0.29; endif
...
'set strsiz 0.12 0.12'
if(iframe = 1);'draw string 'xstr' 'ystr' EOF1'; endif
if(iframe = 2);'draw string 'xstr' 'ystr' EOF2'; endif
if(iframe = 3);'draw string 'xstr' 'ystr' EOF3'; endif
if(iframe = 4);'draw string 'xstr' 'ystr' EOF4'; endif

'set string 1 tc 6 0'
if(iframe = 1);'draw string 'xstr2' 'ystr2' 13.5%'; endif
if(iframe = 2);'draw string 'xstr2' 'ystr2'  6.5%'; endif
if(iframe = 3);'draw string 'xstr2' 'ystr2'  5.6%'; endif
if(iframe = 4);'draw string 'xstr2' 'ystr2'  4.8%'; endif
endif
if(iframe > 4);
'set ylab on'
*'set xlab off'
...
'set strsiz 0.12 0.12'
if(iframe = 5);'draw string 'xstr' 'ystr' PC1'; endif
if(iframe = 6);'draw string 'xstr' 'ystr' PC2'; endif
if(iframe = 7);'draw string 'xstr' 'ystr' PC3'; endif
if(iframe = 8);'draw string 'xstr' 'ystr' PC4'; endif
endif
*----------
'set string 1 tc 5 0'
if(iframe = 4);'run /cpc/home/wd52pp/bin/cbarn.gs 0.7 0 4.2 4.35';endif
*
...
endwhile
*
'printim rsd_reof_pc.cmap.djf.'eof_range'.'mtx'.wtd.4m.png gif x1200 y1600'
