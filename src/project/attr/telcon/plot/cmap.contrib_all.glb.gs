...
'open /cpc/home/wd52pp/data/attr/telcon/cor_t.cmap_contrib_all.rsd_rpc.djf.ctl'

*---------------------------string/caption
 'set string 1 tc 5 0'
 'set strsiz 0.12 0.12'
 'draw string 4.25 10.75 COR of Reconstructed CMAP to OBS (1980-2021)'
 'set strsiz 0.12 0.12'
...
endwhile
*
*'printim cmap.'ts'.contrib_all.'area'.png gif x1200 y1600'
'printim Fig11.png x1200 y1600'
