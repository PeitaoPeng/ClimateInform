 open /export-1/sgi59/wd52pp/data/tony/acc2d_vs_obs_2mt.jfm.ctl
 open /export-1/sgi59/wd52pp/data/echam/acc2d_vs_obs_2mt.jfm.ctl
 open /export-1/sgi59/wd52pp/data/b9x/acc2d_vs_obs_temp.jfm.ctl
 reset
...
set string 1 tc 8
set strsiz 0.2 0.2
draw string 4.0 10.8 corr(model.vs.obs) 2mtmp JFM 58-94 
