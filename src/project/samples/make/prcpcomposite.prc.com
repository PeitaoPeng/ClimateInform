...
open /export-3/sgi57/ocean/wd52pp/ctlxfast/anom/prcpjfm.composite.ctl
 reset
...
draw string 4.0 10.6 ctlxfast jfm prate(mm/mon) warm case composite 
...
set gxout contour
set csmooth on
set clevs -640 -320 -160 -80 -40 -20 -10 -5 5 10 20 40  80 160 320 640
d z*86400*30
