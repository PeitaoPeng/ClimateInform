 open /export-1/sgi59/wd52pp/data/b9x/corr.esm_rcoef_cor_vs_sst.jfm.ctl
 open /export-1/sgi59/wd52pp/data/b9x/corr.rcoef_cor_vs_sst.jfm.ctl
 reset
...
set string 1 tc 8
set strsiz 0.2 0.2
draw string 4.0 10.8 CORR: RPC(b9x NHZ500) vs SST jfm 58-94 
set t 1
set vpage 1 7 7 10  
set grads off
set gxout shaded
