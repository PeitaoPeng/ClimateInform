...
#=========================================================
# use SVD to combine empirical and dynamical forecasts 
#=========================================================
...
c
      ...
      do j=1,jmx
        ...
        std1(i,j)=0.
        do it=1,ntm
        std1(i,j)=std1(i,j)+w3d1(i,j,it)*w3d1(i,j,it)
        enddo
        std1(i,j)=sqrt(std1(i,j)/float(ntm))
        endif
      enddo
      enddo
c
...
c
      ...
      ngd1=0
        do i=isv1,iev1,2
        do j=jsv1,jev1,2
c         if(w3d1(i,j,1).gt.-1000) then
          if(w3dm(i,j,1).gt.-1000.and.w3d1(i,j,1).gt.-1000) then
          ngd1=ngd1+1
          if(id.eq.1) then
c         aleft(ngd1,it)=w3d1(i,j,it)*cosr(j)/std1(i,j)
          aleft(ngd1,it)=w3d1(i,j,it)*cosr(j)/stdm(i,j)
          else
          aleft(ngd1,it)=w3d1(i,j,it)*cosr(j)
          endif
          endif
        enddo
        enddo
