...
c      parameter(isv1=1,iev1=360,jsv1=70,jev1=110)
       ...
       parameter(isv2=234,iev2=240,jsv2=124,jev2=138)
c      parameter(isv2=234,iev2=240,jsv2=124,jev2=133)
c
...
c
      ...
      data npick /1,1,0,1,1,1,1/ ! conus with t&extp sst
      data mpick /1,5,7,4,2,6,2/ ! conus with t&extp sst
c
