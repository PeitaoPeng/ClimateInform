...
mm_eof=8 # mode cut off for model data
...
c
      call eof_s(w3dvm,cosr,nt,ngrdm,modm,undef,
...
c have non-taget data
        ...
        ENDDO  ! iy loop
c
      call eof_s(w3do,cosr,ntm,ngrdo,modo,undef,
...
C write out obs and pls_prd
      ...
      subroutine eof_s(fin,cosr,nt,ng,nmod,undef,
...
c     print *, 'ngrd=',ig
      enddo
C EOF analysis
c     call eofs(aaa,ng,nt,nt,weval,wevec,wcoef,wk,id)
